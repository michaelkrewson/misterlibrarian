// Share-this-page button for The Librarian's Regimen.
//
...
function _shareInit(root){
  // Regimen ships a Spanish edition (<html lang="es">) alongside the English
  // one, same as the Bible project — this is the one place the label needs
  // to branch.
