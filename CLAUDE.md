...
- **Other fixed renderings, established — search the source file's existing notes before inventing
  ...
  (YHVH — never "the LORD"; in the NT also wherever an OT YHVH text is quoted or an OT formula is
  used, e.g. "angel of Jehovah", "Jehovah God the Almighty", with the note saying the Greek reads
  *kyrios*; "Lord" stays where the referent is Jesus), "Look —" (hineh), "my bow" not "rainbow" (qeshet), "great sea-beasts" (taninim).
