...
**Five standing boards** (the first two renamed 2026-09-03 so they could be told apart;
Bitcoin Treasuries and CEBE joined 2026-09-06; the Crypto Heat Map joined 2026-09-07 —
keep this table current when a board is added rather than letting it go stale again, the
exact failure mode this note itself once was):
