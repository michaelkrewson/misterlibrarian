...
- **Other fixed renderings, established — search the source file's existing notes before inventing
  ...
  where the referent is Jesus or genuinely open (Mark 5:19), and the note says why; possessive titles
  ("our Lord and God", Rev 4:11) stay "Lord". Ps 110:1 = "Jehovah said to my Lord"), "Look —" (hineh), "my bow" not "rainbow" (qeshet), "great sea-beasts" (taninim).
