...
CHAPTERS = [
    ...
    ("rev9", "Revelation", 9, "The fifth trumpet opens a shaft into the Abyss, and out of it come locusts armored like war-horses with human faces, women's hair, lions' teeth, and scorpion tails -- ordered to spare every plant and strike only the people who do not carry God's seal, tormenting without killing, for exactly five months. &#9888; Their king is named twice, once in Hebrew and once in Greek -- Abaddon, Apollyon, both meaning 'Destroyer' -- and the Greek name sounds close enough to the god Apollo that some readers hear a coded jab at the emperor who claimed him as patron. The first woe passes; two remain. The sixth trumpet releases four angels bound at the Euphrates to kill a third of mankind, with a cavalry of two hundred million whose horses breathe fire, smoke, and sulfur from their mouths and strike a second time with a serpent's head in their tails. And after a quarter of the earth, then a third of the earth, and now a third of mankind have died, the chapter's last word is that no one repented."),
    ("rev10", "Revelation", 10, "A mighty angel comes down wrapped in a cloud, a rainbow on his head, his face like the sun -- a figure who borrows real pieces of Christ's own description from chapter 1, and who nonetheless is called 'ANOTHER mighty angel,' the identical phrase already used for a figure that is unmistakably not Christ. He sets one foot on the sea and one on the land and swears -- the very thing Christ himself forbade -- that there will be no more delay: an old, famous mistranslation reads this 'time shall be no more' instead. &#9888; Seven thunders speak, and John is told to seal up their words and never write them -- the one door this whole Unveiling never opens. Then he is handed a little scroll and told to eat it: sweet as honey in the mouth, bitter in the stomach once swallowed -- the same order a much older prophet was given on a foreign riverbank, centuries before, with a scroll of his own."),
    ("rev11", "Revelation", 11, "John is handed a measuring reed and told to measure the temple -- but to leave the outer court unmeasured, handed over to be trampled for forty-two months, the same span two unnamed witnesses will spend prophesying in sackcloth, fire pouring from their mouths, power to shut the sky and turn water to blood: a fused portrait of Moses and Elijah the text never names outright. &#9888; When their testimony is finished, THE BEAST -- this book's antagonist, named here for the first time, already wearing a definite article -- rises from the Abyss and kills them, and their bodies lie unburied in a great city 'spiritually called Sodom and Egypt,' while the whole earth throws a party over the corpses. Three days and a half later, breath of life enters them, they stand, and a voice says only 'Come up here.' The seventh trumpet finally sounds -- 'the kingdom of the world has become the kingdom of our Lord' -- and heaven's own temple opens on an object nobody has seen in six centuries: the ark of the covenant, not lost after all, only ever in the wrong building."),
    ("rev12", "Revelation", 12, "A great sign in heaven: a woman clothed with the sun, the moon under her feet, twelve stars crowning her head, crying out in the pain of childbirth -- while a second sign waits opposite her, a great red dragon with seven heads and ten horns, sweeping a third of the stars from the sky and positioning himself to devour her child the moment it is born. She bears a son who will 'shepherd all the nations with an iron rod,' snatched to God's throne before the dragon can touch him, while she flees into the wilderness for 1,260 days. &#9888; Then war breaks out in heaven itself: Michael and his angels against the dragon, who loses and is thrown down to earth -- named for the first time in the whole Bible, in one unbroken sentence, as the serpent of Eden, the Devil, and Satan all at once. A great voice announces his fall and the end of a courtroom standing open since Job: the Accuser, thrown out for good. Furious and running out of time, he turns on the woman a second time -- a river poured from his mouth, swallowed whole by the earth itself -- then on 'the rest of her offspring,' everyone who keeps God's commandments and holds to the testimony of Jesus. The chapter ends with him standing on the sand of the sea, watching the water: a single-letter textual variant decides whether that sentence belongs here, or opens the very next chapter."),
    ("rev13", "Revelation", 13, "A beast rises out of the sea -- ten horns, seven heads, the dragon's own body from the chapter before, and now a composite of every animal Daniel's four-beast vision needed a separate scene to describe: a leopard's body, a bear's feet, a lion's mouth. One of its heads bears a wound that should have killed it and didn't; the whole earth follows it in astonishment, chanting a question -- 'who is like the beast?' -- that borrows its very grammar from the name of the angel who just defeated the dragon one chapter ago. &#9888; A mouth is given to it 'speaking great things,' lifted word for word from Daniel's own boastful little horn, and authority for forty-two months, the same three and a half years this book has now counted four different ways. A second beast then rises from the earth -- lamb-horned, dragon-voiced -- performing false signs, breathing speech into an image of the first beast, and killing anyone who refuses to worship it. Everyone, 'the small and the great, the rich and the poor, the free and the slave,' is forced to carry a mark on the hand or forehead before they may buy or sell anything at all. &#9888; The chapter ends with the single most argued-over number in the whole Bible: 'let the one who has understanding calculate the number of the beast, for it is the number of a man -- and his number is six hundred and sixty-six,' a value nearly every ancient witness agrees on, against a rival reading, 616, already known and already rejected by a bishop writing within a century of the book itself."),
    ...
    ("exod24", "Exodus", 24, "The Mishpatim close with a ceremony: the people swear twice \u2014 once before a word is written down, once after \u2014 and the second oath adds a verb, 'we will do, AND WE WILL HEAR,' the phrase an entire rabbinic teaching is built on. Moses splits the sacrificial blood in two, half on the altar, half thrown on the people themselves with five words this translation renders exactly as the Hebrew has them: 'behold the blood of the covenant' \u2014 picked up almost verbatim thirteen centuries later, over a cup of wine, at the Last Supper. \u26a0 Then seventy-four people climb partway up the mountain and see God, and eat lunch, and the text does not treat these as different kinds of remarkable \u2014 with a pavement of sapphire under his feet that later rabbinic tradition reads as a deliberate memorial: the same word for 'pavement' shares a root with 'brick,' what Israel was forced to make as slaves in Egypt. Moses alone keeps climbing, into a cloud that covers the peak for six days before God calls to him on the seventh, and disappears for forty days and forty nights \u2014 the first of what becomes, across the rest of Exodus, a very consequential number."),
    ("exod25", "Exodus", 25, "The tabernacle instructions open with a voluntary contribution, not a tax \u2014 'from every man whose HEART moves him' \u2014 funding a building whose whole stated purpose is a preposition: 'let them make me a sanctuary, that I may dwell AMONG THEM,' not in it. Then the specifications begin: an ark whose poles may never be removed from their rings, so the most sacred object in the camp travels perpetually ready to move; a gold cover two cherubim guard from either end \u2014 not the 'mercy seat' KJV names it (Tyndale's own 16th-century invention, following Luther), but literally just 'the cover' \u2014 with a promise attached that those same cherubim once made structurally impossible at Eden's gate: 'there I will MEET with you.' \u26a0 A table for bread that is never eaten by the one it's set before, and a solid-gold lampstand hammered from one single piece of metal, seven lamps, that reappears \u2014 almost, but not quite, unchanged \u2014 in a prophet's vision nine centuries later. And one item on the materials list, the mysterious 'tachash' skins, has defeated every translator since the King James Version guessed 'badgers.'"),
    ("exod26", "Exodus", 26, "The tabernacle proper turns out to be the INNER LINING no visitor from outside would ever see \u2014 ten cherubim-woven curtains, wrapped in a plainer eleven-curtain goat-hair 'tent,' wrapped again in weatherproof skins, three shells with the most sacred nearest the center. Then the walls: whether they were solid acacia planks or an open lattice frame is a genuine, unresolved scholarly argument \u2014 KJV says 'boards,' NIV says 'frames,' and the practical case (the sheer weight of the alternative; whether priests inside could see the cherubim curtains through the wall) cuts both ways. Each board's two tenons are, in the Hebrew, literally its two 'HANDS.' \u26a0 And two different curtains close the chapter, distinguished by two different craft-terms \u2014 a two-faced weave for the veil guarding the ark, a one-faced embroidery for the plainer screen at the public door \u2014 a distinction that turns out to explain something odd thirteen centuries later: why the Gospel's account of the temple curtain torn at the crucifixion can't say which curtain is meant."),
    ("exod27", "Exodus", 27, "The tabernacle's furniture and structure now get a boundary: a bronze altar with horns 'of one piece' \u2014 hammered from the same metal fleeing men will one day grasp for asylum, and that a coming prophet's judgment will one day cut off \u2014 built deliberately HOLLOW, so a portable altar can still keep an older law that God's altar be bare earth or unhewn stone, never cut, never climbed by steps. Around it, a hundred-by-fifty-cubit court whose entire wall is cloth, not masonry, its one gate borrowing the same plain embroidery as the tent's own outer door \u2014 cherubim reserved only for what stands deepest inside. \u26a0 And for the first time since the specifications began, an instruction turns to the PEOPLE rather than to Moses: bring pure, beaten olive oil, so a lamp burns every single night before Jehovah \u2014 an everlasting statute, the identical formula that first sealed the Passover, now sealing the priesthood's first standing duty, a chapter before either Aaron or his sons is even given the clothes that make him a priest."),
    ("exod28", "Exodus", 28, "The instructions finally turn from the STRUCTURE to the PEOPLE who will serve inside it: Aaron and his four sons named individually, and 'that he may serve as priest to me' repeated three times before a single garment is described. A breastplate of JUDGMENT \u2014 the Mishpatim's own word, Exodus 21-23, now worn literally over the heart \u2014 carries twelve famously disputed gemstones, one per tribe, and the Urim and Thummim: named, placed, and never once described, the one object on this whole page every English version on the shelf declines to translate rather than guess at. \u26a0 A robe reinforced 'like the opening of a coat of mail'; gold bells and woven pomegranates so the high priest's own presence is audible, 'so that he does not die'; a gold plate reading HOLY TO JEHOVAH worn on the forehead so Aaron can 'bear the iniquity of the holy things' Israel brings; and one idiom \u2014 'fill their hand' \u2014 that every major translation quietly turns into 'consecrate,' kept here exactly as literal as 'side' over 'rib' at Genesis 2."),
    ("exod29", "Exodus", 29, "The ordination ceremony arrives, and pays off the promise Exodus 28 made: the idiom 'fill their hand' \u2014 kept literal there against the whole shelf's 'consecrate' \u2014 fires nine more times here, four as the verb and five as its own noun, 'the ram OF FILLING,' the chapter's standing name for the sacrifice that installs Aaron and his sons. Blood goes onto the altar's horns for the first time since Exodus 27 built them 'of one piece'; a second ram's blood marks ear, thumb, and big toe \u2014 hearing, doing, walking, the body's three extremities, left unexplained. \u26a0 But the real destination is the closing verse: 'I will DWELL among the children of Israel' \u2014 the exact Hebrew root behind mishkan, 'tabernacle,' the word this whole five-chapter building project has carried since Exodus 25:9. Fifteen chapters of gold and curtains were never really about the furniture."),
    ("exod30", "Exodus", 30, "The tabernacle's furniture list, which seemed to have closed two chapters ago, gets one more piece: an incense altar named only by what it does \u2014 'a burning of incense,' one root doing both jobs \u2014 until it is finally put to use and earns a proper name, 'the altar OF incense.' A census follows, priced in a flat half-shekel ransom the rich cannot inflate and the poor cannot discount \u2014 the exact coin that survives thirteen centuries to become the temple tax Peter and Jesus pay in Matthew 17. Then a laver for washing, on pain of death, and two matching recipes \u2014 the anointing oil and the incense \u2014 each described in the identical four-word Hebrew phrase, 'the work of a perfumer.' \u26a0 Both recipes end the same way: whoever compounds one for himself, or merely enjoys its fragrance without ever selling it, is cut off from his people \u2014 private enjoyment alone is guilt enough."),
    ("exod31", "Exodus", 31, "The whole tabernacle instruction closes by naming who will build it: Bezalel, filled with 'the spirit of God' \u2014 the identical phrase for the Spirit that hovered over the waters at creation \u2014 and named down to his grandfather Hur, who once held up Moses' own hands in battle. Eleven verses recap the entire preceding project in miniature, every object from the ark to the incense named once more in one breath, before a Sabbath command restates the Fourth Commandment almost verbatim and closes on the strangest verb in the chapter: God rested 'and was REFRESHED' \u2014 the identical rare word this book otherwise uses only for an exhausted ox, donkey, or slave. \u26a0 The chapter's real hinge is its last line: the two tablets, written 'with the finger of God,' finally handed over \u2014 a promise made seven chapters earlier, on the very mountain where Moses has been standing the whole time."),
    ("exod32", "Exodus", 32, "The people grow impatient waiting on Moses, and demand Aaron make them 'gods who will go before us' — a Hebrew phrase genuinely ambiguous between new deities and an illegitimate image of the one they already have. Aaron melts their gold into a calf and proclaims 'a feast to Jehovah,' not a different god. Moses intercedes with a two-part argument — Egypt's reputation, then a promise already sworn to Abraham — and God relents, for the first time in this book's own thread on divine regret. Moses descends with the very tablets promised seven chapters ago, sees the dancing, and SHATTERS them at the mountain's foot before grinding the calf to powder and making Israel drink it. ⚠ Aaron's own excuse — 'I threw it into the fire, and out came this calf' — is answered by the chapter's plain, final verb: 'the calf, WHICH AARON MADE.'"),
    ("exod33", "Exodus", 33, "Jehovah repeats every earlier promise — the land, the oath, an angel to lead — and withholds the one thing that made any of it bearable: 'I will not go up in your midst, for you are a stiffnecked people.' Moses pitches a plain tent far outside the camp and calls it 'the tent of meeting,' where he speaks with Jehovah 'face to face, as a man speaks to his friend.' Then he presses further, arguing God's own presence back — not merely an angel — through a five-fold volley of the same word, 'favor,' crossing between them six verses running. Having won that, he asks for more still: 'Show me, I pray, your glory.' The answer redirects the request rather than refusing it — goodness passing by, a name proclaimed, a hand covering Moses in the cleft of a rock — because 'you cannot see my face, for man shall not see me and live.' ⚠ The same Hebrew word for 'face' opens the chapter as intimate conversation, becomes 'presence' in its middle, and closes as the one thing flatly impossible to see."),
    ("exod34", "Exodus", 34, "Moses cuts new tablets and climbs the mountain a second time, and Jehovah keeps the promise from the chapter before almost immediately, descending in the cloud to proclaim his own name aloud: 'Jehovah, Jehovah, a God merciful and gracious, slow to anger, and abundant in steadfast love and truth' — the single most quoted self-description of God in the Hebrew Bible. Moses answers with his own plea from the last chapter, word for word, and the covenant is remade in the same terms the golden calf had broken: no molten gods, the same festivals repeated almost verbatim, the same six-word ban on boiling a young goat in its mother's milk. Then Moses comes down the mountain, and does not know that the skin of his face SHINES from having been with God — bright enough that Israel is afraid to come near him, until he learns to veil it. ⚠ That verb, qaran, shares its root with the Hebrew word for 'horn' — the accident of etymology that gave Michelangelo's famous statue its two small horns, and Moses fourteen centuries of being pictured as something he was never described as being."),
    ("exod35", "Exodus", 35, "As construction finally begins, Moses reverses the usual order and puts the sabbath first this time, adding a genuinely new detail — no fire may be kindled in any dwelling on that day, the first time the law has ever named a specific forbidden act. Then he recites the whole material list and furnishing inventory back to the people almost word for word from seven chapters earlier, and they respond with open hands: 'everyone whose heart stirred him,' men and women alike, bring gold, dyed yarn, acacia wood, and spun thread until the offering is called what it plainly is, a freewill gift. ⚠ The jewelry they bring — nose-rings, earrings, signet-rings, bracelets, 'all articles of gold' — is described with the same word, nezem, that named exactly what Aaron demanded stripped off for the golden calf three chapters back: the identical metal, once taken under pressure, now given without being asked twice. The chapter closes by naming Bezalel and Oholiab in the exact words that first commissioned them before any of this book's crisis happened, as if four chapters of rupture and repair left no mark on what God intended to build."),
    ("exod36", "Exodus", 36, "Bezalel, Oholiab, and every skilled craftsman finally set to work, and the offering keeps arriving every morning until the workers themselves have to stop and report a problem no other fundraising story in the Bible has: the people are bringing far more than enough. Moses has an order proclaimed through the whole camp — bring nothing more — and 'the people were restrained from bringing,' a verb that everywhere else describes something withheld against its own nature: rain held back, dew and produce withheld in a famine, a prophet shut up under guard. Here, for once, it describes reining in too much generosity. From there the chapter reports, verse by verse, the same tabernacle instructions given seven chapters ago at Exodus 26 — curtains, boards, sockets, bars, veil, screen — but every verb has moved from command to completed history: 'you shall make' becomes simply 'he made.' ⚠ The only genuinely new engineering problem in the whole account surfaces quietly at v29 — the corner boards have to be doubled front to back, a detail with no equivalent anywhere else, because a design that works on paper still has to actually hold a right angle."),
    ("exod37", "Exodus", 37, "The chapter narrows from a whole team to one man, named once: 'Bezalel made the ark' (v1), and every verse after simply says 'he made,' unnamed but understood, through the ark and its cherubim, the table, the golden lampstand, and the altar of incense. The lampstand repeats, almost word for word, the same claim made three times seven chapters ago — beaten from a single mass of pure gold, no joints, no solder — as if the text is daring the reader to picture how. ⚠ The altar of incense arrives out of its expected order, built here alongside the gold furniture of the inner room rather than with the bronze altar its own name and construction most resemble — the chapter groups its objects by where they stand, not by the sequence the instructions were originally given. Its horns are 'of one piece with it,' the identical phrase already used of the bronze altar outside: two altars, one gold and one bronze, built to the same rule on opposite sides of the same curtain."),
    ("exod38", "Exodus", 38, "The bronze altar and the courtyard fence go up exactly as commanded seven chapters ago, and then the chapter pauses on one startling detail no instruction ever gave: the bronze laver was made 'from the mirrors of the serving women who served at the door of the tent of meeting' — the only object in the whole tabernacle whose raw material the text bothers to trace back to a giver. Then the whole project closes with something new, a formal audit: every talent and shekel of gold, silver, and bronze itemized and accounted for 'by the hand of Ithamar, the son of Aaron the priest.' ⚠ The arithmetic actually checks out — 301,775 shekels of silver, collected at a flat half-shekel a head, divides out to exactly 603,550 men, the same total the text states outright. Read against the golden calf three chapters back, the whole account reads like a quiet correction: gold taken from the people and turned, in secret, into an idol no one could account for, answered here by gold taken from the people and turned, in public, into a building whose every ounce is written down and signed for."),
    ("exod39", "Exodus", 39, "The priestly garments are sewn at last, exactly as commanded nine chapters earlier — every gemstone, every gold thread, every measurement matching Exodus 28 word for word — and the fulfillment says so, out loud, ten separate times: 'as Jehovah commanded Moses' closes verse after verse, the highest concentration of that refrain anywhere in the Torah, a deliberate answer to the golden calf's total improvisation three chapters back. Then the whole finished tabernacle — every board, curtain, vessel, and garment — is brought to Moses and listed one final time, piece by named piece, before he blesses the people who built it. ⚠ 'Thus was FINISHED' (v32) uses the same rare Hebrew root Genesis uses twice for the end of creation itself — a textual echo scholars have long noted runs through the whole tabernacle account, seven speeches answering seven days."),
    ("exod40", "Exodus", 40, "The book's final chapter, and it moves in two long strides: first a nine-chapter, nine-verse command — set up the tabernacle, place every object, anoint it all, clothe and consecrate Aaron and his sons — answered in a single line, 'Thus Moses did; according to everything Jehovah commanded him, so he did.' Then that same command becomes a report, checked off object by object, seven of its clauses closing on the identical formula that dominated the last chapter: 'as Jehovah commanded Moses.' And then the glory arrives. The cloud covers the tent, and 'the glory of Jehovah filled the tabernacle' so completely that Moses — who spoke with God face to face and came and went from the tent freely — cannot enter it at all. The book that opened on a people with no home of their own closes with God dwelling among them so fully that even Moses is shut outside the door. ⚠ The chapter's very last word carries a Masoretic scribal mark used nowhere else in this translation yet — {ש}, 'an empty line at the end of some books' — the ancient copyists' own signal that this, right here, is where a book actually ends."),
    ...
    ("lev2", "Leviticus", 2, "The offering that requires nothing to die: fine flour, oil, and frankincense, baked in an oven or cooked on a griddle or in a pan, with a small handful burned as a 'memorial portion' and the rest kept as food for the priests. No leaven, no honey, may ever go on the altar — but salt must never be missing, 'the salt of the covenant of your God.' And the earliest offering of all needs no kitchen at all: fresh green ears of grain, roasted over fire and crushed by hand, still standing in the field a moment before."),
    ("lev3", "Leviticus", 3, "The offering that no one is required to finish alone: the peace-offering, only ever the fat of it turned to smoke — kidneys, the lobe on the liver, and, when the animal is a sheep, the whole fat tail cut off close to the backbone — while the meat itself becomes a shared meal, part for the priests, the rest for the very family that brought it. And the chapter that gives away the whole system in one closing line: never eat the fat, never eat the blood, a rule this book will spend two more chapters defending — of which, centuries later, only one half survives into a very different set of instructions, written for people who never kept the rest of this law at all."),
    ("lev4", "Leviticus", 4, "The offering laws turn from gift to guilt: a graduated sin-offering, its whole shape scaled to who sinned. The anointed priest and the entire congregation get the elevated version — blood carried into the tent itself, sprinkled seven times before the veil, the animal's body burned outside the camp untouched by anyone, not even the priests. A ruler and an ordinary person get the lesser version — blood on the outer altar only, the body becomes food like any other offering. Four cases, four different animals, one word bounding every one of them: shegagah, through error — nothing here is for a sin worn openly — and one phrase closing every single case, regardless of rank: he shall be forgiven."),
    ("lev5", "Leviticus", 5, "The atonement law widens: three cases where guilt arrives before knowledge does — a withheld testimony, an unnoticed touch of something unclean, a rash oath forgotten — followed by a sin-offering graded to what a person can actually afford, down to a handful of flour for the poorest, with no oil and no frankincense, the only bloodless sin-offering the whole system knows. Then the guilt-offering: the one sacrifice bundled with cash restitution, first for trespassing against holy things, then — in the very same words — for cheating a neighbor over a deposit, a pledge, a lost object found and denied. Repay in full, add a fifth, and only then bring the ram. ⚠ This chapter runs the full Hebrew count, verses 1-26; most English Bibles split its back half off into 'Leviticus 6:1-7' instead."),
    ("lev6", "Leviticus", 6, "The same offering laws, restated a second time — not for the worshippers who bring them, but for the priests who run the altar. The fire that must never go out, day or night. The priests' own share of the grain-offering, hedged with new restrictions Leviticus 2 never spelled out. The anointed priest's own daily offering, morning and evening from the day of his ordination — burned entirely, with no eaten portion at all, because a priest cannot eat his own gift as both giver and receiver. And the sin-offering's law closes on a hard material fact: an earthen pot the meat was boiled in gets smashed, a bronze one just gets scrubbed — holiness spreading by contact, cleaned where it can be, destroyed where it can't. ⚠ Continues Leviticus 5's own versification split: this is Hebrew chapter 6 in full, corresponding to English 6:8-30."),
    ("lev7", "Leviticus", 7, "The priestly economics closing the whole seven-chapter offering-law section: who is paid from which sacrifice, spelled out to the hide. The peace-offering splits into three occasions with three different clocks — a thanksgiving offering eaten the very same day, paired with the one bread rule in the whole system that allows leavened loaves onto the altar precinct; a vow or freewill-offering given an extra day; anything left to a third day becomes tainted meat, worthless retroactively, as if never offered. A flat, absolute ban on eating fat or blood follows, addressed to all Israel rather than just the priests. And every peace-offering permanently taxes two cuts for the priesthood — the breast, waved before Jehovah, and the right thigh, a contribution — carried forward by the offerer's own hands, not the priest's. Closes on a formal colophon naming six offerings and ending, at last, what opened at Leviticus 1."),
    ("lev8", "Leviticus", 8, "Seven chapters of law, and now the story that carries it out: Exodus 29's own ordination instructions, given fifteen chapters and years earlier, are finally performed almost word for word. Aaron is washed, then fully vested — tunic, sash, robe, ephod, breastplate, turban — before a single drop of oil touches him; the tabernacle itself is anointed first, the man second. A sin-offering bull and burnt-offering ram enact laws already legislated but never yet carried out, with Aaron and his sons only laying hands on the animals' heads, the ordinary offerer's own gesture — they cannot yet act as priests, because they are not yet priests. Then the ram of consecration: blood touched to the tip of the right ear, the thumb of the right hand, the big toe of the right foot, before raw fat and bread are placed directly on Aaron's own open palms and waved there — the hand, quite literally, filled. Seven days of confinement at the tabernacle door follow, ending on the identical six-word formula that once sealed the tabernacle's own construction: they did all that Jehovah commanded."),
    ("lev9", "Leviticus", 9, "The eighth day arrives — the confinement is over, and the priesthood goes to work for the first time. Moses hands Aaron the altar itself: draw near, offer your own sin-offering and burnt-offering, and only then the people's. For the first time in the whole book, Aaron slaughters, dips his own finger in the blood, touches the altar's horns himself — the hands filled eight days ago are now doing the filling. He does it once for himself, then again, almost verse for verse, for the whole nation. He blesses the people; he and Moses bless them again together; and fire comes out from before Jehovah and consumes the offering in front of everyone, while the whole camp shouts for joy and falls on its face. No Masoretic paragraph break separates any of it — the entire chapter is one unbroken scene, running straight into whatever comes next."),
    ("lev10", "Leviticus", 10, "The same fire that closed the last chapter in triumph opens this one in catastrophe. Nadab and Abihu, Aaron's own eldest sons, offer strange fire before Jehovah, and fire comes out and consumes them where they stand — the identical clause, word for word, that had just consumed the offering. Moses answers with a citation, not a comfort, and Aaron's entire recorded response is one word: he was silent. Kinsmen, not his surviving sons, carry the bodies out, because the working priests may not so much as leave the tent's entrance. Jehovah speaks to Aaron directly — one of the only times in the whole book — banning wine before the priesthood's daily task of distinguishing holy from common. And the chapter closes on an unexpected turn: the father who said nothing when his sons died speaks up, unprompted, in defense of his surviving two, and wins the argument."),
    ("lev11", "Leviticus", 11, "The food law \u2014 and the first time this book says why. Two tests decide a land animal, a split hoof and the cud, and four famous near-misses fail one of them: the camel, the hyrax, the hare, and the pig, which gets a single verse and no special comment at all. Fins and scales settle the water in three verses without naming one creature. Twenty birds are simply listed, roughly half of them names no translation can identify with confidence \u2014 one Hebrew word turns up once among the birds and once among the lizards, and no version renders it the same way twice. Locusts are the one insect Israel may eat, and two of the four insect names occur nowhere else in the Bible, so this translation prints them untranslated rather than guessing. Then the law follows a dead lizard into the kitchen: a wooden bowl is washed, a clay pot is smashed, an oven is broken down \u2014 while a spring or cistern stays clean no matter what falls in, the one thing here that cannot be defiled, and the word later Judaism took for its own ritual bath. The word for belly in v42 carries the most famous scribal mark in the Torah: an oversized vav the Talmud calls the middle letter of the whole scroll \u2014 a tradition that does not survive being counted, as the Talmud half-admits itself. And forty-three verses of bare criteria finally get a reason: be holy, for I am holy. The chapter ends on a single infinitive, to distinguish \u2014 creation's own verb, and the one Aaron was handed one chapter ago."),
    ("lev12", "Leviticus", 12, "Eight verses on childbirth, and three of the hardest things in the book. A woman \u2014 in a verb odd enough to name the whole Torah portion \u2014 \u2018conceives seed\u2019 and bears a son: seven days unclean, then thirty-three more in what the Hebrew calls the blood of her PURITY, a second stage most translations quietly erase by turning it into a process of being cleansed from blood. A daughter doubles both numbers, and the text gives no reason at all \u2014 every explanation ever offered, from Philo's embryology to the medieval readings that blamed Eve, was supplied afterwards by readers working backwards from the figures, and the chapter itself refuses to let the asymmetry become a price: the offering is identical for a son or a daughter. Circumcision on the eighth day interrupts for exactly one verse, so that the mother's uncleanness never delays the child's rite. Then she brings a lamb and a bird \u2014 and a sin-offering, though she has done nothing wrong, which is the strongest single argument that the word means purification rather than guilt. The chapter ends on a means test: if she cannot afford a lamb, two birds will do. That is the offering Luke reports Mary bringing."),
    ("lev13", "Leviticus", 13, "Fifty-nine verses of pure diagnosis, and the word this book is known for has been mistranslated for two thousand years. ‘Leprosy’ is the King James’s word, inherited from the Septuagint’s own perfectly reasonable Greek — lepros just meant ‘scaly’; the disease modern medicine calls leprosy went by a wholly different Greek name, elephantiasis, and the two were never confused until ‘leprosy’ narrowed centuries later into the name of one disease alone. What the priest actually examines is depth, spreading, and hair colour — three tests run with obsessive precision across a swelling, a scab, a bright spot, a healed boil’s scar, a burn’s scar, and a scale on the scalp or beard that turns the hair thin and yellow instead of white. One rule stops most readers cold: if the disease covers the ENTIRE body, head to foot, with no raw flesh showing anywhere, the man is pronounced clean — only living tissue counts as active disease, not the colour that first raised the alarm. A hapax word, bohaq, is printed untranslated rather than guessed at. And the identical affliction, in the very same chapter, breaks out in wool, in linen, and in leather — proof inside the text itself that whatever this is, it cannot be Hansen’s disease, because no bacterial infection grows on a coat. It closes on the diagnosed man’s own voice: torn clothes, loosened hair, a covered lip, and a cry of ‘unclean, unclean’ from outside the camp — the very isolation two Gospels report Jesus reaching across, on purpose, with his own hand."),
    ("lev14", "Leviticus", 14, "Leviticus 13 diagnosed; this chapter readmits. A person cleared of scaly disease meets the priest OUTSIDE the camp — the boundary never crosses to fetch him — for a rite that kills one bird over living water and dips a second, still-living bird in its blood before setting it free over open country. Seven days follow, then a total, deliberate shave of every hair on the body, head to eyebrows. Then the eighth day, and the chapter’s real payoff: blood and oil touched to the tip of the right ear, the thumb of the right hand, the big toe of the right foot — the exact three points, in the exact order, that consecrated Aaron himself into the priesthood fifteen chapters ago on the worst and best day of his life. A poor person’s cheaper version follows, birds standing in for lambs, the cost cut without the rite being cut. Then the law repeats a third time, for a house — plague breaking out in the plaster of a wall, examined, quarantined, scraped, and, if it returns, torn down stone by stone — a law given for a land the wilderness camp hasn’t reached yet, since nobody living in a tent owns a wall. It closes on a six-line colophon naming every category two chapters have covered: the affliction, the scale, the garment, the house, the swelling, the scab, the bright spot — all of it existing, the text says plainly, to teach the one distinction the priesthood was handed at its own ordination: unclean from clean."),
    ("lev15", "Leviticus", 15, "The law that closes the whole clean/unclean block, and the one Leviticus 12 already assumed its reader knew — twice, that chapter compared a new mother's uncleanness to 'the days of her niddah' without ever explaining the word, because this is where the explaining happens. An abnormal male discharge gets the most elaborate contact-contamination law in the entire Torah: a bed, a seat, a saddle, being spat on, an earthen vessel broken outright versus a wooden one merely rinsed. Then, in three quiet verses, the chapter turns to something nobody expects a law code to legislate so plainly: an ordinary emission of semen, and ordinary marital intercourse — the identical 'unclean until evening' assigned to a couple doing exactly what Genesis commanded them to do, no offering, no shame, no priest involved at all. Ordinary menstruation gets the same procedural calm. And then the harder case: a woman bleeding for many days beyond her expected week — the precise condition the Gospels report a woman living with for twelve straight years, until she comes up behind a crowd and touches a hem, and the uncleanness this chapter spent thirty verses tracking runs, for once, the other direction. It closes on the one sentence that states why any of it exists at all: so that a people living beside their own God do not die in their uncleanness by defiling the tent pitched in their own camp."),
    ("lev16", "Leviticus", 16, "The book's own center, and — uniquely in Leviticus — told in a single unbroken paragraph, no pause anywhere in the whole chapter until it closes. Aaron, dressed down to plain linen instead of his ordination gold, sacrifices a bull for himself and his household, then turns to two identical goats and casts lots: one lot for Jehovah, one for a name this translation refuses to resolve into a single English word — Azazel, a name three genuine scholarly readings claim (a wilderness cliff, a folk etymology behind the word 'scapegoat', a demon's proper name) and none of them settle. The first goat is slaughtered, its blood carried past the veil into the space no one else may enter, sprinkled on the ark's own cover — the literal 'cover', not the 'mercy seat' Tyndale invented centuries later. The second goat, still alive, gets both of Aaron's hands laid on its head and every sin of Israel spoken over it aloud, before a man 'kept ready for it' leads it out to a land the Hebrew calls, in three words, cut off. Everyone who touches any part of this day's ritual — releasing the goat, burning what's left of the sacrifices — becomes unclean by the contact and must wash before returning to camp, even on the one day dedicated entirely to becoming clean. It closes by making itself permanent: once a year, forever, on the tenth day of the seventh month, the day the world will come to call Yom Kippur."),
    ("lev17", "Leviticus", 17, "Sixteen verses, tight as a legal brief, and — like the chapter before it — told without a single internal pause. The law: no ox, lamb, or goat may be killed anywhere but at the tent of meeting's own door, brought as a peace-offering rather than butchered in an open field. The reason, half-buried in the middle of the command, is the real subject of the chapter — some in the camp had been sacrificing to 'the goat-demons', se'irim, real objects of popular worship this law suppresses in the same breath that centralizes every altar into one. Burnt-offerings get the identical rule two verses later, no exceptions by species or by who's offering. Then the chapter turns from where blood is shed to what happens to it afterward: never eaten, under any circumstance, native-born or foreigner alike, because — in the clearest single sentence anywhere in the Torah for what a nefesh actually is — 'the life of the flesh is in the blood.' A hunted animal's blood, never destined for an altar in the first place, is poured out and covered with dust instead. And eating a carcass or an animal killed by a predator — trefah, the direct ancestor of the word 'treif' — brings the same uncleanness as touching one already did three chapters back."),
    ("lev18", "Leviticus", 18, "Thirty verses that open by naming their own alternative — “not as they do in Egypt, not as they do in Canaan” — before laying out, one prohibition per verse, twelve forbidden degrees of kinship, each one set apart in the Masoretic text by its own paragraph break, a structural emphasis found nowhere else in this book. Then, without any change of register, the list keeps going: marrying two sisters as rivals, sex during a woman's monthly separation, adultery, giving a child to Molech, a man lying with a male as with a woman, an animal. All of it — every item on the list, without exception — gets called by the same word: abomination. The chapter closes on one of the most physical images anywhere in the Torah — the land itself, personified, vomiting out the nations who did these things before Israel arrived — and refuses, twice over, to let Israel imagine itself exempt: the same fate waits for native-born and foreigner alike if they do what the land's previous inhabitants did. This chapter completes the run from Leviticus 1 straight through 19, with no gap remaining."),
    ("lev20", "Leviticus", 20, "Leviticus 18's own catalog, told a second time — but this time with a sentence attached to every item. Give a child to Molech, and the town stones you; and if the town looks away, Jehovah says he'll do it himself, a backstop clause aimed less at the guilty than at the community that might let them go. Curse a parent — the same clause, word for word, that Exodus already fixed in an earlier law code — and it's death. Adultery, a father's wife, a daughter-in-law, two men, a man and a beast: death, each one closed with the same grim formula, “their blood is upon them,” a way of saying the sentence isn't the executioner's doing. One case alone gets burned rather than stoned, the single admission in an otherwise flat list that not every offense weighed the same. Then the list turns stranger: a brother and sister who look at each other is called, of all things, chesed — the Bible's own word for loyal, covenant kindness, turned savagely on its head, one bitter pun away from the very first time that word was ever spoken, by Lot, at the gate of Sodom. And two more cases end not in a courtroom at all but in a simple, flat prediction: childless. This chapter closes exactly where it opened — mediums, spiritists — with its own reason for existing spoken once in the middle of it all: you shall be holy, for I am holy."),
    ("lev21", "Leviticus", 21, "Holiness law for the priesthood itself, in two tiers. An ordinary priest may go to a funeral only for his five closest relatives — parent, child, sibling, an unmarried sister — and even then keeps the same mourning rules the whole nation already lives by: no shaved bald spot, no trimmed beard, no cuts in the flesh for the dead. His marriage list excludes a prostitute, a woman the text calls \"profaned,\" a divorcee. Then the chapter tightens every one of those rules for one man alone: the high priest may not so much as loosen his hair or tear his own clothes, may not leave the sanctuary, may not defile himself even for his own mother or father, and may marry nothing but a virgin of his own people — not even the widow an ordinary priest could take. A priest's own daughter, if she becomes a prostitute, is burned, the same fire two chapters back reserved for exactly one other offense. And it closes on the longest list of physical conditions anywhere in this book — blind, lame, a broken limb, a hunchback, a dwarf, crushed testicles — barring a man from the altar itself, while the text goes out of its way to say what that bar does NOT touch: he still eats the holy bread, still belongs, still draws provision as a priest. The line the chapter draws is about who may cross one particular threshold, not about who counts."),
    ("lev22", "Leviticus", 22, "Two holiness laws that turn out to be the same law twice. First: who gets to eat the priestly share of Israel's offerings — actual food, not an abstraction. A priest with a skin disease, a discharge, or corpse-contact is barred from his own table until a wash and sundown clear him; an outsider or a hired hand may never eat it, full stop, but a slave a priest bought with his own money can — property status, oddly, counting for more than a wage. A priest's daughter loses her claim on it the day she marries out, and gets it back, just as automatically, if she comes home a childless widow. Eat it by accident and the fix is exact: what it's worth, plus a fifth, handed to the priest — the same formula this book already used three chapters back. Then the chapter turns from the men to the animals, and gives, for the first time, the actual list behind a word this book has used since its own opening page: tamim, \"without blemish.\" Blind. Broken. A wart. A scab. Crushed. It is, item for item, the same list that barred a man with a limp or a crushed hand from the altar one chapter earlier — the identical standard, first for the ones who serve, now for what they carry to the fire. A newborn animal gets a week with its mother before anyone may touch it. A mother and her calf may not die on the same day. And a thanksgiving offering can't be saved for later — whatever gratitude means here, it does not keep overnight."),
    ("lev23", "Leviticus", 23, "The whole religious year, laid out in forty-four verses and seven appointed times — the fullest calendar the Torah ever gives in one place. It opens, before naming a single annual feast, with the ordinary weekly Sabbath, filed under the identical Hebrew word as everything that follows: an appointed time, not a lesser rhythm running underneath the real calendar. Then Passover, a single evening with no feast-day rest attached to it at all, followed immediately by seven days of unleavened bread that do carry one. A sheaf of the first barley, waved before anyone else's grain is touched. A fifty-day count from that sheaf to a new grain offering of two leavened loaves — and, dropped into the middle of the count with no ritual content of its own, the field-edge law for the poor and the foreigner, because this is harvest, and the law belongs exactly here. A memorial of trumpet-blasts in the seventh month that gets two verses and no explanation. The Day of Atonement, already given its ritual four chapters back, now given its date on the calendar and, for the first time, a penalty for skipping it. And last, seven days living in branch-built shelters, the one festival in the whole chapter that states outright why it exists: so future generations will know their ancestors once had nothing sturdier than this. Six days of ordinary work forbidden outright; on the festival days themselves, a narrower kind of work forbidden instead — a distinction this chapter draws without ever once explaining it, and an entire later category of religious law grew out of exactly that silence."),
    ("lev27", "Leviticus", 27, "The book's own price list, tacked on after the main argument already closed. If you vow a PERSON to God — not sacrifice them, just promise their value — here's exactly what that costs: a flat rate by age and sex, fifty shekels for a man in his prime down to three for an infant girl, no negotiating, though if you're too poor to pay it the priest is required to set a number you can actually afford. Vow an animal that could already be sacrificed, and no swapping a worse one in later — try it, and now you owe both animals, not one. Vow a house or a field, and a priest appraises it fairly, though you can always buy it back later for the appraised price plus a 20% surcharge, since walking back a promise to God isn't free. Land gets tied to the same fifty-year clock introduced two chapters ago: dedicate your own inherited field and its price depends on how many years are left until everything resets; dedicate a field you merely bought, and it was never really yours to give in the first place — it snaps back to its original family regardless. You can't vow an animal's firstborn, because it was already spoken for before you ever got the idea. And then the chapter turns genuinely hard: something placed under a total ban — devoted, no takebacks, no buying it back at any price — including, in the starkest sentence in the book, a person. No ransom. It ends on tithes: one tenth of the harvest, and one tenth of the herd, counted out one animal at a time with no cherry-picking allowed — the tenth one is the tenth one, whether it's the runt or the prize of the litter. And then, after thirty-four verses of appendix, one final line closes the entire book: these are the rules God gave Moses, at the mountain, for Israel. Numbers picks up next, one month later, same mountain, ready to move."),
    ("lev26", "Leviticus", 26, "The book's own bottom line, laid out as a straight trade: obey, and here's what you get; don't, and here's what happens instead. The blessing side runs ten verses — rain on schedule, harvests so good the threshing runs right into the next grape season, peace secure enough to sleep with the doors open, victory so total that five chase off a hundred and a hundred chase off ten thousand, and, underneath all of it, God's own presence moving through the camp the way it once moved through a garden. Then the trade flips, and the curse side runs three times as long, in four distinct stages, each one worse than the last, each one only arriving because the last one got ignored. First sickness and losing to your enemies. Then the sky turns to iron and the ground to bronze, so nothing falls and nothing grows. Then wild animals start picking off livestock and children both, and the roads go empty because no one will risk them. Then siege — actual siege, ten women baking bread in one shared oven because there's no longer flour or fuel for ten separate ones, and still nobody gets full. And then the worst sentence in the whole book: parents eating their own children, because that's where the road actually ends if it's walked all the way to the finish. Cities flattened, shrines torn down, the survivors scattered into enemy territory so thoroughly that a rustling leaf is enough to send them running — not because anything is actually chasing them, just because guilt has already done the chasing on its own. And there, at the very bottom, the chapter doesn't stop. It turns: if they ever admit what they did, if the resistance in them finally breaks, God remembers the old promise anyway — Jacob, then Isaac, then Abraham, working backward through the family like flipping through old photographs — and the door back stays open no matter how far gone things got. The book closes its main legal argument here, with a formal sign-off: these are the rules, this was the deal, sealed at the mountain."),
    ("lev25", "Leviticus", 25, "Two clocks running at once, one inside the other. Every seventh year, the land itself gets to stop — no sowing, no pruning, and whatever the fields grow on their own belongs to nobody in particular: the owner, the hired hand, the resident foreigner, and the wild animals all eat from it on exactly the same terms. Count off seven of those cycles — forty-nine years — and the fiftieth gets a trumpet blast on the single most solemn day of the year, and a phrase that would end up cast onto a bell in Philadelphia three thousand years later: proclaim liberty throughout the land, to all its inhabitants. Every family gets its land back. Every Israelite who sold himself into service walks free. The chapter then does something almost no other law code from the ancient world bothers to do: it works out the actual math. Selling land isn't really selling land — it's leasing however many harvests are left until the reset, and the price has to be calculated accordingly, no cheating either direction. A poor relative's land can be bought back by the nearest family member who can afford it, or by the man himself if he gets back on his feet, or, failing both, by the fiftieth year showing up regardless. Houses inside a walled city get one weird exception — miss the one-year window and it's gone for good, no matter what year of the cycle it is — unless you're a Levite, in which case the ordinary rule comes back, because Levites don't have farmland to lose in the first place. No charging interest against a countryman who's fallen on hard times. And when it comes to actual servitude, the law draws a line it never draws anywhere else this bluntly: an Israelite who sells himself to survive is never, under any framing, a slave — he's a hired hand with an expiration date, gone at the jubilee at the latest — while it's only the surrounding nations whose people can be bought outright, for good, as property. The whole chapter closes on the reason underneath all of it, repeated twice like a bracket around everything in between: you don't actually own any of this — the land, or each other — because it already belongs to the one who got you out of Egypt."),
    ("lev24", "Leviticus", 24, "Three things that have almost nothing to do with each other, filed under one chapter. First, two housekeeping laws restated almost word for word from Exodus: keep a lamp burning every night without fail, and keep twelve loaves of bread on a table before God, replaced every single week, eaten only by priests, in a holy place. Then, with no transition at all, a story — a man with an Israelite mother and an Egyptian father gets into a fight in the camp, and in the heat of it says God's own name out loud as a curse. Nobody knows what to do with him, so they lock him up and wait for a direct answer from Jehovah. The answer, when it comes, is not just his sentence — it is a law: death for cursing God's name, whether you were born in the camp or just living in it. And then, still riding the momentum of that one case, the law keeps going, past blasphemy into everything else a person can do to hurt another person's body: a life for a life, a fracture for a fracture, an eye for an eye, a tooth for a tooth — whatever you did to someone else, done back to you, exactly, no more and no less. One standard, the chapter says twice, for the foreigner and the native alike. Then the man is taken outside the camp, and the sentence the law had just finished describing is carried out on the very case that produced it."),
    ...
    ("num14", "Numbers", 14, "The report lands and the nation breaks. Israel weeps all night and says out loud the wish that will become its sentence — if only we had died in this wilderness — and then proposes, in a phrase found in exactly one other verse in the Bible, to give itself a head and go back to Egypt. Joshua and Caleb tear their clothes and argue that the inhabitants are bread and that their SHADE has turned away from over them, an image not one of the eight versions checked here keeps; the congregation's answer is to reach for stones. God offers to wipe out the people and rebuild the nation from Moses — the identical offer made at the golden calf, with three words added, and mightier than they — and Moses refuses it by quoting God's own self-description from Sinai back at him, in an abbreviation that quietly drops almost every merciful clause and keeps the punishing one entire. The pardon comes back in two Hebrew words, and the next word is BUT. Then the oath: as I live — the first time in the Bible God swears by his own life, twice in this chapter and then not again until Isaiah — and the census that opened the book, 603,550 men from twenty years old and upward, is read back as a list of who will die in the desert, a year for each day the scouts were gone. The ten die of plague that day. The people mourn, and the next morning do the one thing left to do wrong: they go up to fight without the ark, using a verb that appears in only one other verse in the Hebrew Bible — the verse where Habakkuk sets the swollen soul against the righteous who lives by his faith."),
    ("num15", "Numbers", 15, "A law about arriving, addressed to the generation that has just been told it will never arrive: the words immediately following the sentence in the wilderness are &lsquo;when you come into the land.&rsquo; Grain and wine become a fixed accompaniment to every animal offering, on a sliding scale &mdash; a tenth of flour and a quarter-hin of oil for a lamb, three tenths and half a hin for a bull. Then the formula this project was promised twice in writing, at Exodus 12 and Leviticus 24, and which arrives here piled up five times in fifteen verses: one statute, one law, one ordinance, for the native and for the sojourner alike. A loaf lifted out of the first dough &mdash; <em>challah</em>, the only offering in the chapter nobody leaves home to make, and a word that outlived its own law onto every Sabbath table since. &#9888; Then the boundary Leviticus 4 pointed at from three books away: everything the sacrificial system covers is bounded by <em>shegagah</em>, error, nine times in eight verses &mdash; and the moment a person acts &lsquo;with a HIGH HAND,&rsquo; the identical two Hebrew words used of Israel marching out of Egypt, the offerings stop and no rite is left. &#9888; A man is found gathering sticks on the sabbath, held in custody because it had not been made clear what should be done to him, and stoned outside the camp &mdash; the third of the Torah&rsquo;s four cases where a law is made in answer to a question, and all four carry a scribal paragraph break at exactly the moment the question hangs unanswered. &#9888; And it closes on tassels with a cord of blue: the third paragraph of the Shema, the garment Matthew three times shows Jesus wearing without naming, and a commandment turning on a verb no version on either shelf prints &mdash; <em>lo taturu</em>, do not go SCOUTING after your own heart and your own eyes, the exact verb used twelve times in the two preceding chapters of the twelve men who scouted the land and came back with a report that killed a generation."),
    ("num16", "Numbers", 16, "Korah's rebellion &mdash; and it opens on a broken sentence. &#9888; <em>And Korah took</em>, says the Hebrew, and never says what he took: the verb wants an object and there isn't one, and the seven versions checked here invent seven different solutions, from &lsquo;took men&rsquo; to &lsquo;became insolent&rsquo; to dropping the verb entirely. This translation leaves the hole marked, as it did for Cain in Genesis 4. The revolt is really two revolts braided: a Levite cousin of Moses who wants the priesthood, and three Reubenites who never mention priesthood at all &mdash; and one of them, On son of Peleth, is named once here and never again in the Bible. &#9888; The argument is built out of sentences said twice in opposite directions: <em>rav lakhem</em>, &lsquo;you have too much&rsquo;, goes from Korah to Moses and comes straight back four verses later; <em>ha-me'at</em>, &lsquo;is it a small thing&rsquo;, goes from Moses to Korah and back from Dathan and Abiram. And Korah's premise is a QUOTATION of Leviticus 19:2 &mdash; the whole congregation is holy &mdash; which makes the rebellion an argument from the law rather than against it. &#9888; Then the most startling line in the chapter, easy to read past: Dathan and Abiram call EGYPT &lsquo;a land flowing with milk and honey&rsquo;, the Torah's own formula for Canaan, and accuse Moses of bringing them out of it to kill them. Moses stakes his commission on a falsifiable public test and asks God to <em>create a creation</em> &mdash; the verb of Genesis 1, which has no other subject in the Bible. ⭐ And the ground opens its mouth: <em>patzetah</em>, a form that occurs in exactly three verses in the whole Hebrew Bible, the first of which is the ground opening to receive Abel's blood from Cain's hand. &#9888; The chapter also ends where English readers do not expect &mdash; the Hebrew has 35 verses where every English Bible has 50, because their 16:36-50 is Numbers 17 in the Masoretic text. So it stops on fire consuming two hundred and fifty men, with no atonement and no memorial; and it never actually says what became of Korah himself."),
    ("num17", "Numbers", 17, "&#9888; Read the versification note before anything else: the Hebrew chapter has 28 verses and holds TWO episodes, so vv1-15 here are printed in every English Bible as Numbers 16:36-50, and vv16-28 as Numbers 17:1-13. Nothing is added or missing on either side &mdash; the same text is divided in two places, and this is where the fifteen verses Numbers 16 planted arrive. First: the censers of the two hundred and fifty dead men are not destroyed but CONSECRATED &mdash; &lsquo;for they have become holy&rsquo;, on the purely procedural ground that they were brought near before Jehovah &mdash; and hammered into plating for the altar, so every sacrifice Israel offers afterwards is offered on a surface made of the rebellion. Then, the very next morning, the whole congregation comes back to accuse Moses and Aaron of murder: &lsquo;you have killed the people of Jehovah.&rsquo; &#9888; God repeats the offer of Numbers 16:21 almost word for word &mdash; and this time nobody argues; Moses simply sends Aaron out with a censer, the same object that killed 250 men, filled with fire from the altar now plated with their censers, and Aaron stands between the dead and the living and the plague is checked at fourteen thousand seven hundred. Then the second sign, and it is the opposite of the first in every way: twelve rods laid in the dark overnight, and the Hebrew word for a rod is also the word for a TRIBE, so each chieftain is holding his tribe with his name written on it. ⭐ Aaron&rsquo;s buds, blossoms and ripens almonds in four stages in one verse &mdash; and the word for the blossom it produces is the same word as the golden PLATE already tied to Aaron&rsquo;s forehead. &#9888; It does not end in relief. It ends in panic, on the exact verb the whole revolt was about: everyone who draws near, who draws near, dies."),
    ("num18", "Numbers", 18, "&#9888; The chapter is addressed to AARON, and that is the finding: searched across the whole Hebrew Bible, God speaks directly to Aaron with Moses not in the sentence in exactly five verses, and THREE of them are here (vv1, 8, 20). The other sustained one is Leviticus 10:8, the wine prohibition given right after two of his sons died for approaching wrongly &mdash; so both times God instructs Aaron in his own right, it follows a death at the sanctuary. &#9888; And this chapter is the answer to the question Numbers 17 ended on. The congregation had cried that everyone who draws near dies; the reply is not reassurance but a job description: <em>you shall BEAR the guilt of the sanctuary</em> &mdash; <em>nasa avon</em>, the same phrase that in Numbers 14 meant God FORGIVING, turned a third way so that a priest absorbs the liability professionally, on everyone else's behalf. &#9888; V2 sets both Hebrew words for &lsquo;tribe&rsquo; side by side &mdash; <em>matteh Levi shevet avicha</em> &mdash; the only verse in the Bible that does so of one tribe, and one of the two is the rod-word Numbers 17 spent a chapter on. The Douay-Rheims, following the Vulgate, takes the second in its OTHER sense and reads &lsquo;the SCEPTRE of thy father&rsquo;. &#9888; Then a landless tribe's entire economy: the contributions, the firstfruits, the devoted things (<em>cherem</em>, the Bible's darkest word, appearing here as a line in a household budget), and the firstborn, redeemed at five shekels &mdash; which the Living Bible converts to &lsquo;two and a half dollars&rsquo;, telling its reader a serious price was pocket change. ⭐ Aaron is given no land at all: <em>I am your portion and your inheritance</em>, a consolation built out of the two legal words just taken away from him. And the tithe turns out not to be charity but payroll &mdash; <em>wages</em>, in exchange for service &mdash; on which the Levites are then themselves taxed a tithe of the tithe."),
    ("num19", "Numbers", 19, "&#9888; The chapter everyone knows as the RED HEIFER, which this translation calls a red COW &mdash; because <em>parah</em> means a cow, because Hebrew's actual word for a heifer (<em>eglah</em>) is already spent on Genesis 15:9, and because the shelf is not on the famous side: four say heifer (KJV, ASV, NIV, TLB) and six say cow &mdash; Geneva, the NWT 1984, a Douay-Rheims that adds &lsquo;of full age&rsquo;, and the entire Spanish shelf, which says <em>vaca</em> without exception. ⭐ The colour is doing work: <em>adumah</em>, red, is the same three consonants as <em>adam</em>, a human being, and the chapter deals them out in order &mdash; a RED cow, her BLOOD burned with her, and then from v11 the HUMAN corpse this all exists to deal with. &#9888; She is burned outside the camp, whole, hide and flesh and blood and dung, with cedar, hyssop and scarlet thrown in &mdash; the same three items that CLEANSE a healed skin-disease in Leviticus 14, used here the opposite way. And then the paradox the chapter is famous for and never explains: the ash makes the unclean clean, and every clean man who handles it &mdash; the priest, the burner, the gatherer, the sprinkler &mdash; is unclean until evening. ⚠ <em>Nefesh</em> does three unrelated jobs here in six occurrences &mdash; a corpse, living people, and twice the subject of &lsquo;that SOUL shall be cut off&rsquo; &mdash; and v13 does two of them in one sentence. ⭐ And the detail almost every version loses: v9 gathers the <em>efer</em>, the ASHES, but v17 takes the <em>afar</em>, the DUST &mdash; Genesis 2's word for what a human is made of and Genesis 3's word for what he returns to. Of the ten versions checked here only the NWT 1984 prints the difference. What cures a man defiled by a human body is the substance a human body is."),
    ("num22", "Numbers", 22, "Israel is camped on the plains of Moab and the story leaves them entirely for three chapters. Balak king of Moab has just watched what happened to Sihon and Og, works out that he cannot win a battle, and goes looking for a weapon an army cannot answer &mdash; so he sends four hundred miles for a foreign seer called Balaam son of Beor, a man whose name turns up, centuries later, on a broken plaster inscription dug out of the Jordan Valley in 1967. What follows is one of the strangest passages in the Torah. God forbids the trip, then permits it, then is angry that it is taken. An angel with a drawn sword blocks the road three times, and the only party who can see him is the donkey &mdash; who is beaten for it, twice, until God opens her mouth and she asks what she has done. A professional visionary is out-seen by his own animal, and when his eyes are finally uncovered he offers to go home and is told to carry on. Two words carry the chapter. Balak asks Balaam to CURSE Israel using one Hebrew verb; Balaam repeats the request to God using a different one, and God&rsquo;s refusal goes back to Balak&rsquo;s original word &mdash; a three-move exchange only two of thirteen versions let you see. And the angel stands in the road <em>le-satan</em>, as a SATAN: the same noun every one of those thirteen versions prints as a proper name in Job and Zechariah, and not one of them prints here. The donkey, meanwhile, counts her beatings as &lsquo;three <em>regalim</em>&rsquo; &mdash; the exact phrase the Torah uses everywhere else for the three annual pilgrimages you are commanded to walk to."),
    ("num36", "Numbers", 36, "<strong>The last chapter of Numbers</strong>, and it is an appeal against a ruling the book already made. In <a href=\"numbers-27.html\">Numbers 27</a> the daughters of Zelophehad won their dead father&rsquo;s land; here the men of their own clan draw near &mdash; the same verb the sisters used, in the masculine &mdash; and point out that if the women marry outside the tribe the land walks off with them, and the jubilee will confirm the loss instead of undoing it. ⭐ Moses gives them <strong>the identical verdict he gave the women</strong>: <em>ken &hellip; dovrim</em>, &lsquo;they speak rightly&rsquo; &mdash; a formula that stands in exactly two verses of the Hebrew Bible, and both are this one case. Both sides are told they are right, and neither ruling is withdrawn. ⚠ Three times in this book somebody petitions Moses using one verb, <em>gara</em>, to be SUBTRACTED &mdash; the unclean men at 9:7, the daughters at 27:4, their clansmen here &mdash; and all three win; not one of thirteen versions uses a single word in all three places, so the thread is invisible in translation. ⚠ The verse that grants the daughters their choice carries a MASCULINE pronoun (&lsquo;good in their eyes&rsquo;), and it is the only masculine plural suffix in the chapter &mdash; six verses later the identical phrase &lsquo;their father&rsquo; is spelled feminine. Eleven versions delete the eyes; one quietly makes the pronoun feminine. ⚠ The fence around the land is built from the marriage verb: Israelites must CLING to their inheritance, <em>davaq</em>, the word of Genesis 2:24. The five sisters marry their cousins, the land stays put, and the list of their names &mdash; given four times in the Bible &mdash; is reordered here, in the one list that records what they actually did. It closes on a colophon: at Sinai God commanded Moses, and on the plains of Moab he commands BY THE HAND OF Moses, adding one word Leviticus never needed &mdash; <em>mishpatim</em>, judgements, the case-law this book invented. Nobody has crossed anything."),
    ("num35", "Numbers", 35, "The cities of refuge &mdash; and the chapter is where the sixth commandment&rsquo;s own verb lives: <em>ratzach</em>, the word in <em>lo tirtzach</em>, stands here <strong>twenty times out of forty-five in the whole Hebrew Bible</strong>, in fourteen of thirty-four verses. ⭐ Hebrew uses ONE word for the man who kills by accident and the man who kills in hatred, and the chapter&rsquo;s whole business is to sort it &mdash; so this translation prints &lsquo;the killer&rsquo; throughout, where eleven of thirteen versions split it and hand the reader the verdict before the trial. ⚠ At v27 the law uses that same verb of a killing it declares blameless: the redeemer of blood <em>ratzach</em>es the <em>rotzeach</em>, and there is no bloodguilt &mdash; and not one version on either shelf repeats the word. ⚠ The verb that APPOINTS the six towns is the causative of the root behind <em>miqreh</em>, CHANCE: Israel is told to make an accident happen on purpose, for people to whom an accident will happen. The man they flee is a <em>go&rsquo;el</em> &mdash; a REDEEMER, the same office that buys back a poor relative&rsquo;s field and that Boaz holds in Ruth. Forty-eight Levitical towns and a pastureland named with the verb for driving people out; a thousand cubits at v4 against two thousand at v5, shown and not resolved; no ransom accepted for the guilty OR the innocent; and a sentence that ends only when the high priest dies. It closes on the reason for all of it: blood corrupts the land, in a causative that stands in two verses of the Bible &mdash; because the landlord lives on the property."),
    ("num34", "Numbers", 34, "The borders of Canaan, drawn corner to corner &mdash; and the chapter is a DEED, not a description: <em>gvul</em>, border, stands in it sixteen times in twenty-nine verses, more than in any other chapter of the Torah and nearly three times the runner-up. ⭐ The land is not GIVEN here, it FALLS to you (v2) &mdash; the vocabulary of the lot, which the chapter says outright eleven verses later, and which only the Douay-Rheims explains, by putting &lsquo;by lot&rsquo; into v2 itself. ⚠ In Hebrew the west IS the sea: v6 says sea-border, sea, sea-border, and every version on both shelves prints &lsquo;west&rsquo; and the collision disappears. ⚠⚠ The mount Hor of v7 is NOT the mountain Aaron died on one chapter ago &mdash; same letters, opposite end of the country &mdash; and the Douay-Rheims alone never creates the problem, because it declines the name and reads &lsquo;the most high mountain&rsquo;. ⭐ Three sets of letters here carry two unrelated meanings apiece: a riverbed and an inheritance; marking out a border and COVETING (that verb exists nowhere else in the Bible, and is spelled like the one in Deuteronomy&rsquo;s tenth commandment); and reaching a lakeshore and BLOTTING OUT. ⭐ The border strikes the SHOULDER of the Sea of Galilee &mdash; which no version on either shelf says &mdash; in a land that by then has hands, a shoulder and eyes. ⚠ Then the accounting: nine tribes are GIVEN their land and two and a half TOOK theirs, a distinction the NWT, the TNM 1987 and both Reina-Valeras keep and the whole KJV tradition flattens. And a roster of ten chieftains listed in map order, three of whom are never called chieftains at all."),
    ("num33", "Numbers", 33, "Moses writes the whole forty-year itinerary himself, stage by stage, forty-two camps from Rameses to the plains of Moab, and its opening line collects a promise made forty years earlier: Exodus 12:12 has Jehovah say he WILL execute judgments on Egypt's gods; here, in the perfect tense, he HAS. Most of the camp names in between are attested nowhere else in the whole Bible &mdash; whole years of wandering compressed into words this list is the only record of &mdash; until the march stops twice: once for Aaron's death, dated by year, month, and day &mdash; one of only a handful of such precise dates in the whole wilderness narrative &mdash; at a station and on an order Deuteronomy 10:6 will later tell differently; once for an enemy king who is only, ominously, listening. Then Jehovah commands the conquest itself &mdash; drive out every inhabitant, destroy every carved stone and molten image and high place, divide the land by lot &mdash; and closes on a warning built from two words found nowhere else in Hebrew, which the whole shelf agrees are thorns and disagrees, right down to which eye they belong in."),
    ("num32", "Numbers", 32, "Reuben and Gad, rich in cattle, ask to settle east of the Jordan instead of crossing into Canaan &mdash; and Moses answers not with a ruling but with a history lesson, retelling Numbers 13-14 almost word for word to men who were children when the scouts' report cost their parents forty years in the wilderness. The covenant he strikes has no divine speech in it at all &mdash; the first extended negotiation in this book settled entirely by a human being, in Jehovah's name but not his voice &mdash; and it turns on one word repeated seven times: every man must be armed before he crosses, or 'know that your sin will find you out,' a line the shelf translates two different ways depending on which language, and sometimes which decade, you read it in. Gad, blessed on his father's deathbed as a raiding band that raids at last, becomes exactly that: Israel's own armed vanguard. And while Moses is still negotiating with the two tribes who actually asked, a third &mdash; Manasseh's own clans &mdash; is already taking Gilead by conquest, without asking anyone at all."),
    ("num31", "Numbers", 31, "Moses sends an army to avenge Israel on Midian, and the campaign that follows refuses to stay simple. Every fighting man is killed and every city burned — and Balaam, the gentile seer who filled three earlier chapters with his own voice, dies in six words, the same clause as five kings whose names appear nowhere else in the Bible. Then Moses, furious that women and children were spared, gives the hardest order in this book so far. The purification law that follows treats even a war Jehovah commanded as something that leaves the men who fought it unclean. And the arithmetic, for once, is flawless: every number in the war-tax and the census checks out exactly, twice — including a war-tribute word, mekhes, that appears nowhere else in the Hebrew Bible outside this one chapter."),
    ("num30", "Numbers", 30, "A single law of vows, and the shelf cannot even agree where it begins &mdash; only Douay-Rheims and Geneva 1599 side with the Masoretic text in opening the chapter with the sentence <a href='numbers-29.html'>Numbers 29</a>'s own closing note promised; the other eleven witnesses on this project's shelf attach it to the chapter before. ⭐ The father's law (vv3-6) uses one verb of override, spoken twice in a single verse; the husband's law (vv7-16) uses two, and the second &mdash; 'annul' &mdash; is one the father's law never uses at all: seven times across four of the ten verses, three of them in one verse alone. ⭐⭐ Three times an on-time override closes with 'and Jehovah will forgive her' &mdash; but the one time a husband waits too long, the sentence is not forgiveness for her but 'he shall bear her guilt' (v16): the unresolved weight of an overridden vow does not vanish, it moves. ⚠ And the one woman no man can override is the one who answers to neither &mdash; a widow or a divorced woman, whose own vow carries the identical unconditional force this chapter gives a man's."),
    ("num29", "Numbers", 29, "Jehovah completes the offering calendar Numbers 28 began, and this half is where the chapter starts naming its own seams instead of leaving them silent. ⭐ The New Year's day of blowing (v1) is never called a new year here or in its parallel at Leviticus 23 &mdash; <a href='exodus-12.html'>Exodus 12:2</a> already gave that title to a different month, six months off; &lsquo;Rosh Hashanah&rsquo; is a later name for an older day. ⭐⭐ The Day of Atonement's own goat is offered 'besides the sin-offering of atonement' (v11) &mdash; naming Leviticus 16's elaborate high-priest ritual by its technical term and stacking on top of it rather than silently disagreeing with it, the way last chapter's Feast-of-Weeks count quietly didn't match Leviticus 23's. ⚠ Then the numbers themselves become the story: the Feast of Tabernacles holds two rams and fourteen lambs constant across seven days and drops exactly one bull each day &mdash; thirteen down to seven, seventy in all &mdash; and the Talmud (Sukkah 55b) has an answer for that number even the text itself never gives: seventy bulls for the seventy nations of <a href='genesis-10.html'>Genesis 10</a>'s own Table of Nations, atoning for the whole world rather than Israel alone. ⭐ And the eighth day that closes the feast turns out to match the New Year that opened the month, animal for animal &mdash; one bull, one ram, seven lambs, both times. The chapter's own last verse says what the whole two-chapter calendar always was: a floor under the nation's worship, not a ceiling on anyone's."),
    ("num28", "Numbers", 28, "Jehovah hands Moses the tabernacle's fixed offering calendar, and the chapter's whole grammar is one word: <em>tamid</em>, continual &mdash; every occasion from here on is layered ON the twice-daily lamb, never instead of it. ⭐ The numbers agree exactly with <a href='exodus-29.html'>Exodus 29:38-42</a>, unchanged decades later &mdash; a rare moment of pure consistency in a book that keeps repeating its own laws, right before the calendar starts giving real reasons to check every parallel rather than assume one. ⚠ V7's drink offering is not wine but <strong>shekhar</strong>, strong drink &mdash; the very word Leviticus 10:9 forbids Aaron's sons to drink before entering the tent, on pain of death; here it is poured, never swallowed, in that same holy place. ⭐⭐ The new moon's own goat carries a phrase neither of the chapter's other two sin-offering goats do &mdash; 'to Jehovah' &mdash; and the sages read exactly that oddity: tractate Shevuot has Reish Lakish call it an atonement 'for having diminished the moon', reaching back to Genesis 1's own lesser light. The Passover day itself gets no offering at all &mdash; that rite was already legislated as a household meal, in Exodus 12 &mdash; and the one festival with nothing here to disagree over instead has no DATE: the Feast of Weeks is named only by relation to a count, and its own headcount here genuinely disagrees with Leviticus 23's list for the identical day."),
    ("num27", "Numbers", 27, "Five women walk to the front of the camp and change a law. ⭐ Zelophehad&rsquo;s daughters &mdash; named in a census two chapters ago for no stated reason &mdash; stand before Moses, the priest, the chieftains and the whole congregation and argue a case: our father was not in Korah&rsquo;s faction, he died in his own sin, and he had no sons, so why should his name be taken away from his clan? And the hinge of the chapter is that <strong>Moses does not rule</strong>; he refers the question up, and a Masoretic paragraph break falls exactly there, between the question and the answer. God&rsquo;s first word on it is that the women are correct, and within six verses a petition has become a precedent and the precedent a statute. &#9888; Then the chapter turns and gives Moses his own sentence as an errand: climb the ridge, look at the land, and be gathered to your people &mdash; for a thing he did at a rock thirty-eight years earlier. He does not argue. His next recorded words ask for a successor, in an image that stands in exactly two verses of the Hebrew Bible: <strong>sheep that have no shepherd</strong> &mdash; the other belonging to a prophet telling a doomed king he is not one. ⭐ And the commissioning is written as a demotion. Joshua gets <em>some</em> of Moses&rsquo; majesty, a partitive form found in this one verse and nowhere else, and where Moses spoke to God directly Joshua must stand before a priest and inquire by the Urim &mdash; a channel the Bible later records failing Saul and then being lost. &#9888; One last thing: God says lay your HAND on him. Moses lays both."),
    ("num26", "Numbers", 26, "The book counts its people a second time, and the arithmetic is the argument. &#9888; <a href='numbers-1.html'>Numbers 1</a> counted a generation at Sinai; this counts their children on the plains of Moab, thirty-eight years later, in the same words &mdash; and the last three verses explain why: not one man of the first list is on this one, because they were sentenced to die in the wilderness and they did. Only two names are exempted, and they are the two scouts who brought back the minority report. ⭐ Set the two totals side by side and they barely move &mdash; 603,550 then, 601,730 now, a net loss of under a third of one per cent across a generation&rsquo;s worth of dying. The movement is all inside: <strong>Simeon collapses from 59,300 to 22,200</strong>, losing nearly two-thirds of its men with no explanation offered, one chapter after a Simeonite chief was named as the man Phinehas killed; Manasseh runs the other way and ends ahead of the brother Jacob had deliberately set above him in Genesis 48. ⭐ And the chapter&rsquo;s best line is three Hebrew words long. After the earth swallows Korah&rsquo;s company, the list pauses to say <strong>the sons of Korah did not die</strong> &mdash; a sentence the Masoretes gave its own paragraph break, and the reason eleven psalms have an author. &#9888; Four times this roll of the living stops to record who is not on it: two men dead in Canaan, two priests dead bringing strange fire, and five daughters standing where a son should be &mdash; Zelophehad&rsquo;s, whose names include a future royal city and a Noah who is not the Noah of the ark, a distinction English cannot print and Spanish keeps by accident."),
    ("num25", "Numbers", 25, "The disaster Balaam could not deliver, arriving without him. &#9888; Israel camps at Shittim &mdash; the place named after ACACIAS, the wood its own tabernacle is built from &mdash; and the people begin sleeping with Moabite women and eating at their gods&rsquo; sacrifices. ⭐ The verb for what happens next is built on the word for a YOKE OF PLOUGH OXEN: Israel did not join itself to Baal-peor, it was harnessed to him, and the whole shelf reads a joining instead. God orders the heads of the people hung up facing the sun, in a verb that stands in exactly two verses of the Bible &mdash; the other is 2 Samuel 21, where seven of Saul&rsquo;s sons are left on a hill until the rain comes &mdash; and then Moses gives the judges a different order, and neither is reported as carried out. ⭐ What stops the plague is a priest with an infantry spear. Phinehas follows a man into the <em>qubbah</em>, a word nobody can define, and runs both him and the woman through her <em>qevah</em> &mdash; two near-homonyms in one sentence, the second found nowhere else in the Bible, and the Douay-Rheims alone reads the room as a brothel. Twenty-four thousand die; 1 Corinthians says twenty-three thousand, and this translation prints the Hebrew and does not reconcile them. ⭐ Then the reward: &lsquo;my covenant, peace&rsquo; &mdash; two nouns side by side with nothing binding them, and a word the Masoretic scribes marked with a BROKEN LETTER that no printed edition and no translation can show. &#9888; The victims are named six verses after they die, and one of the names reads as the word for a LIE. And the Zealots of the first century took their name from this chapter, which is a fact about its afterlife that the note states plainly. Balaam is not in this chapter at all; the book waits six more chapters to say the advice was his."),
    ("num24", "Numbers", 24, "Balak has paid for a curse three times and is about to be told what will happen to him. &#9888; The chapter opens by reporting that Balaam stopped going toward omens &mdash; the plural of the very noun he had just denied of Israel in the previous chapter, so the man abandons his technique one sentence after preaching against it &mdash; and instead the spirit of God comes on him, with no altars in the sentence at all. ⭐ He then introduces himself twice, in words identical letter for letter, as &lsquo;the man whose eye is <em>shetum</em>&rsquo; &mdash; two Hebrew words standing in exactly two verses of the Bible, which nobody can construe, and which the shelf reads three ways at once: OPEN (KJV, both Reina-Valeras), SHUT (ASV, Geneva, Douay), or a state that has CHANGED. ⭐ What follows is the line every synagogue recites on entering &mdash; how good are your tents, Jacob &mdash; said by a foreign diviner about tents he was hired to curse; and one verse later the same consonants come back meaning ALOES, except in the Douay-Rheims, which alone keeps them as tents. Balak claps his hands in fury and makes, almost word for word, the complaint Balaam&rsquo;s donkey made two chapters ago. ⭐ Then the fourth oracle: a STAR steps out of Jacob and a SCEPTRE rises from Israel &mdash; the verse that a Jewish revolt took its leader&rsquo;s name from in 132 AD, and whose second half is so broken that every version repairs it differently. Three short oracles close it, one of them punning the Kenite&rsquo;s name against the word for a NEST and then calling his nation Cain. &#9888; And Balaam goes home unharmed, which is a problem, because Numbers 31 says he was killed with the sword and that the ruin of Israel at Peor happened by his advice."),
    ("num23", "Numbers", 23, "Balak has hired a curse and he is going to be billed for two blessings. Seven altars go up, then seven more, then seven more &mdash; twenty-one bulls and twenty-one rams across three summits &mdash; and each time the answer comes back the wrong way round. &#9888; Read the narrator&rsquo;s verb carefully: four times he says God did not come to Balaam but CHANCED upon him, the ordinary Hebrew root for something falling out by accident, and the whole shelf smooths it to &lsquo;met&rsquo;. ⭐ The first oracle uses four different words for cursing in two verses, and the exchange between them is the plot: Balaam quotes Balak&rsquo;s commission back in Balak&rsquo;s own verb, answers with a different one, and from then on it is the KING who uses the prophet&rsquo;s vocabulary. One of those verbs, <em>za&rsquo;am</em>, enters the Torah in this chapter and nowhere else. ⭐ The second oracle contains the Bible&rsquo;s strongest statement that God does not change his mind &mdash; and the exact form Balaam uses stands in three verses of the Hebrew Bible, the other two of which say he does; 1 Samuel 15 then makes the same argument in a chapter that twice says Jehovah relented over making Saul king. It also contains a wild ox: the animal that became the King James UNICORN and the Douay&rsquo;s rhinoceros, a translation chain four languages long that the Spanish shelf preserves in 1909 and quietly repairs in 1960. &#9888; And in the middle of his second day of reading omens for money, standing beside his own altars, the professional diviner says there is no divination in Israel. The chapter has no Masoretic paragraph break at all, and it stops in the middle of a sacrifice."),
    ("num21", "Numbers", 21, "The hinge of the book, and the chapter every Bible reader half-remembers. Israel destroys the Canaanite king of Arad and names the place Hormah &mdash; the same place the previous generation was beaten back to, now renamed by a victory instead of a defeat. Then the food and the water run out again, and God sends the <em>seraphim</em>: the plural noun in that sentence stands in exactly three verses of the Hebrew Bible, and the other two are Isaiah's six-winged beings at the throne &mdash; a word twelve versions transliterate when it stands over God and all thirteen translate when it bites Israel. Read verse 8 slowly and God does not tell Moses to make a snake at all; he says make a BURNING ONE, and every version on both shelves supplies the missing noun. Moses makes one out of bronze, because <em>nachash</em>, serpent, and <em>nechoshet</em>, bronze, sound almost the same &mdash; and the phrase 'the serpent of bronze' occurs in two verses of the Bible, this one and the one seven hundred years later where a king of Judah smashes it because people had started burning incense to it. Then the chapter turns into an itinerary and starts quoting poetry nobody else preserved: four lines from a lost Book of the Wars of Jehovah, a work-song sung to a well by a generation that could have quarrelled over it instead, and a captured Amorite taunt-ballad about Heshbon that Jeremiah will sing again, almost word for word, some eight centuries later against Moab. Two kings refuse Israel passage and lose everything, and the book quietly changes the verb it has used for scouting twelve times running &mdash; at the one reconnaissance mission in Numbers that goes right."),
    ("num20", "Numbers", 20, "&#9888; Thirty-eight years pass in the white space before v1, and the chapter opens by burying Miriam in a single clause &mdash; no mourning recorded, where Aaron will get thirty days by v29. ⭐ Then something no translation can carry: at v10 Moses turns on the people and shouts <em>ha-morim</em>, &lsquo;you REBELS&rsquo; &mdash; which is, letter for letter, the name <em>Miryam</em> with the definite article in front. The vowels differ and the roots are probably unrelated, but an Israelite has just heard her buried nine verses earlier. And the chapter closes the loop at v24, where God uses the same root back at Moses: because you REBELLED. ⭐ The other finding is a noun. <a href='exodus-17.html'>Exodus 17</a>'s water-from-rock was at a <em>tzur</em>, and God said STRIKE it. This one is at a <em>sela</em>, a crag, and God says SPEAK to it &mdash; and Moses strikes it twice. Two different rocks, two different words, opposite instructions, thirty-eight years apart; of ten versions checked on both shelves only the NWT 1984 keeps them distinct in English, which is why this translation prints &lsquo;crag&rsquo;. &#9888; The rod he swings is the one taken &lsquo;from before Jehovah&rsquo; &mdash; where Numbers 17 stored Aaron's budded staff as a sign. &#9888; The whole shelf keeps the two things that condemn him: the first-person &lsquo;are WE to bring you water&rsquo; and the &lsquo;twice&rsquo;. The place is named Meribah from <em>rib</em>, to quarrel &mdash; the second Meribah, since Exodus 17 already named one &mdash; and the Living Bible glosses it &lsquo;Rebel Waters&rsquo;, which is the wrong root in a chapter that happens to be full of the right one. &#9888; Then Edom refuses passage to &lsquo;your brother Israel&rsquo; and Israel turns away without a fight, the one time in Numbers it takes no for an answer. ⭐ And at Mount Hor the high priest is dismantled in front of himself: Moses strips Aaron of his garments and dresses Eleazar in them while Aaron watches, and Aaron dies on the summit. The chapter's last verb is the one the people used in v3 wishing death on themselves."),
    ("num13", "Numbers", 13, "Twelve chieftains, one per tribe, are sent from the wilderness of Paran to look at the land — and the chapter opens on a two-letter Hebrew word that has carried centuries of argument. God tells Moses to send men \u2018for yourself\u2019, a dative pronoun with no ordinary job in the sentence, and whether it means \u2018I am commanding this\u2019 or \u2018do it on your own responsibility\u2019 matters enormously, because Deuteronomy tells the same story the other way round and says the spies were the people\u2019s idea. Moses renames one of the twelve Joshua before they go, four chapters after the Bible started calling him Joshua. They cross the whole length of the country in forty days and come back carrying a single cluster of grapes on a pole between two men. And their report is true — every word of it, right up to one word. It flows with milk and honey, and here is the fruit, ONLY the people are fierce and the cities are fortified and the giants are there. Caleb hushes the shouting and says go, disputing not a single fact in the report, only its conclusion. The other ten say the inhabitants are stronger than we are, in a Hebrew phrase that can also be read \u2018stronger than HE is\u2019, and then put out a bad report of a land that eats its inhabitants, where they saw the Nephilim and felt like grasshoppers — and then claim to know how they looked through the giants\u2019 eyes."),
    ("num12", "Numbers", 12, "Moses’ brother and sister turn on him, and the chapter opens with a grammatical detail every English Bible hides: two people are named as speaking, but the Hebrew verb is feminine SINGULAR — she spoke, Miriam and Aaron. Their complaint comes in two pieces that the text never connects. One is about the Cushite woman Moses married. The other is the thing Moses himself had wished for out loud only a chapter earlier: has God really spoken only through him? God summons all three outside, calls two of them forward, and delivers the nearest thing the Bible has to a job description for prophecy — visions and dreams for everyone else, and for Moses mouth to mouth, in plain sight, not in riddles, beholding the very thing the second commandment forbids anyone to make. Then he leaves without passing sentence. The punishment is not announced; it is discovered when the cloud lifts. Only one of the two accusers is struck, in words identical to those used of Moses’ own hand at the burning bush, and the brother who spoke too is untouched and starts pleading. Moses answers with five Hebrew words, the shortest prayer in the Torah, and asks nothing for himself. The verse Aaron pleads with carries two of the eighteen places where Jewish tradition says the scribes softened the text. And a nation with a pillar of cloud over it and its marching orders ready waits a full week for one woman before it moves."),
    ("num11", "Numbers", 11, "The mood breaks three days out from Sinai, and the book changes character for good. Everything up to here has gone right \u2014 the counting, the camp, the dedication, the departure. From this chapter on, Numbers is mostly a record of things going wrong, and it opens with people grumbling about nothing the text will even specify, and fire burning the edge of the camp. Then comes the complaint that gives the chapter its shape, and it is startlingly human: they want meat, and what they actually miss is a produce list \u2014 the fish, the cucumbers, the melons, the leeks, the onions, the garlic \u2014 remembered as free, by people who had been slaves. Nobody in the chapter corrects the memory. Moses, meanwhile, breaks down completely, and the words he reaches for are a mother's: did I conceive this people, did I give birth to them, that I have to carry them at my chest like a nurse? Then, plainly: kill me. God's answer is not a rebuke but a reorganization \u2014 seventy elders get a share of the same spirit so the weight stops resting on one man. Two of them start prophesying in the wrong place, off the official list, and when Joshua urges Moses to shut them down Moses gives the best line in the book: he wishes everyone could do it. And then the meat arrives, in a quantity meant as a punishment rather than a gift, and the place where they eat it becomes a cemetery whose name is built out of the same word the chapter used for wanting."),
    ("num10", "Numbers", 10, "They finally leave. Israel has been parked at the same mountain since the third month of the previous year — through the covenant, the golden calf, the entire building of the tabernacle, the whole of Leviticus, and nine chapters of this book — and here, on a date the text gives down to the day, the cloud lifts and the column moves out. First God has Moses make two trumpets, hammered out of silver, and attaches a signal code to them precise enough to steer a nation: blow both and everyone assembles, blow one and only the chiefs come, blow a hard broken blast and the eastern camps start walking. The distinction the chapter cares most about isn't how many horns but how you play them — same instrument, same players, and the difference between 'gather' and 'march' rides entirely on the shape of the note. Then the tribes move off in the exact formation drawn up eight chapters earlier, and Moses turns to his Midianite brother-in-law and asks him to come along as a guide, because a nation with a pillar of cloud overhead still wants somebody who knows the terrain — 'you will be our eyes.' The man says no. Moses asks again. The text never says whether he came. And it closes on two short verses that scribes have bracketed, for centuries, with a letter written backwards — a mark found nowhere else in the Torah, over a passage one ancient tradition insists is not a passage at all but a separate book of the Bible hiding in plain sight, all eighty-five letters of it."),
    ("num9", "Numbers", 9, "Israel keeps Passover in the desert — only the second one ever held, a year to the night after the first one got them out of Egypt. And then a problem nobody had written a rule for: a group of men had recently handled a dead body, which under the camp's own purity laws makes them unfit to take part, and they are not willing to let it go. They come to Moses and ask, flatly, why they should be shut out of the one thing the whole nation is doing. Moses has no answer. He tells them to wait while he asks — a lawgiver admitting on the record that the law doesn't cover this. What comes back isn't an exemption, it's a whole second Passover: anyone unclean, or simply too far from home, gets to keep it a month later to the day, same rules, same meal, nothing left over, no bone broken. The same ruling widens the door again in a direction nobody asked about — a foreigner living among them can keep it too, on identical terms, one law for both. And it shuts exactly one door: anyone perfectly able to show up who just doesn't bother is cut off from his people. Then the chapter pulls back to the cloud sitting over the tent — fire in it at night — and the arrangement that governs everything from here on: when it lifts they march, when it settles they stop, and nobody is told beforehand whether that means two days, a month, or a year."),
    ("num8", "Numbers", 8, "The golden lampstand changes hands. Moses lit it once himself when the tent was first set up; here the job passes to Aaron for good, and the priesthood takes over tending the light. Then the chapter turns to something stranger: the Levites get purified for duty, and the ritual reads like a checklist for undoing a person's ordinary humanity for a moment — water sprinkled on them, a razor run over every inch of their skin, their clothes washed, then the whole nation of Israel lays hands on them at once, and Aaron waves them — the actual, living men — back and forth like a priest waving a piece of meat at an altar, because that's literally the same gesture used everywhere else in the Torah for the fat and breast of a sacrifice, just performed here on an entire tribe of people instead. Two bulls die to make it official, one for a burnt offering, one to atone for the men being consecrated. Then God explains, in his own voice this time, why any of this is happening: every firstborn son in Israel already belongs to him, marked the night he killed every firstborn in Egypt and let Israel's own firstborn walk out untouched — and the Levites are the one-tribe trade that settles that account for good, so the rest of Israel doesn't have to hand over an actual firstborn son to serve God for it. And the chapter ends with a number that flatly contradicts a number from four chapters ago — Levites start their duty at twenty-five here, not thirty like last time — and the text never once acknowledges the difference."),
    ("num7", "Numbers", 7, "The tabernacle is finished, and the very next thing it does is get thrown a twelve-day party. Every day for twelve days running, one tribal chieftain steps forward with an offering — and it's the exact same offering, every single time, item for item, right down to the shekel: one silver dish, one silver basin, a golden spoon of incense, a bull, a ram, a lamb, a goat, and enough oxen and rams and goats and lambs for a peace-offering that could feed half the camp. The text writes it out in full all twelve times anyway, instead of just saying 'repeat eleven more times' — every name gets said, every number gets counted, because apparently no gift here is allowed to look smaller just because eleven identical ones came before it. And the order the chieftains show up in isn't random: it's the exact marching order the camp already used to break camp every morning, tribe by tribe — a calendar built out of last chapter's floor plan. Before any of that, there's a stranger detail buried at the start — the chieftains donate six wagons and twelve oxen to help move the tabernacle, and two of the three Levite clans take them gladly. The third clan, the ones trusted with the ark itself, get nothing — because that cargo doesn't ride in a cart, it rides on a man's own shoulder, no wheel ever allowed near it. Then the chapter does its own math out loud, twice, adding up every dish and every animal to a number that comes out exact. And right at the very end — after fifteen chapters spent building a tent to a set of specifications, a whole book of sacrificial law, and six more chapters besides — one line finally happens: Moses walks in, and for the first time, hears a voice answer him from between the wings of two golden statues, exactly the way he'd been promised it would, chapters and chapters ago, before a single board was ever cut."),
    ("num6", "Numbers", 6, "A vow anyone could take, for as long as they wanted to take it. Skip wine, skip everything that comes off a grapevine — the juice, the raisins, the skins, all of it. Don't cut your hair. Don't go near a dead body, not even your own mother or father's, for as long as the vow runs. That's it — no temple duty, no special robes, just three restrictions anyone in Israel could commit to for a season and then walk away from once the time was up. Except three people in this book never do walk away from it — Samson, marked for it before he's born; Samuel, promised to it by a mother who hadn't even conceived him yet; and, centuries later, a baby who'll grow up to baptize people in a river, marked the same way from the womb. The vow was built to be temporary. Nobody told the mothers that. There's a strange contingency clause tucked into the middle: what happens if someone just drops dead next to you, no warning, and ruins the vow through absolutely no fault of your own? You don't get punished for it — but you don't get credit for the time already served either. Shave your head, wait a week, bring two birds on the eighth day, and start over from zero, whatever you'd already gotten through simply erased. And finishing the vow properly, when nothing interrupts it, costs way more than keeping it ever did — three different animals, bread, grain, wine, the whole production, for a commitment whose daily requirements were just three things you didn't do. Then, with no transition at all, the chapter hands Aaron and his sons the exact words for blessing the entire nation — three lines, each one a little longer than the last, ending on a claim that undercuts the whole ceremony in the best way: the priests don't actually do the blessing. They just say it out loud. God does the blessing part himself, once his own name has been put on the people standing there listening."),
    ("num5", "Numbers", 5, "Three laws that have nothing to do with each other except one thing: what it takes to keep a camp fit for God to actually live in the middle of. First, a housekeeping order — anyone with a skin disease, a bodily discharge, or contact with a corpse gets sent outside the camp, not as punishment exactly, just because those things can't share space with where God has said he'll be. Then a debt law: if you wrong someone, you don't get to make it right with God until you've made it right with the person first — pay back what you took, add twenty percent on top, and only then does anyone talk about a sacrifice. And if the person you wronged has died and left nobody behind to collect on their behalf? The debt doesn't just vanish. It goes to the priest instead, because apparently a wrong doesn't stop being owed just because there's no one left to hand the payment to. Then the chapter turns to something stranger and harder to sit with: a husband gets suspicious of his wife, no proof either way, no witness, nothing anyone could take to court. So instead of a trial with no evidence to run on, there's a ritual — dust from the tabernacle floor mixed into water, her hair unbound, an oath she has to speak out loud agreeing in advance to a curse that only lands if she's actually guilty. She drinks it. If she's lying, something happens to her body. If she's telling the truth, nothing happens at all, and she goes home cleared. It's the one place in the whole law code built specifically for a case where there's genuinely no way to know the truth by ordinary means — and whichever way it goes, the husband himself never answers for having raised the suspicion in the first place."),
    ("num4", "Numbers", 4, "A second census of the same Levites, and this time the age bracket is narrower on both ends: thirty to fifty, not one month and up — the years of a man's actual working strength, because this chapter isn't about who belongs to God from birth, it's about who's strong enough to carry God's furniture across a desert. And before a single Kohathite is allowed anywhere near that furniture, Aaron and his sons have to do something first: wrap it. The ark disappears under a veil, then a covering of the same mystery-material leather this project already flagged back in Exodus, then a cloth of solid blue on top. The table gets the same treatment, and the lampstand, and the incense altar, and the bronze altar outside — each one wrapped in its assigned color before anyone's allowed to touch it, and the warning that goes with the wrapping isn't subtle: look at the holy things uncovered, even for a second, and you die. Only after everything's invisible under cloth are the Kohathites finally allowed to come pick it up — carrying poles already threaded through the rings, so no hand ever actually makes contact with the thing itself. Aaron's son Eleazar gets one more job on top of supervising all this: the lamp oil, the incense, the daily grain offering, and the anointing oil — the ordinary supplies that keep the place running day to day, separate from the furniture. The other two Levite clans get no such warning, because nothing they're hauling can kill anyone — Gershon's got the curtains and the coverings, Merari's got the frames and the bars, and both of them answer to Aaron's other son, Ithamar, not Eleazar. Then the actual headcount: 2,750 men from Kohath, 2,630 from Gershon, 3,200 from Merari. Add them up and you get exactly 8,580 — no gap this time, no leftover 300 nobody can account for, unlike the arithmetic problem the last chapter left sitting on the table. Just a number that adds up, for a job description that's mostly about staying alive long enough to do it."),
    ("num3", "Numbers", 3, "A family tree that gets cut short in the second sentence. Aaron has four sons, but two of them are already dead — offered the wrong fire on the altar and paid for it on the spot, no children left behind — so the whole priestly line has to run through just the two who survived. Then the chapter turns to a trade that's been owed since the night of the Exodus itself: every firstborn son in Israel was marked as belonging to God on the night the plague passed over, and nobody ever followed up on that claim — until now. One entire tribe, the Levites, gets handed over as the payment, a substitute standing in for every firstborn son in every other family in the nation. To make the trade official they get counted the same way the fighting men were counted last chapter, except starting from one month old instead of twenty years, because this isn't about who can hold a weapon — it's about who belongs to whom from birth. Three sons of Levi, three jobs: one clan hauls the tent's fabric and curtains and camps behind it to the west; one clan carries the single most dangerous cargo in the whole camp — the ark, the table, the lampstand, the altars — camped to the south under the direct watch of Aaron's own surviving son; and one clan hauls the heavy stuff nobody thinks about, the frames and bars and posts that hold the whole structure up, camped to the north. Moses and Aaron's family plant themselves directly in front of the entrance, east, so nothing gets near that door without going through them first. And then the chapter ends on a piece of arithmetic it makes you watch happen twice: count every firstborn son in the nation, count every Levite, and the numbers don't quite match — 273 firstborn sons too many, no Levite left to stand in for them. So they get bought back instead, five silver coins each, cash paid straight to the priests, down to the last coin."),
    ("num2", "Numbers", 2, "The same 603,550 men from last chapter's census, given an actual floor plan. Twelve tribes, sorted into four groups of three, one group facing each direction of the compass, each under its own banner planted before a single tent goes up. East gets Judah, Issachar, and Zebulun, and they move out first whenever the camp breaks. South gets Reuben, Simeon, and Gad, moving second — Reuben still gets the honor of leading a group despite losing his birthright standing two books ago, because a census list apparently doesn't forget an accident of birth order just because a father's deathbed blessing did. West gets Ephraim and Manasseh — Joseph's two sons, camped side by side exactly as they were blessed side by side, with Ephraim's name still listed first even though he was the younger of the two. North gets Dan, Asher, and Naphtali, moving last, and Dan's group turns out to be the single largest of the four despite Dan being a fairly minor son in the family story. And directly in the middle of this whole square, not at the front, not off to one side, but dead center: the tent itself, with the Levites camped in a ring around it, so that no matter which direction the column is facing or how far it has to march, the same architecture holds — the tribes on the outside, the priesthood in the middle, and the presence of God at the exact point everything else is built around. The chapter ends the way these things always seem to end here: they did it exactly as they were told, camping and marching both, right down to the last family."),
    ...
    ("deut2", "Deuteronomy", 2, "The long way round. Israel is told to leave Edom, Moab and Ammon alone and not to take a foot of their land, because those countries were given to Esau's sons and to Lot's — the same word, \"possession,\" given to four nations before Israel's own — and then the road runs into Sihon king of Heshbon, who refuses passage because Jehovah hardened his heart, and is destroyed."),
    ("deut3", "Deuteronomy", 3, "Og of Bashan comes out to battle, and the retelling quotes Numbers almost word for word. His iron bed, nine cubits long, is still on show at Rabbah when this chapter is written — the last of the Rephaim, a giant-clan name older than Israel itself. Transjordan is divided among Reuben, Gad and half of Manasseh, and Moses begs to cross the Jordan and is refused: 'Enough from you. Never speak to me again of this matter.' He is sent up Pisgah to look, not to cross, and told to strengthen the man who will."),
    ("deut4", "Deuteronomy", 4, "The eyes that watched Baal-peor become the sermon's first proof: obey, and live, as everyone in this valley still standing can testify. Moses lays down the Bible's oldest rule of self-preservation — do not add to this word, do not take from it — then argues that Israel saw no form at Horeb, only heard a voice, and so must carve no image of anything in heaven, earth or sea. A prophecy of exile follows, and inside it a promise: seek God even from exile and he is found, because he is merciful. Then the loudest claim in the chapter — Jehovah alone is God, in the heavens above and the earth below, there is no other — and Moses, before a single refuge law exists, quietly sets apart three cities where an accidental killer can run and live."),
    ("deut5", "Deuteronomy", 5, "Moses repeats the Ten Words to the generation that did not stand at Horeb — and the repetition is not word for word. \"Remember\" the sabbath becomes \"Keep\" it, grounded now in slavery in Egypt rather than in creation; honoring father and mother gains a second promise Paul will later quote; the tenth Word swaps the neighbor's wife and house and reaches for a second, different verb; and Jehovah himself, once the Ten Words are spoken, \"added nothing more\" — the same restraint the previous chapter demanded of Israel. The people, too afraid to hear the voice again, ask for a mediator, and are told they asked well: it is how Moses gets his job."),
    ("deut6", "Deuteronomy", 6, "The Shema itself &mdash; four Hebrew words with no verb in them, and every translation on earth has to insert an &ldquo;is&rdquo; and decide where it goes. Moses commands Israel to love God with heart, soul and a third word that is not a body part at all but an adverb pressed into service as a noun, and to sharpen these words into their children &mdash; a verb that everywhere else in the Bible sharpens arrows and tongues. Bind them on the hand, write them on the doorpost the Passover blood once went on. Then the danger: cities you did not build, and the warning lands not on hunger but on fullness. Do not test God as you tested him at Testing. And when your son asks tomorrow what all this means, the answer he is given is not a definition but a story."),
    ("deut7", "Deuteronomy", 7, "Seven nations named once and only once in the Hebrew Bible, and the command to devote them to destruction &mdash; a word that means consecrate, not merely kill, and that Deuteronomy adds to the two Exodus passages it is otherwise rewriting almost clause for clause. The reason Israel is chosen is that there was no reason: not for numbers, because it was the fewest of all peoples, only because he loved you. God is called &lsquo;the faithful God&rsquo; here and nowhere else in the Bible; the punishment that ran to the third and fourth generation is cut back to one man in his own lifetime; the blessing on the lambs is spelled with a Canaanite goddess&rsquo;s name in it; and the chapter that opened by devoting seven nations closes by warning that a piece of silver carried indoors devotes YOU."),
    ("deut10", "Deuteronomy", 10, "The second pair of tablets, cut by Moses himself this time and carried up in his own hand to a God who writes the same words again &mdash; and an ark of plain wood, made before the climb, that Exodus builds four chapters later in gold and by another man&rsquo;s hands. Then Aaron dies at Moserah, where Numbers twice buries him on a mountain four stops away, and the Geneva Bible of 1599 answers the contradiction in a marginal line. The tribe of Levi is set apart for three verbs &mdash; to carry, to stand, to bless &mdash; and paid in a person instead of land. Then the sermon turns from the neck to the heart: circumcise its foreskin, and stiffen the neck no more. The reason given is not power but partiality reversed &mdash; the God of gods lifts no faces and takes no bribe, and loves the stranger, giving him bread and a coat."),
    ("deut9", "Deuteronomy", 9, "Moses stops warning and starts correcting: the land is not being given for Israel&rsquo;s righteousness &mdash; said three times in three verses &mdash; but for the wickedness of the nations and an oath sworn to three dead men. The terrifying spy report that broke the first generation is quoted back word for word and CONCEDED rather than refuted; the &lsquo;devouring fire&rsquo; that was a warning to Israel four chapters ago now goes out ahead of it. Then the golden calf, retold by the man who was there &mdash; forty days on a mountain without bread or water, the tablets shattered before their eyes rather than beneath a mountain, Moses&rsquo; own anger gone from the story altogether, and two things about Aaron that Exodus never says. The chapter brackets itself with three Hebrew words that occur nowhere else in the Bible, and changes grammatical number at the same seam."),
    ("deut8", "Deuteronomy", 8, "Manna, and the reason for it: forty years of hunger built to teach one lesson, quoted back word for word by Jesus in the wilderness. The clothes did not wear out; the good land ahead has wheat and barley, vines and figs and pomegranates, iron in its hills and copper to mine. Then the warning, built like a trap: eat, be satisfied, build good houses, watch the silver multiply &mdash; and only then does the heart grow high and forget the God who gave it, almost in the very words the chapter itself used fourteen verses earlier for the wilderness that taught the lesson in the first place."),
    ("deut11", "Deuteronomy", 11, "Watered with the foot &mdash; Egypt&rsquo;s irrigation, and the land that drinks rain instead. Moses argues from what one generation watched and the next did not: a sea flooded over Egypt&rsquo;s horses with a verb that occurs exactly once in the Bible, and a ground that GAPES under Dathan and Abiram &mdash; retold without Korah in it, and with the word Moses had predicted rather than the one the narrator used, while what goes down the hole is the noun Genesis reserves for what the Flood destroyed. Then the early rain and the late rain, named here for the first time in the Bible, and the second paragraph of the Shema &mdash; which finally explains why the &lsquo;you&rsquo; of this book keeps changing between singular and plural mid-sentence: twelve alternating blocks in thirty-two verses, and the seam is a quotation mark. What Deuteronomy rewrote from chapter 6 it pluralised; what it copied word for word it left singular, and 11:20 is 6:9 letter for letter. Then the borders Joshua will quote back in a different tense, and a blessing and a curse set on two named mountains before either has been explained."),
    ("deut12", "Deuteronomy", 12, "The law itself begins, and it begins by demolishing everything: pull down their altars, smash their standing stones, burn their Asherahs, and destroy their NAME out of that place &mdash; then go to the place Jehovah chooses to put HIS name. Six times this chapter sends Israel to that place and not once, in the whole book, is it named; Jerusalem and Zion do not occur in Deuteronomy at all. Because one altar a week&rsquo;s walk away would end meat entirely, the chapter then concedes what Leviticus 17 forbade &mdash; slaughter and eat at home, unclean and clean alike, as you would a gazelle &mdash; and gives its own reason, distance. Only the blood is withheld, and abstaining from it takes a war-word: BE STRONG, the two other occurrences of which are the charge to Joshua. And the sentence &lsquo;each man whatever is right in his own eyes&rsquo;, which the book of Judges will end on twice, is answered fourteen verses later by moving the eyes: right in the eyes of Jehovah &mdash; the formula Kings will use to grade every king in Israel."),
    ("deut13", "Deuteronomy", 13, "In the Hebrew this chapter opens with the verse every English Bible prints as the end of chapter 12 &mdash; do not add to it, do not take from it &mdash; and the Masoretes put their heaviest paragraph break straight after it, attaching it to neither side. <a href=\"deuteronomy-4.html\">Deuteronomy 4:2</a> gave the same command in the plural; here it is singular, which turns a duplicate into evidence. Then the hardest question the last chapter raised: if worship happens in one place and no other, who decides? Three cases, each marked off by its own scribal break &mdash; a prophet whose sign actually COMES TRUE and who then says &lsquo;let us go after other gods&rsquo;; a brother, a son, a daughter, the wife of your bosom, the friend who is as your own soul; and a whole town. One verb drives all three. The town is put under the ban reserved for Canaanites and sentenced to be a <em>tel</em> forever &mdash; two words that stand in exactly one other verse of the Hebrew Bible, of Ai. And the chapter closes on the formula chapter 12 coined, catching the KJV and Geneva getting back the eyes they had just lost."),
    ("deut14", "Deuteronomy", 14, "The chapter turns from a town that must be burned to what may be eaten, and does something this project has not seen since Leviticus: it repeats a whole chapter of another book. Set it beside <a href=\"leviticus-11.html\">Leviticus 11</a> and the rewriting is legible line by line &mdash; twenty-one bird names against twenty, with the extra one almost certainly a kite copied twice in two spellings, since ד and ר differ by the length of a corner and each of the three names stands in exactly one verse of the Bible. Exactly ONE bird moves, the cormorant, from second in its run to last. Deuteronomy adds ten permitted animals Leviticus never lists &mdash; three of the seven game names occur nowhere else, which is why the shelf produces a unicorn and a giraffe &mdash; drops the permission to eat locusts, and swaps the operative word from Leviticus 11&rsquo;s <em>sheqets</em> (eight times there, never here) to <em>to&rsquo;evah</em>, the word chapter 13 used of a whole town&rsquo;s apostasy. It opens by forbidding two mourning rites at the one square of skin the Shema says to bind God&rsquo;s words to, and closes on a tithe you convert to silver and spend on beer."),
    ("deut15", "Deuteronomy", 15, "Every seventh year cancels every debt &mdash; and the law names, in advance, the calculation a lender will make as year seven nears. It calls that thought a word of <em>beliyya&rsquo;al</em>, worthlessness, the harshest noun this book owns and one it has used only once before, two chapters ago, of the men who talk a whole town into apostasy: in the Torah the word stands twice, and this is the only one of the two that describes a thought rather than people. Seven verses apart the chapter says there shall be no needy among you and the needy will never cease from the land &mdash; and the shelf reads the one small particle holding verse 4 together six different ways, from the KJV&rsquo;s exception clause to the Reina-Valera&rsquo;s purpose clause. Then <a href=\"exodus-21.html\">Exodus 21</a>&rsquo;s slave law is done again and the changes are legible line by line: your BROTHER is sold to you rather than bought, he may not be sent away EMPTY &mdash; the word Jacob threw at Laban and God promised Israel at the burning bush &mdash; and you must load him up, with a verb built on the word for a necklace that stands in that verse and nowhere else in the Bible. The awl through the ear stays; the DOORPOST is quietly dropped, which is the surface the Shema had reserved. And counted across the whole book, this is the first chapter of Deuteronomy with no plural &lsquo;you&rsquo; in it anywhere &mdash; exactly what the running study of that alternation predicted for a chapter borrowing from a singular source."),
    ("deut16", "Deuteronomy", 16, "The three pilgrim feasts, and each of them is pulled to the one chosen place. Passover is the sharpest case: <a href=\"exodus-12.html\">Exodus 12</a> has it eaten at home with blood on the doorframes, and this chapter forbids sacrificing it <em>within any one of your gates</em> at all. It also commands, in one word, the thing Exodus forbids in the strongest grammar Hebrew has &mdash; Exodus 12:9 bans boiling the Passover <em>in water</em> and orders it roast with fire, and 16:7 says <em>and you shall BOIL it</em>, using that verb. Twelve of the thirteen versions on this project&rsquo;s shelf decline to print it; one does; and 2 Chronicles solves it by boiling the Passover WITH FIRE and calling that the ordinance. Weeks is the one feast with no date &mdash; you start counting when the sickle goes into the standing grain, a word that stands in two verses of the Bible, both here. Booths has changed its name since Exodus, where it was Ingathering. Then judges and officers in all your gates, the bribe that blinds the eyes of the wise &mdash; the same two things chapter 10 said God does not do &mdash; and <em>justice, justice you shall pursue</em>, a doubled word standing in exactly one verse of the Hebrew Bible, which the shelf constructs six different ways. It closes on an Asherah and a standing stone, the object Jacob set up at Bethel and Moses set up twelve of at Sinai, now the thing Jehovah <em>hates</em>."),
    ("deut17", "Deuteronomy", 17, "The chapter that gave the book its name. It finishes the court that <a href=\"deuteronomy-16.html\">chapter 16</a> opened: a capital case needs two or three witnesses and may never rest on one, and the witness&rsquo;s own hand must be first on the condemned &mdash; the procedure standing behind &lsquo;let him who is without sin cast the first stone&rsquo;. A case too <em>wondrous</em> for a village bench &mdash; the same verb as &lsquo;is anything too wondrous for Jehovah?&rsquo; over Sarah&rsquo;s laughter &mdash; goes up to the one chosen place, and refusing that verdict is capital. Then, after naming thirteen foreign kings, Deuteronomy allows Israel one, on conditions that strip the office of nearly everything a king is normally for: not many horses, and no sending the people back to Egypt to buy them; not many wives; not much silver and gold. His one positive duty is to write out <em>mishneh ha-torah</em> &mdash; two words standing in a single verse of the Hebrew Bible, which the Greek read as &lsquo;this second law&rsquo;, and which is why the book is called Deuteronomy at all."),
    ("deut18", "Deuteronomy", 18, "The offices continue, and this one settles what the Levite lives on and who speaks for God. No <a href=\"deuteronomy-10.html#v10-9\">portion and no inheritance</a> for the whole tribe of Levi &mdash; the sixth and last verse to carry that formula, whose first is Rachel and Leah asking whether any is left for them in their father&rsquo;s house. The priest&rsquo;s cut is the shoulder, the two cheeks and the maw, three parts <a href=\"leviticus-7.html#v7-31\">Leviticus</a> and <a href=\"numbers-18.html#v18-18\">Numbers</a> never give him, and the maw pays a debt <a href=\"numbers-25.html#n25-6\">Numbers 25</a> left open. Then the Bible&rsquo;s longest catalogue of divination &mdash; eight practitioners in two verses, headed by a man who burns his own child &mdash; answered in four Hebrew words with the altar&rsquo;s own vocabulary: <em>you shall be whole</em>, the standard for an unblemished animal turned on a person one chapter after 17:1 forbade a blemished one. And then a prophet <em>like me</em>, a phrase used in the Torah by exactly two other speakers &mdash; Joseph claiming to divine, and God saying there is none like him in all the earth. The chapter is singular throughout except two words, <em>to him you shall listen</em>, which is the clause Acts quotes and pluralises. It closes on the test for a false prophet that <a href=\"deuteronomy-13.html#v13-3\">chapter 13</a> has already contradicted, and that two later narratives run in opposite directions &mdash; <a href=\"jeremiah-28.html#v28-9\">Jeremiah 28</a> pointing it at a rival, and Micaiah at 1 Kings 22:28 pointing it at himself."),
    ("deut19", "Deuteronomy", 19, "The survey of offices turns to homicide, and the chapter everyone calls the law of the cities of refuge never once uses the word &mdash; <em>miqlat</em> stands in twenty verses of the Hebrew Bible, eleven of them in <a href=\"numbers-35.html\">Numbers 35</a>, and not one of them in Deuteronomy. Three cities, with three more if the border is ever enlarged &mdash; a condition no later text records being met, since Joshua 20 stops at six. Roads kept clear, so that a man whose axe-head flew off the handle and killed his neighbour can outrun the <a href=\"numbers-35.html#n35-16\">redeemer of blood</a>, the same word that makes Boaz a redeemer in <a href=\"ruth-1.html\">Ruth</a>. Then the boundary stone <em>which the first ones bounded</em>, the Torah&rsquo;s only law of its kind; and the two-or-three-witnesses rule, which <a href=\"deuteronomy-17.html#v17-6\">17:6</a> restricted to capital cases and 19:15 lifts to every charge &mdash; the wording <a href=\"matthew-18.html#v18-16\">Matthew 18:16</a> quotes, and not the other. It closes on the malicious witness, sentenced to whatever he <em>plotted</em> rather than to what he did, and on the sentence that outlived its own context in every European language. ⭐ Deuteronomy writes that sentence with a preposition the other two talion lists do not use: <em>nefesh BE-nefesh</em>, life for life, stands in a single verse of the Hebrew Bible, while <a href=\"exodus-21.html#v21-23\">Exodus</a> and <a href=\"leviticus-24.html#v24-18\">Leviticus</a> both write <em>tachat</em>, in place of."),
    ("deut20", "Deuteronomy", 20, "The law of war, opened by a priest rather than Moses arguing four separate men out of their fear, and closed by an army forbidden to swing an axe at a fruit tree. Between them, four men sent home before the fighting starts &mdash; a house not dedicated, a vineyard not yet <em>chalal</em> (released to common use, the same root that meant BEGIN two chapters ago), a marriage not consummated, and finally the fearful and tender of heart, an exact phrase this book uses nowhere else. A distant city gets an offer of peace and, failing that, war on limited terms; a city inside the land gets neither &mdash; nothing that breathes may live, against six nations rather than the seven <a href=\"deuteronomy-7.html#v7-1\">chapter 7</a> named, the Girgashite quietly dropped. And the chapter&rsquo;s last sentence is one of the Torah&rsquo;s most genuinely disputed &mdash; is the tree of the field man, to withdraw before you into the siege? &mdash; read on this shelf as a question, as a claim that the tree gives life, and as a claim that it is simply not a combatant, three traditions and this translation votes for none of them."),
    ("deut21", "Deuteronomy", 21, "Five laws with nothing obvious in common, and a single root running under three of them. A body is found in a field with no known killer, and the elders of the nearest town break a heifer&rsquo;s neck in an unworked valley and wash their hands over it &mdash; a rite with no trial, no accused and no altar in it, in which the priests are brought forward and then given nothing to say. The valley is a <em>nachal eitan</em>, two words that stand in one other verse of the Bible, Amos&rsquo;s justice rolling down like waters &mdash; which settles them as ever-running water and puts the KJV and both Reina-Valeras, reading rough terrain after the Latin, on the losing side. Then a captive woman given a full month to mourn her parents before anything else is decided, and protected afterwards by a verb the Bible otherwise uses only of a kidnapper; then the law forbidding a father to advance the loved wife&rsquo;s son over the hated wife&rsquo;s firstborn, written in the two phrases <a href=\"genesis-29.html\">Genesis 29</a> used of Rachel and Leah, so that the statute describes Jacob&rsquo;s own household and forbids what Jacob did; then the stubborn and rebellious son, whose two adjectives Jeremiah turns on the whole nation and whose charge sheet &mdash; a glutton and a drunkard &mdash; is the exact insult thrown at Jesus in <a href=\"matthew-11.html#v11-19\">Matthew 11:19</a>. It closes on a corpse that may not stay overnight on the tree, for one who is hanged is a curse of God &mdash; three words the shelf has never agreed how to run, and the sentence Paul quotes in Galatians 3:13 after adding <em>everyone</em> and dropping <em>God</em>."),
    ("deut22", "Deuteronomy", 22, "Twenty-nine verses that name no person and no place, and a chapter that keeps turning out to be a rewrite. It opens by redoing <a href=\"exodus-23.html#v23-4\">Exodus 23:4&ndash;5</a> with one word changed: there the stray ox and the collapsed donkey belong to <em>your enemy</em>, and here, four times in four verses, to <em>your brother</em> &mdash; and the verb for what you must not do becomes <em>hit&rsquo;alem</em>, to HIDE YOURSELF, which stands in six verses of the Bible and three of them are these. Then the cross-dressing law, whose two halves are not built alike: a woman&rsquo;s <em>cloak</em> against a man&rsquo;s <em>keli</em>, Hebrew&rsquo;s word for gear, tools and weapons &mdash; an asymmetry the KJV, the ASV and the NWT 1984 all keep and every modern revision of them flattens to &lsquo;clothing&rsquo; on both sides. A bird&rsquo;s nest carries the identical reward as honouring your father and mother, the only two commandments in the book that share it. A parapet is named by a word found in one verse of the Bible, guarding against a sentence in which <em>the faller falls</em>. <em>Sha&rsquo;atnez</em> is the word <a href=\"leviticus-19.html#v19-19\">Leviticus 19</a> gave without its meaning, and this chapter supplies the gloss; the vineyard&rsquo;s penalty clause says the crop will BECOME HOLY, which four versions print as its opposite, <em>defiled</em>. The tassel verse uses the temple&rsquo;s own word for the chain-work on Solomon&rsquo;s pillars, on the four corners the Bible otherwise gives to the earth. And then seventeen verses of sexual case law: a husband&rsquo;s trumped-up charge answered by a cloak spread in the gate, an outrage the Bible elsewhere only ever lays at a man&rsquo;s door, a rape reasoned about as a murder, a girl in a field with <em>no one to save her</em> &mdash; and, at the last, the hardest translation decision in the chapter, where the Hebrew has a weaker verb than the one it used three verses earlier and the NIV prints &lsquo;rapes her&rsquo; at both."),
    ("deut23", "Deuteronomy", 23, "Twenty-six verses in the Hebrew and twenty-five in every English Bible, because the first of them &mdash; <em>a man shall not take his father&rsquo;s wife</em> &mdash; is the verse the English shelf just printed as 22:30. Then a fence around the <em>assembly of Jehovah</em>, a phrase that stands in eight verses of the Bible and four of them are here: the man made a eunuch, the <em>mamzer</em> (a word so uncertain the Douay leaves it in Hebrew), the Ammonite and the Moabite to the tenth generation, for ever &mdash; because nobody came out with bread and water, and because Balak hired Balaam to <em>curse</em>, in a verb Numbers never used of him &mdash; but the Edomite let in, <em>for he is your brother</em>, and the Egyptian, <em>for you were a stranger in his land</em>. A camp kept clean with a tent-peg for a trowel, because <em>Jehovah your God walks about in the midst of your camp</em> in the very participle Genesis used for Eden. A runaway slave who may not be handed back and settles <em>in the place that he chooses</em> &mdash; the formula this book otherwise reserves for God. No <em>qedeshah</em> and no <em>qadesh</em>, and the price of a dog barred from the temple; interest that is, in Hebrew, a snakebite, forbidden to a brother and allowed to a foreigner; a vow you were never obliged to make but must pay once spoken. And at the close, the hungry traveller in a neighbour&rsquo;s field: pluck ears by hand, but no sickle &mdash; the law the disciples were keeping when the Pharisees objected to the sabbath and not to the grain."),
    ("deut24", "Deuteronomy", 24, "Twenty-two verses, and the Hebrew and the English count them alike again. The Torah&rsquo;s one law of divorce opens it, and it is a four-verse sentence that commands nothing until its last clause: a wife sent away with a <em>certificate of severance</em> and married to another may never be <em>turned back to and taken</em> &mdash; three words the chapter uses once more, of a forgotten sheaf, and nowhere else in the Bible. A newly married man kept home a year to make his wife rejoice; a hand-mill that may not be taken in pledge, <em>for it is a life</em>; a kidnapper who <em>traffics in</em> a brother, in the verb <a href=\"deuteronomy-21.html#v21-14\">21:14</a> promised, and dies as a thief; a skin disease handed to the priests, with Miriam&rsquo;s seven days outside the camp as the thing to remember. A creditor who must stand in the street while the poor man chooses what to pledge, and hand the cloak back when the sun goes in, so that he may <em>lie down in his cloak and bless you</em> &mdash; the righteousness of <a href=\"deuteronomy-6.html#v6-25\">6:25</a>, earned by one garment; a hired man paid on his day, because <em>to it he lifts up his life</em>; fathers and sons who may not be put to death for each other, a verse a king of Judah obeyed by name; the stranger, the orphan and the widow, named in one breath four times; and the harvest that may not be gone over <em>after you</em> &mdash; the sheaf, the olive, the vine &mdash; because <em>you were a slave in Egypt</em>, said twice."),
    ("deut25", "Deuteronomy", 25, "Nineteen verses, the second chapter running in which the Hebrew and the English count alike, and every law in it draws a line at a body or a name. A beating counted in the judge&rsquo;s presence and stopped at forty, <em>lest your brother be made light in your eyes</em> &mdash; the ceiling the Mishnah reads as thirty-nine, which is why Paul could say he had five times received <em>forty less one</em>. Four Hebrew words about an ox that may not be muzzled while it threshes, quoted twice in the New Testament for a preacher&rsquo;s wage. The levirate: a dead brother&rsquo;s widow, a brother who <em>has no desire</em> to take her, a sandal pulled off before the eyes of the elders and a spit in the face that is Miriam&rsquo;s from <a href=\"numbers-12.html#v12-14\">Numbers 12:14</a> &mdash; and a house named for the sandal for ever. A wife who seizes a man by his private parts in a fight, and the Torah&rsquo;s one law of mutilation, closed by the fifth and last <em>your eye shall not pity</em>. <em>A stone and a stone</em> in the bag, an ephah and an ephah in the house, and the <em>whole stone</em> that is also the stone Solomon&rsquo;s temple is built of. And Amalek: the twin of <a href=\"deuteronomy-24.html#v24-9\">24:9</a>, Esau&rsquo;s own word for the stragglers, and the sentence <a href=\"exodus-17.html#v17-14\">Exodus 17:14</a> gave to God handed to Israel &mdash; <em>blot out the remembrance of Amalek</em> &mdash; in a chapter that opened by raising a son so that a name would <em>not</em> be blotted out."),
    ("deut26", "Deuteronomy", 26, "Nineteen verses, the third chapter running in which the Hebrew and the English count alike, and the last law of the code that began at chapter 12 &mdash; two liturgies, a creed and an oath, put in an ordinary Israelite&rsquo;s mouth to say at the altar. A basket of firstfruits &mdash; <em>tene</em>, a word in four verses of the Bible, all in this book &mdash; carrying <em>some of the first of all the fruit of the ground</em>, which is Cain&rsquo;s phrase from <a href=\"genesis-4.html#v4-3\">Genesis 4:3</a> with the missing word put back. Then the creed: <em>a wandering Aramean was my father</em>, three words in one verse of the Hebrew Bible, whose second word means lost, and perishing, and, in the Douay, pursued; a father called by the name Genesis gives only to Laban&rsquo;s family; and a history of Egypt built tile by tile from <a href=\"numbers-20.html#v20-15\">Numbers 20</a> and Exodus, with Numbers&rsquo; messenger left out. The third-year tithe sworn out of the house with the verb this book keeps for <em>burning out the evil</em>, three denials that all touch death, and <em>look down</em> &mdash; the verb for looking out of a window &mdash; asked of heaven. And a verb in two verses of the Bible that the shelf renders seven ways: <em>you have declared Jehovah</em>, <em>Jehovah has declared you</em>, the offer of <a href=\"exodus-19.html#v19-5\">Exodus 19:5</a> accepted forty years on, and a nation dressed in Aaron&rsquo;s own <em>glory</em>."),
    ("deut27", "Deuteronomy", 27, "Twenty-six verses, the fourth chapter running in which the Hebrew and the English count alike, and the code closed at chapter 26 is now staged as a ceremony &mdash; Exodus 24 done again on the far side of the Jordan. Great stones coated with <em>lime</em> (a word the prophets otherwise keep for what a kiln makes of a body), the whole law written on them <em>plainly and thoroughly</em> with the adverb this book gives its judges, and an altar of <em>whole stones</em> &mdash; the honest weight&rsquo;s adjective of <a href=\"deuteronomy-25.html#v25-15\">25:15</a> &mdash; over which no iron may swing, bearing the one peace offering in Deuteronomy. <em>Be silent and hear</em>, with a verb in one verse of the Bible; six tribes on Gerizim to bless and six on Ebal <em>for the curse</em>, the two Jacob cursed at the head of the blessing side and Reuben first on the other; and then twelve curses, each answered by all the people with <em>Amen</em> &mdash; a word that only one accused wife, at <a href=\"numbers-5.html#v5-22\">Numbers 5:22</a>, had spoken before them. Among the twelve: the carved-and-cast image of Micah&rsquo;s house, the eighth and last <em>abomination to Jehovah</em> in the book, a mother-in-law named with a word the Bible uses once, a neighbour struck <em>in secret</em>, and a last curse Paul quotes with an <em>all</em> the Hebrew does not have."),
    ("deut28", "Deuteronomy", 28, "Sixty-nine verses in the Hebrew and sixty-eight in the English, so the four-chapter run of matching counts ends here &mdash; the blessings and the curses of the covenant, fourteen verses of the one and fifty-four of the other, and the curse is a single Masoretic paragraph with no break in it. <em>If you truly listen</em>, with the doubled verb of Marah; blessings that <em>overtake</em> you with the pursuer&rsquo;s verb from the Song of the Sea; six <em>blessed</em> in four verses answered by six <em>cursed</em>, the words God said to the serpent and to Cain; the basket of <a href=\"deuteronomy-26.html#v26-2\">26:2</a> beside the kneading-bowl of the exodus night; the fruit of the belly that Elizabeth will bless at <a href=\"luke-1.html#v42\">Luke 1:42</a>. Then a sky of bronze over an earth of iron &mdash; <a href=\"leviticus-26.html#v26-19\">Leviticus 26</a>&rsquo;s two metals the other way up &mdash; the boil of Egypt, a word the Masoretes would not read aloud, the three verbs of chapter 20 with the other man arrived, a yoke of iron that <a href=\"jeremiah-28.html#v28-14\">Jeremiah 28</a> will wear, an eagle-nation whose tongue you will not understand, a siege in which the delicate woman eats in secret, the dove&rsquo;s own <em>no resting place for the sole of her foot</em> from <a href=\"genesis-8.html#v8-9\">Genesis 8:9</a>, <em>you have forsaken me</em> &mdash; two words that stand in one other verse of the Bible, Psalm 22&rsquo;s &mdash; and, at the very end, a return to Egypt in ships to a market where no one buys."),
    ("deut29", "Deuteronomy", 29, "Twenty-eight verses in the Hebrew and twenty-nine in the English &mdash; the same seam <a href=\"deuteronomy-28.html#v28-69\">28:69</a> already flagged, so every verse here runs one number behind its own common English citation. The covenant is sworn in Moab: everyone made to stand, <em>your heads, your tribes, your elders and your officers&hellip; your little ones, your wives, and the stranger who is in your camp, from the hewer of your wood to the drawer of your water</em>, and the oath binding <em>whoever is standing here with us today&hellip; and also whoever is not here with us today</em>. A heart Jehovah has &ldquo;not given&rdquo; to know, set beside forty years in which a garment and a sandal did not wear out; <em>a root bearing gall and wormwood</em>, the exact clause the Greek Bible hands to Hebrews 12:15 four centuries on; a man who blesses himself, &ldquo;I shall have peace, though I walk in the stubbornness of my heart&rdquo; &mdash; three words the Bible will not use again until Jeremiah repeats them seven times, once with the identical false peace in a false prophet&rsquo;s own mouth. Then a land of sulfur and salt that the nations will ask about, as they asked about <a href=\"genesis-19.html#v19-24\">Sodom and Gomorrah</a> &mdash; and, named beside them here, Admah and Zeboiim, the two lesser cities <a href=\"genesis-14.html#v14-2\">Genesis 14</a> already listed but Genesis 19&rsquo;s own destruction narrative left out. A nation uprooted with the very verb <a href=\"jeremiah-1.html#v10\">Jeremiah 1:10</a> will be commissioned with; and the sentence the rabbis marked with dots: <em>the hidden things belong to Jehovah our God, but the revealed things belong to us and to our children for ever.</em>"),
    ("deut30", "Deuteronomy", 30, "Hebrew and English verse numbers align again after chapter 29's offset. The root <em>shuv</em>, &lsquo;to return&rsquo;, is sounded seven times in the first ten verses &mdash; Jehovah himself will <em>turn your captivity</em>, gather the outcasts from the very end of the heavens, and <em>circumcise your heart, and the heart of your seed</em> &mdash; an answer, unstated, to <a href=\"deuteronomy-29.html#n29-1\">29:4</a>'s heart Jehovah once said he had not given. Then the commandment that is <em>not too hard&hellip; and not far off</em> &mdash; not in the heavens, not beyond the sea, but a word already <em>in your mouth and in your heart</em>, the same three verses Paul will one day rework, swapping the sea for the abyss, into a question about who brings Christ down and who raises him from the dead. And the chapter's own close: one verb that simply declares the news, a second, older one that calls heaven and earth to witness it, and a covenant ceremony's last word &mdash; <em>choose life</em>."),
    ("deut31", "Deuteronomy", 31, "Thirty verses, and the shortest weekly portion in the Torah: <em>Vayelekh</em>, named for a verb of going that never says where. Moses at a hundred and twenty says he can no longer <em>go out and come in</em> &mdash; the same two words Caleb will use at eighty-five to say he still can &mdash; and hands the command over: <em>be strong and resolute</em>, said three times in one chapter and in two different numbers, with a promise under it that is not about God not failing but about a hand that will not go slack. Then the instruction is written down and becomes an object with custodians: read aloud to men, women, little ones and the resident foreigner every seventh year, at the Feast of Booths, in the vocabulary of the day at Horeb it is built to repeat. The tent of meeting appears for its only verse in the whole book; a pillar of cloud stands at the door; and God dictates a song to be filed in advance as evidence, alongside two other witnesses &mdash; a book laid beside the ark rather than in it, and the sky. And in between, the sentence that gave a later book its pun: <em>I will surely hide my face.</em>"),
    ("deut32", "Deuteronomy", 32, "Fifty-two verses of poetry, <em>Ha&rsquo;azinu</em> &mdash; the Song of Moses, opening <em>give ear, heavens, and let me speak</em>. The Rock named for the first time in the Bible, rain and dew for doctrine, an eagle stirring up its nest, and Israel under a name the prose never uses &mdash; <em>Jeshurun</em>, who grew fat and kicked; gods the fathers never dreaded, and a God pictured, in one line, both as father and in labor. A textual fork runs through the poem&rsquo;s own structure &mdash; &lsquo;sons of Israel&rsquo; in the Hebrew this project translates, &lsquo;sons of God&rsquo; in a Dead Sea fragment and the Greek Septuagint &mdash; the same fork a New Testament letter reads, at the song&rsquo;s own last verse, as angels commanded to worship the Son. Then Moses hands his last words to a man the text suddenly calls by his old name, and climbs, at God&rsquo;s own command, the one mountain from which the whole land is visible and none of it reachable."),
    ("deut33", "Deuteronomy", 33, "Moses&rsquo;s own last words, a blessing on the tribes before he climbs the mountain the previous chapter named. He is called &lsquo;the man of God&rsquo; &mdash; a title the whole Torah gives him exactly once, here and nowhere else &mdash; and opens with a theophany whose &lsquo;fiery law&rsquo; is a single Masoretic word no two shelf versions read alike. Reuben and Judah both get the thinnest blessings in the chapter; Levi&rsquo;s curse in Genesis becomes Levi&rsquo;s priesthood here, the hinge a massacre this project has already shown in full; Benjamin the wolf becomes Benjamin the beloved. Joseph&rsquo;s blessing borrows its own closing words from Genesis, letter for letter, and its wild ox pays off a promise made two chapters ago. And eleven tribes are named. The twelfth, cursed alongside Levi on the very same page of Genesis, never appears at all."),
    ("deut34", "Deuteronomy", 34, "The last chapter of the Torah: Moses climbs the mountain this book has kept pointing toward, is shown the whole land, and dies at a hundred and twenty with his eye undimmed and his vigor unspent &mdash; the first person in five books to land exactly on the number Genesis once set as a ceiling for everyone. He is buried by a hand the grammar never names, in a grave this chapter says twice that no one has ever found. Aaron's promised mourning arrives on schedule, thirty days; Joshua's two hands, commanded as one, are still two. And the closing verdict &mdash; a sentence spoken nowhere else in the whole Hebrew Bible &mdash; reaches back past a rarer, stranger idiom for how God knew him and settles, one last time, on &lsquo;face to face.&rsquo;"),
    ...
    ("josh2", "Joshua", 2, "Two spies leave Shittim for Jericho and lodge with Rahab, a prostitute whose house is built into the city wall. She hides them under the flax on her roof, sends the king&rsquo;s men off toward the fords with a lie, and then, on the roof, recites Israel&rsquo;s own words back to it &mdash; the Song of the Sea&rsquo;s melting inhabitants, Deuteronomy&rsquo;s &lsquo;God in the heavens above and on the earth below&rsquo; &mdash; before asking for <em>chesed</em> and a true sign. The sign is a cord whose Hebrew name, <em>tiqvah</em>, everywhere else in the Bible means hope; scarlet, like the thread once tied on Tamar&rsquo;s son; hung in a marked house whose door no one may leave, the Passover night turned inside out. Three days in the hills, and the spies bring Joshua back not a map but her sentence: the land is given, and all who live in it melt away."),
    ("josh3", "Joshua", 3, "The crossing. Israel waits three days at the river&rsquo;s edge, then follows the ark of the covenant two thousand cubits behind it &mdash; carried now by priests, not the Kohathites of Numbers 4 &mdash; into a Jordan &lsquo;full over all its banks all the days of harvest.&rsquo; The moment the priests&rsquo; feet are wet, the water from upstream stands up &lsquo;in one heap,&rsquo; <em>ned</em>, the Song of the Sea&rsquo;s own word, far away at a town called Adam whose riverbank has fallen in at least twice since; the water below runs out to the Salt Sea, and the whole nation crosses on dry land opposite Jericho while the priests stand still in the riverbed. God speaks once, to say who the day is for: &lsquo;This day I will begin to make you great&rsquo; &mdash; Deuteronomy 2:25&rsquo;s sentence with Joshua as its object. A living God, without an article; the Lord of the whole earth, a title the Bible uses here for the first time; and a written <em>at Adam</em> under a read <em>from Adam</em>."),
    ("josh4", "Joshua", 4, "Twelve men go back into the riverbed for twelve stones, one on each man&rsquo;s shoulder, and set them down where the nation sleeps its first night in the land &mdash; <em>a memorial for the sons of Israel for ever</em>, with a question built into it: <em>when your sons ask tomorrow, what are these stones to you?</em> The same catechism the Torah wrote for Passover night, and the crossing is dated to the tenth of the first month, the day the Passover lamb is chosen. Twelve more stones stand in the middle of the Jordan &lsquo;until this day&rsquo; &mdash; or the same twelve: the Hebrew says neither OTHER nor THE, the Greek and the Latin say <em>other</em>, the NIV says one. Reuben, Gad and half Manasseh cross in battle order, forty thousand of some hundred and ten thousand, keeping Numbers 32&rsquo;s oath in its own words; Jehovah makes Joshua great &lsquo;in the eyes of all Israel,&rsquo; the Torah&rsquo;s last three words; and when the priests&rsquo; soles are pulled loose onto the bank the river comes back over all its banks. The chapter opens with a Masoretic break in the middle of a verse, tells the ark&rsquo;s exit twice, and ends with the fathers taught to say <em>us</em> of a sea they never saw."),
    ("josh5", "Joshua", 5, "The kings west of the river hear, and their heart melts &mdash; Rahab&rsquo;s sentence, in the narrator&rsquo;s mouth, over a written <em>we</em> the Masoretes read as <em>they</em>. Then a knife: make yourself knives of flint and circumcise the sons of Israel again, a second time, because everyone who left Egypt is dead and no one born on the way was ever cut. A nation sits still in enemy country until it revives, and the camp gets its name &mdash; <em>today I have rolled away the reproach of Egypt from off you</em> &mdash; from a verb that rolls a stone off a well. The first Passover in the land, on the plains of Jericho; the next morning they eat the land, roasted grain and unleavened bread, on the morrow after the Passover &mdash; the day Numbers 33 gives for leaving Egypt &mdash; and the morning after that the manna ceases, with the sabbath&rsquo;s own verb. Then a man with a drawn sword outside Jericho, who answers <em>are you for us or for our adversaries?</em> with a single <em>no</em>, and gives Joshua the sentence Moses heard at the bush &mdash; with one sandal instead of two, and no ground."),
    ("josh7", "Joshua", 7, "One man takes from Jericho&rsquo;s devoted things, and the chapter opens by blaming a nation for it. The spies say Ai is small; about three thousand go up and run, thirty-six die on the descent, and <em>the heart of the people melted and turned to water</em> &mdash; Rahab&rsquo;s sentence about her own people, said now of Israel, the third melted heart in the book. Joshua tears his clothes with Jacob&rsquo;s word, falls on his face with Goliath&rsquo;s, and prays the wilderness generation&rsquo;s own complaint word for word &mdash; <em>to give us into the hand of the Amorites, to destroy us</em> &mdash; the sentence he once tore his clothes to answer. God&rsquo;s reply is a word written one letter short, <em>Get up!</em>, and five <em>and also</em>s, more than any verse in the Bible: Israel has become <em>devoted to destruction</em>, as Deuteronomy 7:26 warned. The nation is sifted tribe, clan, household, man, with the verb that captured Jericho and no lot named; Judah is taken first; and Achan &mdash; a Zerahite, descendant of the twin with the scarlet thread &mdash; confesses in the grammar of Genesis 3:6 and the vocabulary of Deuteronomy 7:25: <em>I saw &hellip; I coveted them &hellip; I took them</em>. A mantle of Shinar, a tongue of gold, a heap of stones, and a valley named Trouble that Hosea will call a door of hope."),
    ("josh8", "Joshua", 8, "Ai falls the second time, and this time by a plan rather than a miracle: thirty thousand men by night, an ambush behind the city, a decoy that lets Israel &lsquo;be struck&rsquo; on purpose and run &lsquo;as at first&rsquo; &mdash; performing the very collapse that just cost them a battle and a man. Jehovah opens the chapter with the exact two verbs Moses used on the edge of the land the first time, before the spies were ever sent, and this time the concession is real: only Jericho&rsquo;s cherem is lifted, and the plunder is Israel&rsquo;s to keep. Joshua rises early a fourth and final time, with the elders restored to his side; a javelin held out and not lowered decides a battle the way a raised hand once decided one against Amalek; and the king of Ai is buried under the identical phrase that buried Achan one chapter before &mdash; a great heap of stones, still there, it says, until this day. Then the campaign stops, and Joshua builds the altar Deuteronomy promised on Mount Ebal, half the nation facing Gerizim and half facing Ebal, and copies the law onto stone &mdash; a &lsquo;copy&rsquo; whose own mistranslation, centuries later, will name a book that has not been written yet."),
    ...
    ("1sam1", "1 Samuel", 1, "The book that gives Israel its kings opens on a barren woman. Hannah, provoked year after year by her rival, prays silently at Shiloh until the priest Eli takes her for a drunk; she vows her son to God, and when Samuel is born she carries the weaned boy back and gives him away — 'lent to Jehovah' for life. The FIRST 'Jehovah of armies' in the Bible, a wordplay ('asked') that reaches toward Saul, and the seed of the song (ch 2) that Mary's Magnificat will be built on."),
    ...
    ("lam3", "Lamentations", 3, "The book's own dead center, and its most disciplined poem: sixty-six verses, the Hebrew alphabet worked through not once but three times over, every one of its twenty-two letters opening three consecutive lines in a row. For the first time in Lamentations the corporate 'she' gives way to a single voice — 'I am the man who has seen affliction' — and for eighteen unbroken verses that voice catalogues what has been done to it: walled in, hunted like prey, an archer's target, ground down, until it says flatly, 'my strength has perished, and my hope from Jehovah.' Then, with no new fact to explain it, only a chosen memory: 'The loving devotion of Jehovah never ceases... they are new every morning; great is your faithfulness' — six words that became a hymn a century of readers still sing. &#9888; The voice widens to 'we,' confesses, falls back into raw lament, and swaps two letters of its own alphabet out of order exactly where chapter 2 already promised it would. It ends, sixty-six verses after it began, on a plea for the enemy's destruction that sits beside the hope without resolving it."),
    ...
    ("jhn7", "John", 7, "&ldquo;I am not going up to this feast&rdquo; &mdash; and then he goes anyway, in secret, nine verses later. ⚠ A single Greek word decides whether this is a real contradiction or not: the earliest manuscripts read &lsquo;not,&rsquo; the majority text reads &lsquo;not yet,&rsquo; and a third-century pagan philosopher already used this exact verse to call Jesus a liar. The crowd at the Feast of Tabernacles cannot agree what he is &mdash; good man, deceiver, the Prophet, the Christ, or disqualified outright because everyone already knows he's from Galilee, not Bethlehem where the Christ is supposed to be born. On the feast's last and greatest day, during the Temple's own water-pouring ritual, he stands up and redirects the whole ceremony onto himself: &ldquo;let anyone who thirsts come to me and drink.&rdquo; Officers sent to arrest him come back empty-handed with the best line in the chapter &mdash; &ldquo;no one has ever spoken like this man&rdquo; &mdash; and the chapter's last verse opens directly into one of the New Testament's most famous textual disputes, absent from the earliest manuscripts entirely."),
    ("jhn8", "John", 8, "This chapter opens with a story absent from the two oldest complete Greek New Testaments: the woman caught in adultery, and the accusers who leave one by one, oldest first, after &ldquo;let the one without sin cast the first stone.&rdquo; ⚠ This translation states the textual situation plainly rather than passing over it in silence. What follows escalates fast &mdash; &ldquo;I am the light of the world,&rdquo; staged against the Feast of Tabernacles' own blazing lampstands; a claim with no grammatical predicate at all (&ldquo;unless you believe that I am&rdquo;) that this chapter refuses to complete until its final verse; and an argument with his own new believers that turns, verse by verse, into the single most historically dangerous line in this Gospel &mdash; addressed plainly, including why fifteen centuries of its worst use gets the text wrong. It ends on the sentence the Greek grammar itself was built toward: &ldquo;before Abraham was, I am&rdquo; &mdash; and men picking up stones before he finishes speaking."),
    ...
    ("zechariah2", "Zechariah", 2, "The four horns and the four craftsmen, then a man goes out with a cord to measure Jerusalem — and discovers the city has already outgrown the whole project. Two more of Zechariah’s night visions, run together in one Hebrew chapter (what English splits as 1:18–21 and all of chapter 2). The vision answers itself: instead of a wall, Jehovah promises to BE one — “I myself will be a wall of fire around her, and I will be the glory within her” — a city measured for its extent and then deliberately left unwalled, because no wall could hold what’s coming and none is needed. ⚠ Verse 12 holds one of the book’s real cruxes — an unnamed “me,” sent by “Jehovah of armies,” reporting words that then slide, without warning, into Jehovah’s own first-person voice (“touches the pupil of HIS eye”). And a promise widens past Israel for the first time: “many nations will join themselves to Jehovah… and become MY people.” ⚠ A 1695 German engraving illustrates the four-horns vision under its OWN English-style numbering, “Zach. I, 18” — the same picture, counted the other way."),
    ("zechariah5", "Zechariah", 5, "The SIXTH and SEVENTH night visions, back to back. First a scroll flies overhead, thirty feet by fifteen — the exact footprint of Solomon's temple porch — written on both sides with a curse against thieves on one face and against those who swear falsely by Jehovah's name on the other, covering between them both tables of the Ten Words. Then a basket goes out, and inside it, discovered rather than placed there, sits a woman the angel names outright: “This is Wickedness.” He shoves her back down and seals the basket's mouth with a disc of lead — and two women with wings “like the wings of a STORK” lift the whole thing into the air to build it a house in the land of SHINAR, Babylon, the same plain where an earlier generation raised a tower “with its top in the sky.” ⚠ The stork's own Hebrew name, chasidah, is built on chesed, covenant kindness — “the pious one” — yet Torah lists it among the unclean birds anyway: Wickedness leaves the holy land on the wings of a bird whose name and status contradict each other. And a genuine, unresolved crux sits at the vision's center: does “this is their EYE in all the land” (v6) mean their appearance, or — as the Septuagint reads it, one Hebrew letter apart — their INIQUITY?"),
    ("zechariah4", "Zechariah", 4, "The FIFTH night vision, and the book's most famous sentence. An angel wakes the drowsy prophet to show him a solid-gold lampstand, self-feeding from a reservoir bowl through pipes with no human hand shown refilling it, flanked by two olive trees no one can explain. The answer, when it comes, is addressed straight to the governor Zerubbabel: “Not by MIGHT, and not by POWER, but by my spirit,” says Jehovah of armies — chayil and koach, strength and capacity, both denied at once to a man rebuilding a temple with no army of his own. A “great mountain” becomes a plain before him; he brings out the top stone to shouts of “Grace, grace!”; and “the day of small things” is named directly — a modest house need not match Solomon's to succeed. The seven eyes of Jehovah return, one chapter after they were first engraved on a single stone. It closes on the two olive branches — literally “ears” of olive, the same word-root as the Judges 12 shibboleth — identified only as “the two sons of oil,” not “the two anointed ones” as most versions print it: a harvest word for fresh oil, deliberately not the word for anointing at all."),
    ("zechariah3", "Zechariah", 3, "The fourth night vision, and the first with a human being on trial. Joshua the high priest stands before the angel of the LORD in FILTHY garments — one of the crudest words in the language, no ordinary dirt — while “the Accuser” (Hebrew ha-satan, WITH the definite article: a job title, not yet a name — the same figure and the same courtroom scene Job 1’s own note named seven chapters in advance) stands at his right hand to accuse him. Jehovah rebukes the Accuser outright, on the ground that Jerusalem is HIS to choose; the filthy garments come off, fine robes go on, and Joshua is offered “free access” among the angels of the divine council itself. Then the vision widens past one man: “I am bringing my servant, SPROUT” — tsemach, the messianic term this project already met at Jeremiah 23:5, here given its first bare unveiling as a NAME, not a title (the Hebrew carries no definite article) — and a stone with SEVEN EYES, which this translation reads literally rather than softening to “facets,” the identical image and count that returns one chapter from now on a lampstand, and centuries later on a slain Lamb in Revelation 5:6. It closes on the most ordinary image in the whole book: neighbors inviting each other to sit under their own vine and fig tree."),
...
TEASERS_ES = {
    "num22": "Israel acampa en las llanuras de Moab y el relato los abandona por completo durante tres cap&iacute;tulos. Balac rey de Moab acaba de ver lo que le pas&oacute; a Sej&oacute;n y a Og, deduce que no puede ganar una batalla y sale a buscar un arma a la que un ej&eacute;rcito no pueda responder: manda a buscar, a cientos de kil&oacute;metros, a un vidente extranjero llamado Balaam hijo de Beor, un hombre cuyo nombre aparece siglos despu&eacute;s en una inscripci&oacute;n rota sobre yeso desenterrada en el valle del Jord&aacute;n en 1967. Lo que sigue es uno de los pasajes m&aacute;s extra&ntilde;os de la Tor&aacute;. Dios proh&iacute;be el viaje, luego lo permite, y luego se enoja porque se hace. Un &aacute;ngel con la espada desenvainada corta el camino tres veces, y la &uacute;nica que puede verlo es la asna &mdash;a la que golpean por ello, dos veces, hasta que Dios le abre la boca y ella pregunta qu&eacute; ha hecho. A un visionario profesional lo ve mejor su propia bestia, y cuando por fin le destapan los ojos se ofrece a volverse y le dicen que siga. Dos palabras sostienen el cap&iacute;tulo. Balac pide a Balaam que MALDIGA a Israel con un verbo hebreo; Balaam le repite la petici&oacute;n a Dios con otro distinto, y la negativa de Dios vuelve a la palabra original de Balac &mdash;un intercambio de tres movimientos que solo dos de trece versiones dejan ver. Y el &aacute;ngel se planta en el camino <em>le-satan</em>, como un SATAN&Aacute;S: el mismo sustantivo que esas trece versiones imprimen como nombre propio en Job y en Zacar&iacute;as, y que ninguna imprime aqu&iacute;. La asna, entretanto, cuenta sus golpes como &laquo;tres <em>regalim</em>&raquo; &mdash;la frase exacta que la Tor&aacute; usa en todos los dem&aacute;s sitios para las tres peregrinaciones anuales a las que se te manda ir caminando.",
    "num36": "<strong>El último capítulo de Números</strong>, y es una apelación contra una sentencia que el propio libro ya dictó. En <a href=\"numbers-27.es.html\">Números 27</a> las hijas de Zelofehad ganaron la tierra de su padre muerto; aquí los hombres de su propio clan se acercan &mdash;el mismo verbo que usaron las hermanas, en masculino&mdash; y señalan que si ellas se casan fuera de la tribu la tierra se va con ellas, y que el jubileo confirmará la pérdida en vez de deshacerla. ⭐ Moisés les da <strong>el mismo veredicto que dio a las mujeres</strong>: <em>ken &hellip; dovrim</em>, «hablan con razón» &mdash;una fórmula que aparece en exactamente dos versículos de la Biblia hebrea, y los dos son este mismo caso. A las dos partes se les dice que tienen razón, y ninguna de las dos sentencias se retira. ⚠ Tres veces en este libro alguien pide algo a Moisés con un mismo verbo, <em>gara</em>, ser RESTADO &mdash;los hombres inmundos en 9:7, las hijas en 27:4, los del clan aquí&mdash; y las tres ganan; ninguna de las trece versiones usa una sola palabra en los tres sitios. ⚠ El versículo que concede a las hijas su elección lleva un pronombre MASCULINO («a los ojos de ellos»), y es el único sufijo masculino plural del capítulo &mdash;seis versículos después la misma expresión, «su padre», se escribe en femenino. Once versiones borran los ojos; una hace el pronombre femenino sin decirlo. ⚠ La cerca alrededor de la tierra está hecha con el verbo del matrimonio: los israelitas deben AFERRARSE a su heredad, <em>davaq</em>, la palabra de Génesis 2:24. Las cinco hermanas se casan con sus primos, la tierra se queda, y la lista de sus nombres &mdash;dada cuatro veces en la Biblia&mdash; aparece reordenada aquí, en la única lista que registra lo que de verdad hicieron. Cierra con un colofón: en el Sinaí Dios mandó a Moisés, y en las llanuras de Moab manda POR MANO DE Moisés, añadiendo una palabra que Levítico no necesitó &mdash;<em>mishpatim</em>, juicios, la jurisprudencia que este libro inventó. Nadie ha cruzado nada.",
    "num35": "Las ciudades de refugio &mdash;y el capítulo es donde vive el verbo propio del sexto mandamiento: <em>ratzach</em>, la palabra de <em>lo tirtzach</em>, aparece aquí <strong>veinte veces de las cuarenta y cinco de toda la Biblia hebrea</strong>, en catorce de treinta y cuatro versículos. ⭐ El hebreo usa UNA sola palabra para el que mata por accidente y el que mata por odio, y todo el negocio del capítulo es clasificarla &mdash;así que esta traducción imprime «homicida» en todas partes, donde once de las trece versiones la parten en dos y entregan al lector el veredicto antes del juicio. Las dos que no lo hacen son la RV 1909 y la RV60. ⚠ En el v27 la ley usa ese mismo verbo para una muerte que ella declara sin culpa: el redentor de la sangre hace <em>ratzach</em> al <em>rotzeach</em> y no hay culpa de sangre &mdash;y ni una sola versión de ninguno de los dos estantes repite la palabra. ⚠ El verbo que DESIGNA las seis poblaciones es el causativo de la raíz que hay detrás de <em>miqreh</em>, el AZAR: se manda a Israel hacer que ocurra un accidente a propósito, para gente a quien le ocurrirá un accidente. Aquel de quien huyen es un <em>go'el</em> &mdash;un REDENTOR, el mismo oficio que rescata el campo de un pariente pobre y que ejerce Booz en Rut&mdash;, y en el v12, la única vez que el hebreo lo deja a secas, tres versiones echan mano del PARIENTE. Cuarenta y ocho poblaciones levíticas y un pastizal nombrado con el verbo de expulsar; mil codos en el v4 contra dos mil en el v5, mostrado y no resuelto; ningún rescate aceptado ni por el culpable NI por el inocente; y una condena que solo termina cuando muere el sumo sacerdote. Cierra con la razón de todo ello: la sangre corrompe la tierra, en un causativo que aparece en dos versículos de la Biblia &mdash;porque el propietario vive en la finca.",
    "num34": "Las fronteras de Canaán, trazadas de esquina a esquina &mdash;y el capítulo es una ESCRITURA DE PROPIEDAD, no una descripción: <em>gvul</em>, frontera, aparece aquí dieciséis veces en veintinueve versículos, más que en ningún otro capítulo de la Torá y casi el triple que el segundo. ⭐ La tierra no se DA aquí: CAE sobre vosotros (v2) &mdash;el vocabulario de la suerte, que el capítulo dice sin rodeos once versículos después, y que solo la Douay-Rheims explica, metiendo «por suerte» en el v2 mismo. ⚠ En hebreo el oeste ES el mar: el v6 dice frontera-mar, mar, frontera-mar, y todas las versiones de ambos estantes imprimen «occidental» y la colisión desaparece. ⚠⚠ El monte Hor del v7 NO es el monte donde murió Aarón un capítulo antes &mdash;las mismas letras, el extremo opuesto del país&mdash;, y la Douay-Rheims es la única que nunca crea el problema, porque rechaza el nombre y lee «el monte más alto». ⭐ Tres juegos de letras llevan aquí dos sentidos sin relación cada uno: un cauce y una herencia; trazar una frontera y CODICIAR (ese verbo no existe en ningún otro lugar de la Biblia, y se escribe como el del décimo mandamiento en Deuteronomio); y llegar a una orilla y BORRAR. ⭐ La frontera golpea el HOMBRO del mar de Galilea &mdash;algo que ninguna versión de ninguno de los dos estantes dice&mdash; en una tierra que para entonces tiene manos, hombro y ojos. ⚠ Luego las cuentas: a nueve tribus se les DA su tierra y dos y media TOMARON la suya, una distinción que la NWT, la TNM 1987 y ambas Reina-Valeras conservan y que toda la tradición de la KJV aplana. Y una lista de diez jefes ordenada como el mapa, tres de los cuales nunca reciben el título de jefe.",
    "num33": "Mois\u00e9s escribe todo el itinerario de cuarenta a\u00f1os \u00e9l mismo, etapa por etapa, cuarenta y dos campamentos desde Rams\u00e9s hasta las llanuras de Moab, y su l\u00ednea de apertura cobra una promesa hecha cuarenta a\u00f1os antes: \u00c9xodo 12:12 tiene a Jehov\u00e1 decir que EJECUTAR\u00c1 juicios sobre los dioses de Egipto; aqu\u00ed, en perfecto, YA LOS HA EJECUTADO. La mayor\u00eda de los nombres de campamento intermedios no est\u00e1n atestiguados en ning\u00fan otro lugar de toda la Biblia \u2014a\u00f1os enteros de peregrinaci\u00f3n comprimidos en palabras de las que esta lista es el \u00fanico registro\u2014, hasta que la marcha se detiene dos veces: una por la muerte de Aar\u00f3n, fechada por a\u00f1o, mes y d\u00eda \u2014una de las pocas fechas tan precisas en todo el relato del desierto\u2014, en una estaci\u00f3n y con un orden que Deuteronomio 10:6 contar\u00e1 despu\u00e9s de otra manera; otra por un rey enemigo que solo, ominosamente, escucha. Luego Jehov\u00e1 ordena la conquista misma \u2014expulsar a todo habitante, destruir toda piedra grabada e imagen de fundici\u00f3n y lugar alto, repartir la tierra por sorteo\u2014, y cierra con una advertencia construida sobre dos palabras que no aparecen en ning\u00fan otro lugar del hebreo, que todo el estante coincide en llamar espinas y sobre las que discrepa, hasta en qu\u00e9 ojo va cada una.",
    "num32": "Rub\u00e9n y Gad, ricos en ganado, piden asentarse al oriente del Jord\u00e1n en vez de cruzar a Cana\u00e1n \u2014y Mois\u00e9s no responde con un fallo sino con una lecci\u00f3n de historia, repitiendo N\u00fameros 13-14 casi palabra por palabra a hombres que eran ni\u00f1os cuando el informe de los exploradores cost\u00f3 a sus padres cuarenta a\u00f1os en el desierto. El pacto que sella no lleva ninguna palabra divina \u2014la primera negociaci\u00f3n extensa de este libro resuelta enteramente por un ser humano, en nombre de Jehov\u00e1 pero no en su voz\u2014, y gira sobre una sola palabra repetida unas diez veces: todo hombre debe ir armado antes de cruzar, o \u00absabed que os alcanzar\u00e1 vuestro pecado\u00bb, una l\u00ednea que el estante traduce de dos maneras distintas seg\u00fan el idioma, y a veces seg\u00fan la d\u00e9cada, en que se lea. Gad, bendecido en el lecho de muerte de su padre como banda de asalto que acomete al fin, se convierte en exactamente eso: la vanguardia armada de Israel. Y mientras Mois\u00e9s a\u00fan negocia con las dos tribus que en verdad lo pidieron, una tercera \u2014los propios clanes de Manas\u00e9s\u2014 ya est\u00e1 tomando Galaad por conquista, sin pedirle permiso a nadie.",
    "num31": "Mois\u00e9s env\u00eda un ej\u00e9rcito a vengar a Israel de Madi\u00e1n, y la campa\u00f1a que sigue se niega a quedarse simple. Matan a todo hombre de guerra y queman toda ciudad \u2014y Balaam, el vidente gentil que llen\u00f3 tres cap\u00edtulos anteriores con su propia voz, muere en seis palabras, en la misma cl\u00e1usula que cinco reyes cuyos nombres no aparecen en ning\u00fan otro lugar de la Biblia. Luego Mois\u00e9s, furioso porque perdonaron a mujeres y ni\u00f1os, da la orden m\u00e1s dura de este libro hasta ahora. La ley de purificaci\u00f3n que sigue trata incluso una guerra que Jehov\u00e1 mand\u00f3 como algo que deja impuros a los hombres que la libraron. Y la aritm\u00e9tica, por una vez, es impecable: cada n\u00famero del impuesto de guerra y del censo cuadra exactamente, dos veces \u2014incluida una palabra de tributo de guerra, mekhes, que no aparece en ning\u00fan otro lugar de la Biblia hebrea fuera de este \u00fanico cap\u00edtulo.",
    "num30": "N\u00fameros 30 es una sola ley de votos, y el estante ni siquiera logra ponerse de acuerdo sobre d\u00f3nde empieza &mdash;solo Douay-Rheims y Ginebra 1599 coinciden con el texto masor\u00e9tico al abrir el cap\u00edtulo con la frase que la propia nota de cierre de N\u00fameros 29 prometi\u00f3; los otros once testigos del estante de este proyecto la adjuntan al cap\u00edtulo anterior. \u2b50 La ley del padre (vv3-6) usa un verbo de anulaci\u00f3n, dicho dos veces en un solo vers\u00edculo; la ley del esposo (vv7-16) usa dos, y el segundo &mdash;'anular'&mdash; es el que la ley del padre nunca usa: siete veces en cuatro de los diez vers\u00edculos, tres de ellas en un solo vers\u00edculo. \u2b50\u2b50 Tres veces una anulaci\u00f3n a tiempo se cierra con 'y Jehov\u00e1 la perdonar\u00e1' &mdash;pero la \u00fanica vez que un esposo espera demasiado, la sentencia no es perd\u00f3n para ella sino '\u00e9l llevar\u00e1 la culpa de ella' (v16): el peso no resuelto de un voto anulado no desaparece, se traslada. \u26a0 Y la \u00fanica mujer a la que ning\u00fan hombre puede contrariar es la que no responde a nadie &mdash;una viuda o una divorciada, cuyo propio voto lleva la misma fuerza incondicional que este cap\u00edtulo da a la de un hombre.",
    "num29": "Jehov&aacute; completa el calendario de ofrendas que N&uacute;meros 28 empez&oacute;, y esta mitad es donde el cap&iacute;tulo empieza a nombrar sus propias costuras en vez de dejarlas en silencio. ⭐ El d&iacute;a de toque del A&ntilde;o Nuevo (v1) nunca se llama a&ntilde;o nuevo aqu&iacute; ni en su paralelo de Lev&iacute;tico 23 &mdash;&Eacute;xodo 12:2 ya le hab&iacute;a dado ese t&iacute;tulo a otro mes, seis meses antes; &laquo;Rosh Hashan&aacute;&raquo; es un nombre posterior para un d&iacute;a m&aacute;s antiguo. ⭐⭐ El macho cabr&iacute;o del D&iacute;a de la Expiaci&oacute;n se ofrece &laquo;adem&aacute;s de la ofrenda por el pecado de la expiaci&oacute;n&raquo; (v11) &mdash;nombrando el elaborado ritual del sumo sacerdote de Lev&iacute;tico 16 por su t&eacute;rmino t&eacute;cnico y apil&aacute;ndose sobre &eacute;l en vez de discrepar de &eacute;l en silencio, como el recuento de la Fiesta de las Semanas del cap&iacute;tulo pasado, que no coincid&iacute;a con el de Lev&iacute;tico 23 sin decirlo. ⚠ Luego los n&uacute;meros mismos se vuelven la historia: la Fiesta de los Tabern&aacute;culos mantiene fijos dos carneros y catorce corderos durante siete d&iacute;as y suelta exactamente un novillo cada d&iacute;a &mdash;trece hasta siete, setenta en total&mdash;, y el Talmud (Sucá 55b) tiene una respuesta para ese n&uacute;mero que el texto mismo nunca da: setenta novillos por las setenta naciones de la propia Tabla de las Naciones de G&eacute;nesis 10, expiando por el mundo entero y no solo por Israel. ⭐ Y el octavo d&iacute;a que cierra la fiesta resulta coincidir con el A&ntilde;o Nuevo que abri&oacute; el mes, animal por animal &mdash;un novillo, un carnero, siete corderos, las dos veces. El &uacute;ltimo vers&iacute;culo del cap&iacute;tulo dice lo que todo el calendario de dos cap&iacute;tulos siempre fue: un piso bajo el culto de la naci&oacute;n, no un techo sobre el de nadie.",
    "num28": "Jehov&aacute; le entrega a Mois&eacute;s el calendario fijo de ofrendas del tabern&aacute;culo, y la gram&aacute;tica entera del cap&iacute;tulo es una sola palabra: <em>tamid</em>, continuo &mdash;toda ocasi&oacute;n desde aqu&iacute; se apila SOBRE el cordero de dos veces al d&iacute;a, nunca en su lugar. ⭐ Las cifras coinciden exactamente con &Eacute;xodo 29:38-42, sin cambios d&eacute;cadas despu&eacute;s &mdash;un momento raro de pura coherencia en un libro que no deja de repetir sus propias leyes, justo antes de que el calendario empiece a dar motivos reales para comprobar cada paralelo en vez de suponerlo. ⚠ La libaci&oacute;n del v7 no es vino sino <strong>shekhar</strong>, bebida fuerte &mdash;la misma palabra que Lev&iacute;tico 10:9 proh&iacute;be a los hijos de Aar&oacute;n beber antes de entrar en la tienda, bajo pena de muerte; aqu&iacute; se derrama, nunca se bebe, en ese mismo lugar santo. ⭐⭐ El macho cabr&iacute;o de la luna nueva lleva una frase que ninguno de los otros dos machos cabr&iacute;os del cap&iacute;tulo lleva &mdash;&laquo;a Jehov&aacute;&raquo;&mdash;, y los sabios leyeron exactamente esa rareza: el tratado Shevuot pone en boca de Resh Lakish que es expiaci&oacute;n &laquo;por haber empeque&ntilde;ecido la luna&raquo;, remont&aacute;ndose a la lumbrera menor de G&eacute;nesis 1. El d&iacute;a mismo de la Pascua no recibe ninguna ofrenda &mdash;ese rito ya se legisl&oacute; como comida dom&eacute;stica, en &Eacute;xodo 12&mdash;, y la &uacute;nica fiesta sin nada aqu&iacute; que discrepar en cambio no tiene FECHA: la Fiesta de las Semanas se nombra solo por relaci&oacute;n a un conteo, y su propio recuento aqu&iacute; discrepa realmente del de Lev&iacute;tico 23 para el mismo d&iacute;a.",
    "num27": "Cinco mujeres se plantan al frente del campamento y cambian una ley. ⭐ Las hijas de Zelofehad &mdash;nombradas en un censo dos cap&iacute;tulos antes sin raz&oacute;n declarada&mdash; se ponen de pie ante Mois&eacute;s, el sacerdote, los jefes y toda la congregaci&oacute;n y exponen una causa: nuestro padre no estuvo en la facci&oacute;n de Cor&eacute;, muri&oacute; en su propio pecado y no tuvo hijos varones, &iquest;por qu&eacute; ha de quitarse su nombre de su clan? Y la bisagra del cap&iacute;tulo es que <strong>Mois&eacute;s no falla</strong>: remite la pregunta hacia arriba, y una divisi&oacute;n de p&aacute;rrafo masor&eacute;tica cae justo ah&iacute;, entre la pregunta y la respuesta. La primera palabra de Dios es que las mujeres tienen raz&oacute;n, y en seis vers&iacute;culos una petici&oacute;n se ha hecho precedente y el precedente estatuto. &#9888; Luego el cap&iacute;tulo gira y le entrega a Mois&eacute;s su propia sentencia como un recado: sube a la cresta, mira la tierra y s&eacute; reunido a tu pueblo &mdash;por algo que hizo junto a una pe&ntilde;a treinta y ocho a&ntilde;os antes. No discute. Sus siguientes palabras registradas piden un sucesor, con una imagen que est&aacute; en exactamente dos vers&iacute;culos de la Biblia hebrea: <strong>ovejas que no tienen pastor</strong> &mdash;la otra es de un profeta dici&eacute;ndole a un rey condenado que &eacute;l no lo es. ⭐ Y la investidura est&aacute; escrita como un descenso. Josu&eacute; recibe <em>algo</em> de la majestad de Mois&eacute;s, forma partitiva que aparece en este vers&iacute;culo y en ning&uacute;n otro, y donde Mois&eacute;s hablaba con Dios directamente Josu&eacute; tiene que ponerse ante un sacerdote y consultar por el Urim, canal que la Biblia registra despu&eacute;s fallando a Sa&uacute;l y luego perdi&eacute;ndose. &#9888; Una &uacute;ltima cosa: Dios dice pon tu MANO sobre &eacute;l. Mois&eacute;s pone las dos.",
    "num26": "El libro cuenta a su gente por segunda vez, y la aritm&eacute;tica es el argumento. &#9888; <a href='numbers-1.es.html'>N&uacute;meros 1</a> cont&oacute; a una generaci&oacute;n en Sina&iacute;; este cuenta a sus hijos en las llanuras de Moab, treinta y ocho a&ntilde;os despu&eacute;s, con las mismas palabras &mdash;y los tres &uacute;ltimos vers&iacute;culos explican por qu&eacute;: no hay ni un hombre de la primera lista en esta, porque fueron sentenciados a morir en el desierto y murieron. Solo se except&uacute;an dos nombres, y son los dos exploradores que trajeron el informe minoritario. ⭐ P&oacute;nganse los dos totales uno al lado del otro y apenas se mueven: 603.550 entonces, 601.730 ahora, una p&eacute;rdida neta de menos de un tercio del uno por ciento a lo largo de toda una generaci&oacute;n de muertes. El movimiento est&aacute; todo dentro: <strong>Sime&oacute;n se desploma de 59.300 a 22.200</strong>, perdiendo casi dos tercios de sus hombres sin explicaci&oacute;n alguna, un cap&iacute;tulo despu&eacute;s de que un jefe simeonita fuera nombrado como el hombre al que mat&oacute; Finehas; Manas&eacute;s corre al rev&eacute;s y termina por delante del hermano al que Jacob hab&iacute;a puesto deliberadamente por encima de &eacute;l en G&eacute;nesis 48. ⭐ Y la mejor l&iacute;nea del cap&iacute;tulo tiene tres palabras hebreas. Despu&eacute;s de que la tierra se trague al grupo de Cor&eacute;, la lista se detiene para decir que <strong>los hijos de Cor&eacute; no murieron</strong> &mdash;una frase a la que los masoretas dieron su propia divisi&oacute;n de p&aacute;rrafo, y la raz&oacute;n de que once salmos tengan autor. &#9888; Cuatro veces esta n&oacute;mina de vivos se detiene para registrar qui&eacute;n no est&aacute; en ella: dos hombres muertos en Cana&aacute;n, dos sacerdotes muertos por ofrecer fuego extra&ntilde;o, y cinco hijas donde deber&iacute;a haber un hijo &mdash;las de Zelofehad, entre cuyos nombres hay una futura ciudad real y una Noa que no es el No&eacute; del arca, distinci&oacute;n que el ingl&eacute;s no puede imprimir y que el espa&ntilde;ol conserva por accidente.",
    "num25": "El desastre que Balaam no pudo entregar, llegando sin &eacute;l. &#9888; Israel acampa en Sitim &mdash;el sitio que lleva el nombre de las ACACIAS, la madera con que est&aacute; hecho su propio tabern&aacute;culo&mdash; y el pueblo empieza a acostarse con mujeres moabitas y a comer en los sacrificios de sus dioses. ⭐ El verbo de lo que pasa a continuaci&oacute;n est&aacute; construido sobre la palabra para una YUNTA DE BUEYES DE ARADO: Israel no se uni&oacute; a Baal-peor, qued&oacute; enganchado a &eacute;l, y todo el estante lee una uni&oacute;n. Dios manda colgar a las cabezas del pueblo de cara al sol, con un verbo que est&aacute; en exactamente dos vers&iacute;culos de la Biblia &mdash;el otro es 2 Samuel 21, donde siete hijos de Sa&uacute;l quedan en un monte hasta que viene la lluvia&mdash; y luego Mois&eacute;s da una orden distinta, y de ninguna se informa que se cumpliera. ⭐ Lo que detiene la plaga es un sacerdote con una lanza de infanter&iacute;a. Finehas sigue a un hombre dentro de la <em>qubbah</em>, palabra que nadie sabe definir, y los atraviesa a &eacute;l y a la mujer por su <em>qevah</em>: dos casi hom&oacute;nimos en una sola frase, el segundo sin paralelo en toda la Biblia, y solo la Douay-Rheims lee el cuarto como un burdel. Mueren veinticuatro mil; 1 Corintios dice veintitr&eacute;s mil, y esta traducci&oacute;n imprime la cifra hebrea sin conciliarlas. ⭐ Luego el premio: &laquo;mi pacto, paz&raquo; &mdash;dos sustantivos uno junto a otro sin nada que los ate&mdash; y una palabra que los escribas masor&eacute;ticos marcaron con una LETRA ROTA que ninguna edici&oacute;n impresa y ninguna traducci&oacute;n pueden mostrar. &#9888; A las v&iacute;ctimas se las nombra seis vers&iacute;culos despu&eacute;s de morir, y uno de los nombres se lee como la palabra para una MENTIRA. Y los zelotes del siglo I tomaron su nombre de este cap&iacute;tulo, hecho sobre su posteridad que la nota expone sin rodeos. Balaam no est&aacute; en este cap&iacute;tulo; el libro espera seis cap&iacute;tulos m&aacute;s para decir que el consejo fue suyo.",
    "num24": "Balac ha pagado tres veces por una maldici&oacute;n y est&aacute; a punto de que le digan lo que le va a pasar a &eacute;l. &#9888; El cap&iacute;tulo abre informando de que Balaam dej&oacute; de ir hacia los presagios &mdash;el plural del mismo sustantivo que acababa de negar de Israel en el cap&iacute;tulo anterior, de modo que el hombre abandona su t&eacute;cnica una frase despu&eacute;s de predicar contra ella&mdash; y en su lugar viene sobre &eacute;l el esp&iacute;ritu de Dios, sin un solo altar en la frase. ⭐ Luego se presenta dos veces, con palabras id&eacute;nticas letra por letra, como &laquo;el hombre de ojo <em>shetum</em>&raquo;: dos palabras hebreas que est&aacute;n en exactamente dos vers&iacute;culos de la Biblia, que nadie sabe construir, y que el estante lee de tres maneras a la vez: ABIERTO (KJV, las dos Reina-Valeras), CERRADO (ASV, Ginebra, Douay) o un estado que ha CAMBIADO. ⭐ Lo que sigue es la l&iacute;nea que toda sinagoga recita al entrar &mdash;qu&eacute; buenas son tus tiendas, Jacob&mdash; dicha por un adivino extranjero sobre las tiendas que le pagaron por maldecir; y un vers&iacute;culo despu&eacute;s las mismas consonantes vuelven significando &Aacute;LOES, salvo en la Douay-Rheims, la &uacute;nica que las conserva como tiendas. Balac bate las palmas de furia y hace, casi palabra por palabra, la queja que hizo la asna de Balaam dos cap&iacute;tulos antes. ⭐ Luego el cuarto or&aacute;culo: una ESTRELLA sale de Jacob y un CETRO se levanta de Israel &mdash;el vers&iacute;culo del que una revuelta jud&iacute;a tom&oacute; el nombre de su caudillo en el 132 d.C., y cuya segunda mitad est&aacute; tan rota que cada versi&oacute;n la repara de otro modo. Tres or&aacute;culos breves lo cierran, uno de ellos jugando con el nombre del quenita contra la palabra para NIDO y llamando luego Ca&iacute;n a su naci&oacute;n. &#9888; Y Balaam se va a casa ileso, lo cual es un problema, porque N&uacute;meros 31 dice que lo mataron a espada y que la ruina de Israel en Peor sucedi&oacute; por consejo suyo.",
    "num23": "Balac ha contratado una maldici&oacute;n y le van a facturar dos bendiciones. Se levantan siete altares, luego otros siete, luego otros siete &mdash;veintiun toros y veintiun carneros en tres cumbres&mdash; y cada vez la respuesta vuelve del rev&eacute;s. &#9888; L&eacute;ase con cuidado el verbo del narrador: cuatro veces dice que Dios no vino a Balaam sino que SE TOP&Oacute; con &eacute;l, la ra&iacute;z hebrea corriente para lo que sucede por accidente, y el estante entero lo alisa a &laquo;encontrar&raquo;. ⭐ El primer or&aacute;culo usa cuatro palabras distintas para maldecir en dos vers&iacute;culos, y el intercambio entre ellas es la trama: Balaam le devuelve a Balac su encargo con el verbo de Balac, responde con otro distinto, y a partir de ah&iacute; es el REY quien usa el vocabulario del profeta. Uno de esos verbos, <em>za&rsquo;am</em>, entra en la Tor&aacute; en este cap&iacute;tulo y en ning&uacute;n otro. ⭐ El segundo or&aacute;culo contiene la afirmaci&oacute;n m&aacute;s fuerte de la Biblia de que Dios no cambia de parecer &mdash;y la forma exacta que Balaam usa est&aacute; en tres vers&iacute;culos de la Biblia hebrea, y los otros dos dicen que s&iacute; cambia; 1 Samuel 15 repite luego el mismo argumento en un cap&iacute;tulo que dice dos veces que Jehov&aacute; se arrepinti&oacute; de haber hecho rey a Sa&uacute;l. Contiene tambi&eacute;n un toro salvaje: el animal que se convirti&oacute; en el UNICORNIO de la Biblia del rey Jacobo y en el rinoceronte de la Douay, una cadena de traducci&oacute;n de cuatro lenguas que el estante espa&ntilde;ol conserva en 1909 y repara calladamente en 1960. &#9888; Y en mitad de su segundo d&iacute;a leyendo presagios por dinero, junto a sus propios altares, el adivino profesional dice que en Israel no hay adivinaci&oacute;n. El cap&iacute;tulo no tiene ninguna divisi&oacute;n de p&aacute;rrafo masor&eacute;tica, y se detiene en mitad de un sacrificio.",
    "num21": "La bisagra del libro, y el cap&iacute;tulo que todo lector de la Biblia recuerda a medias. Israel destruye al rey cananeo de Arad y llama al lugar Horm&aacute; &mdash;el mismo sitio hasta el que hab&iacute;an hecho retroceder a la generaci&oacute;n anterior, rebautizado ahora por una victoria en vez de por una derrota. Luego vuelven a faltar la comida y el agua, y Dios env&iacute;a los <em>seraphim</em>: ese sustantivo plural est&aacute; en exactamente tres vers&iacute;culos de la Biblia hebrea, y los otros dos son los seres de seis alas de Isa&iacute;as junto al trono &mdash;una palabra que doce versiones transliteran cuando est&aacute; sobre Dios y las trece traducen cuando muerde a Israel. Lea despacio el vers&iacute;culo 8 y ver&aacute; que Dios no le manda a Mois&eacute;s hacer una serpiente: dice hazte un ARDIENTE, y todas las versiones de ambos estantes suplen el sustantivo que falta. Mois&eacute;s la hace de bronce, porque <em>nachash</em>, serpiente, y <em>nechoshet</em>, bronce, suenan casi igual &mdash;y la frase &laquo;la serpiente de bronce&raquo; aparece en dos vers&iacute;culos de la Biblia: este, y aquel en que setecientos a&ntilde;os despu&eacute;s un rey de Jud&aacute; la hace pedazos porque la gente hab&iacute;a empezado a quemarle incienso. Despu&eacute;s el cap&iacute;tulo se vuelve itinerario y empieza a citar poes&iacute;a que nadie m&aacute;s conserv&oacute;: cuatro l&iacute;neas de un Libro de las Guerras de Jehov&aacute; hoy perdido, un canto de trabajo dedicado a un pozo por una generaci&oacute;n que pod&iacute;a haber pleiteado por &eacute;l, y una balada burlesca amorrea sobre Hesb&oacute;n que Jerem&iacute;as volver&aacute; a cantar, casi palabra por palabra, unos ocho siglos m&aacute;s tarde contra Moab. Dos reyes niegan el paso a Israel y lo pierden todo, y el libro cambia calladamente el verbo que llevaba doce veces usando para explorar &mdash;justo en la &uacute;nica misi&oacute;n de reconocimiento de N&uacute;meros que sale bien.",
    "num17": "&#9888; Lea la nota de versificaci&oacute;n antes que nada: el cap&iacute;tulo hebreo tiene 28 vers&iacute;culos y contiene DOS episodios, as&iacute; que los vv1-15 de aqu&iacute; se imprimen en toda Biblia moderna como N&uacute;meros 16:36-50, y los vv16-28 como N&uacute;meros 17:1-13. No sobra ni falta nada: el mismo texto est&aacute; dividido en dos sitios, y aqu&iacute; llegan los quince vers&iacute;culos que N&uacute;meros 16 plant&oacute;. Primero: los incensarios de los doscientos cincuenta muertos no se destruyen sino que se CONSAGRAN &mdash;«porque se han vuelto santos», por el motivo puramente procedimental de que fueron presentados delante de Jehov&aacute;&mdash; y se baten hasta ser el enchapado del altar, de modo que todo sacrificio que Israel ofrezca despu&eacute;s se ofrece sobre una superficie hecha de la rebeli&oacute;n. Luego, a la ma&ntilde;ana siguiente, la congregaci&oacute;n entera vuelve para acusar a Mois&eacute;s y a Aar&oacute;n de asesinato: «vosotros hab&eacute;is matado al pueblo de Jehov&aacute;». &#9888; Dios repite la oferta de N&uacute;meros 16:21 casi palabra por palabra &mdash;y esta vez nadie discute; Mois&eacute;s manda a Aar&oacute;n con un incensario, el mismo objeto que mat&oacute; a 250 hombres, lleno de fuego del altar ahora enchapado con los incensarios de ellos, y Aar&oacute;n se pone entre los muertos y los vivos y la plaga se detiene en catorce mil setecientos. Luego la segunda se&ntilde;al, opuesta a la primera en todo: doce varas dejadas a oscuras una noche &mdash;y la palabra hebrea para vara es tambi&eacute;n la palabra para TRIBU, de modo que cada jefe sostiene su tribu con su nombre escrito encima. ⭐ La de Aar&oacute;n brota, florece y madura almendras en cuatro etapas dentro de un solo vers&iacute;culo &mdash;y la palabra para la flor que produce es la misma que la L&Aacute;MINA de oro que Aar&oacute;n ya lleva atada en la frente. &#9888; No termina en alivio. Termina en p&aacute;nico, sobre el verbo exacto del que iba la revuelta: todo el que se acerca, el que se acerca, muere.",
    "num18": "&#9888; El cap&iacute;tulo est&aacute; dirigido a AAR&Oacute;N, y ah&iacute; est&aacute; el hallazgo: buscado en toda la Biblia hebrea, Dios habla directamente a Aar&oacute;n sin Mois&eacute;s en la frase en exactamente cinco vers&iacute;culos, y TRES est&aacute;n aqu&iacute; (vv1, 8, 20). El otro caso sostenido es Lev&iacute;tico 10:8, la prohibici&oacute;n del vino dada justo despu&eacute;s de que dos de sus hijos murieran por acercarse mal &mdash;as&iacute; que las dos veces que Dios instruye a Aar&oacute;n por derecho propio, es despu&eacute;s de una muerte en el santuario. &#9888; Y este cap&iacute;tulo es la respuesta a la pregunta con que termin&oacute; N&uacute;meros 17. La congregaci&oacute;n hab&iacute;a gritado que todo el que se acerca muere; la r&eacute;plica no es un consuelo sino una descripci&oacute;n de puesto: <em>llevar&eacute;is la culpa del santuario</em> &mdash;<em>nasa av&oacute;n</em>, la misma expresi&oacute;n que en N&uacute;meros 14 significaba que Dios PERDONA, girada por tercera vez para que un sacerdote absorba la responsabilidad profesionalmente, en nombre de todos los dem&aacute;s. &#9888; El v2 pone las dos palabras hebreas para &laquo;tribu&raquo; una junto a otra &mdash;<em>matt&eacute; Lev&iacute; shevet avija</em>&mdash; el &uacute;nico vers&iacute;culo de la Biblia que lo hace de una misma tribu, y una de las dos es la palabra-vara a la que N&uacute;meros 17 dedic&oacute; un cap&iacute;tulo entero. La Douay-Rheims, siguiendo a la Vulgata, toma la segunda en su OTRO sentido y lee &laquo;el CETRO de tu padre&raquo;. &#9888; Luego, la econom&iacute;a entera de una tribu sin tierra: las contribuciones, las primicias, lo consagrado por an&aacute;tema (<em>j&eacute;rem</em>, la palabra m&aacute;s oscura de la Biblia, que aparece aqu&iacute; como una l&iacute;nea del presupuesto dom&eacute;stico) y los primog&eacute;nitos, rescatados por cinco siclos &mdash;que la Living Bible convierte en &laquo;dos d&oacute;lares y medio&raquo;, diciéndole a su lector que un precio serio era calderilla. ⭐ A Aar&oacute;n no se le da tierra ninguna: <em>yo soy tu parte y tu heredad</em>, un consuelo construido con las dos palabras jur&iacute;dicas que acaban de quit&aacute;rsele. Y el diezmo resulta no ser limosna sino n&oacute;mina &mdash;<em>salario</em>, a cambio de un servicio&mdash; sobre el cual los levitas son a su vez gravados con un diezmo del diezmo.",
    "num19": "&#9888; El cap&iacute;tulo que todos conocen como la vaca alazana o &laquo;red heifer&raquo; (novilla) en ingl&eacute;s, y que esta traducci&oacute;n llama sencillamente una VACA ROJA: porque <em>par&aacute;</em> significa vaca, porque la palabra hebrea para novilla (<em>egl&aacute;</em>) ya est&aacute; usada en G&eacute;nesis 15:9, y porque el estante espa&ntilde;ol entero dice <em>vaca</em> &mdash;seis de las diez versiones dicen vaca&mdash; mientras que en ingl&eacute;s la KJV, la ASV, la NIV y la TLB, cuatro, dicen novilla. ⭐ El color trabaja: <em>adum&aacute;</em>, roja, son las mismas tres consonantes que <em>adam</em>, ser humano, y el cap&iacute;tulo las reparte en orden &mdash;una vaca ROJA, su SANGRE quemada con ella, y desde el v11 el CAD&Aacute;VER humano del que todo esto trata. &#9888; Se quema fuera del campamento, entera, piel y carne y sangre y esti&eacute;rcol, con madera de cedro, hisopo y carmes&iacute; echados al fuego &mdash;los mismos tres objetos que LIMPIAN al sanado de una enfermedad de la piel en Lev&iacute;tico 14, usados aqu&iacute; al rev&eacute;s. Y luego la paradoja que da fama al cap&iacute;tulo y que nunca se explica: la ceniza deja limpio al inmundo, y todo hombre limpio que la manipula &mdash;el sacerdote, el que quema, el que recoge, el que roc&iacute;a&mdash; queda inmundo hasta la noche. ⚠ <em>N&eacute;fesh</em> hace aqu&iacute; tres oficios distintos en seis apariciones &mdash;un cad&aacute;ver, personas vivas, y dos veces el sujeto de &laquo;aquella ALMA ser&aacute; cortada&raquo;&mdash; y el v13 hace dos de ellos en una sola frase. ⭐ Y el detalle que casi todas las versiones pierden: el v9 recoge el <em>&eacute;fer</em>, las CENIZAS, pero el v17 toma el <em>afar</em>, el POLVO &mdash;la palabra de G&eacute;nesis 2 para aquello de lo que est&aacute; hecho un humano y la de G&eacute;nesis 3 para aquello a lo que vuelve. De las diez versiones comprobadas aqu&iacute;, solo la NWT 1984 imprime la diferencia. Lo que cura a un hombre contaminado por un cuerpo humano es la sustancia que un cuerpo humano es.",
    "num20": "&#9888; Treinta y ocho a&ntilde;os pasan en el blanco anterior al v1, y el cap&iacute;tulo abre enterrando a Miriam en una sola cl&aacute;usula &mdash;sin duelo registrado, cuando a Aar&oacute;n le dar&aacute;n treinta d&iacute;as en el v29. ⭐ Luego algo que ninguna traducci&oacute;n puede llevar: en el v10 Mois&eacute;s se vuelve contra el pueblo y grita <em>ha-morim</em>, «REBELDES» &mdash;que es, letra por letra, el nombre <em>Miryam</em> con el art&iacute;culo delante. Las vocales difieren y las ra&iacute;ces probablemente no tienen relaci&oacute;n, pero un israelita acaba de o&iacute;r c&oacute;mo la enterraban nueve vers&iacute;culos antes. Y el cap&iacute;tulo cierra el circuito en el v24, donde Dios le devuelve la misma ra&iacute;z: por cuanto os REBELASTEIS. ⭐ El otro hallazgo es un sustantivo. El agua-de-la-roca de <a href='exodus-17.es.html'>&Eacute;xodo 17</a> fue en un <em>tzur</em>, y Dios dijo GOLP&Eacute;ALA. Esta es en un <em>sela</em>, un pe&ntilde;asco, y Dios dice H&Aacute;BLALE &mdash;y Mois&eacute;s la golpea dos veces. Dos rocas distintas, dos palabras distintas, instrucciones contrarias, con treinta y ocho a&ntilde;os de por medio; de diez versiones comprobadas en los dos estantes solo la NWT 1984 las mantiene distintas. &#9888; Y la vara que blande es la que toma «de delante de Jehov&aacute;» &mdash;donde N&uacute;meros 17 guard&oacute; la vara florecida de Aar&oacute;n como se&ntilde;al. &#9888; Todo el estante conserva las dos cosas que lo condenan: el «&iquest;acaso NOSOTROS os hemos de sacar agua?» y el «dos veces». El lugar se llama Merib&aacute;, de <em>rib</em>, pleitear &mdash;la segunda Merib&aacute;, porque &Eacute;xodo 17 ya nombr&oacute; una&mdash; y la Living Bible la glosa como «aguas de rebeli&oacute;n», que es la ra&iacute;z equivocada en un cap&iacute;tulo lleno de la correcta. &#9888; Despu&eacute;s Edom le niega el paso a «tu hermano Israel» e Israel se aparta sin pelear, la &uacute;nica vez en N&uacute;meros que acepta un no. ⭐ Y en el monte Hor el sumo sacerdote es desmontado delante de s&iacute; mismo: Mois&eacute;s despoja a Aar&oacute;n de sus vestiduras y viste con ellas a Eleazar mientras Aar&oacute;n mira, y Aar&oacute;n muere en la cumbre. El &uacute;ltimo verbo del cap&iacute;tulo es el que us&oacute; el pueblo en el v3 deseando para s&iacute; la muerte.",
    "num16": "La rebeli&oacute;n de Cor&eacute; &mdash;y abre con una frase rota. &#9888; <em>Y Cor&eacute; tom&oacute;</em>, dice el hebreo, y nunca dice qu&eacute; tom&oacute;: el verbo pide un objeto y no lo hay, y las siete versiones comprobadas aqu&iacute; inventan siete soluciones distintas, desde «tomaron gente» hasta 'became insolent' hasta suprimir el verbo del todo. Esta traducci&oacute;n deja el hueco marcado, como hizo con Ca&iacute;n en G&eacute;nesis 4. La revuelta son en realidad dos revueltas trenzadas: un primo levita de Mois&eacute;s que quiere el sacerdocio, y tres rubenitas que no mencionan el sacerdocio en absoluto &mdash;y uno de ellos, On hijo de Pelet, se nombra aqu&iacute; una vez y nunca m&aacute;s en toda la Biblia. &#9888; La discusi&oacute;n est&aacute; hecha de frases dichas dos veces en direcciones opuestas: <em>rav lajem</em>, «os basta ya», va de Cor&eacute; a Mois&eacute;s y vuelve cuatro vers&iacute;culos despu&eacute;s; <em>ha-me'at</em>, «¿es poco?», va de Mois&eacute;s a Cor&eacute; y vuelve de Dat&aacute;n y Abiram. Y la premisa de Cor&eacute; es una CITA de Lev&iacute;tico 19:2 &mdash;toda la congregaci&oacute;n es santa&mdash;, lo que hace de la rebeli&oacute;n un argumento desde la ley y no contra ella. &#9888; Luego la l&iacute;nea m&aacute;s asombrosa del cap&iacute;tulo, f&aacute;cil de pasar por alto: Dat&aacute;n y Abiram llaman a EGIPTO «una tierra que mana leche y miel», la f&oacute;rmula que la Tor&aacute; reserva para Cana&aacute;n, y acusan a Mois&eacute;s de haberlos sacado de all&iacute; para matarlos. Mois&eacute;s apuesta su comisi&oacute;n a una prueba p&uacute;blica falsable y le pide a Dios que <em>cree una creaci&oacute;n</em> &mdash;el verbo de G&eacute;nesis 1, que no tiene otro sujeto en la Biblia. ⭐ Y la tierra abre su boca: <em>patzet&aacute;</em>, una forma que aparece en exactamente tres vers&iacute;culos de toda la Biblia hebrea, el primero de los cuales es la tierra abri&eacute;ndose para recibir de la mano de Ca&iacute;n la sangre de Abel. &#9888; El cap&iacute;tulo tambi&eacute;n termina donde el lector no lo espera &mdash;el hebreo tiene 35 vers&iacute;culos donde toda Biblia moderna tiene 50, porque su 16:36-50 es N&uacute;meros 17 en el texto masor&eacute;tico. As&iacute; que se detiene en un fuego que consume a doscientos cincuenta hombres, sin expiaci&oacute;n y sin memorial; y nunca llega a decir qu&eacute; fue de Cor&eacute; mismo.",
    "num15": "Una ley sobre llegar, dirigida a la generaci&oacute;n a la que acaban de decirle que no llegar&aacute; nunca: las palabras que siguen inmediatamente a la sentencia en el desierto son &laquo;cuando entr&eacute;is en la tierra&raquo;. El grano y el vino se vuelven acompa&ntilde;amiento fijo de toda ofrenda animal, en una escala m&oacute;vil &mdash;una d&eacute;cima de harina y un cuarto de hin de aceite por un cordero, tres d&eacute;cimas y medio hin por un novillo. Luego la f&oacute;rmula que este proyecto ten&iacute;a prometida por escrito dos veces, en &Eacute;xodo 12 y Lev&iacute;tico 24, y que llega aqu&iacute; amontonada cinco veces en quince vers&iacute;culos: un mismo estatuto, una misma ley, un mismo decreto, para el natural y para el forastero por igual. Un pan levantado de la primera masa &mdash;<em>jal&aacute;</em>, la &uacute;nica ofrenda del cap&iacute;tulo para la que nadie sale de casa, y una palabra que sobrevivi&oacute; a su propia ley hasta la mesa de cada s&aacute;bado. &#9888; Luego la l&iacute;nea que se&ntilde;alaba Lev&iacute;tico 4 desde tres libros atr&aacute;s: todo lo que el sistema sacrificial cubre est&aacute; acotado por <em>shegag&aacute;</em>, error, nueve veces en ocho vers&iacute;culos &mdash;y en cuanto alguien obra &laquo;con MANO ALZADA&raquo;, las dos mismas palabras hebreas que se usan de Israel saliendo de Egipto, las ofrendas se detienen y no queda rito ninguno. &#9888; Un hombre es hallado recogiendo le&ntilde;a en s&aacute;bado, retenido porque no se hab&iacute;a aclarado qu&eacute; se le deb&iacute;a hacer, y apedreado fuera del campamento &mdash;el tercero de los cuatro casos de la Tor&aacute; en que una ley se hace en respuesta a una pregunta, y los cuatro llevan una divisi&oacute;n de p&aacute;rrafo escribal exactamente en el instante en que la pregunta queda en el aire. &#9888; Y cierra con borlas y un cord&oacute;n azul: el tercer p&aacute;rrafo del Shem&aacute;, el vestido que Mateo muestra tres veces sobre Jes&uacute;s sin nombrarlo, y un mandamiento que gira sobre un verbo que ninguna versi&oacute;n de ninguno de los dos estantes imprime &mdash;<em>lo taturu</em>, no and&eacute;is RECONOCIENDO tras vuestro coraz&oacute;n y vuestros ojos, el verbo exacto usado doce veces en los dos cap&iacute;tulos anteriores de los doce hombres que reconocieron la tierra y volvieron con un informe que mat&oacute; a una generaci&oacute;n.",
    "num14": "El informe cae y la naci&oacute;n se rompe. Israel llora toda la noche y dice en voz alta el deseo que se convertir&aacute; en su sentencia &mdash;ojal&aacute; hubi&eacute;ramos muerto en este desierto&mdash; y luego propone, en una frase que aparece en exactamente otro vers&iacute;culo de la Biblia, darse una cabeza y volver a Egipto. Josu&eacute; y Caleb rasgan sus vestidos y sostienen que los habitantes son pan y que su SOMBRA se ha apartado de sobre ellos, una imagen que no conserva ninguna de las ocho versiones consultadas; la respuesta de la congregaci&oacute;n es echar mano de las piedras. Dios ofrece borrar al pueblo y rehacer la naci&oacute;n desde Mois&eacute;s &mdash;la misma oferta del becerro de oro, con tres palabras a&ntilde;adidas, y m&aacute;s fuerte que ellos&mdash; y Mois&eacute;s la rechaza cit&aacute;ndole a Dios su propia descripci&oacute;n del Sina&iacute;, en una abreviatura que deja fuera casi todas las cl&aacute;usulas misericordiosas y conserva entera la que castiga. El perd&oacute;n vuelve en dos palabras hebreas, y la palabra siguiente es PERO. Luego el juramento: vivo yo &mdash;la primera vez en la Biblia que Dios jura por su propia vida, dos veces en este cap&iacute;tulo y despu&eacute;s no hasta Isa&iacute;as&mdash; y el censo que abri&oacute; el libro, 603.550 hombres de veinte a&ntilde;os arriba, se lee al rev&eacute;s como la lista de quienes morir&aacute;n en el desierto, un a&ntilde;o por cada d&iacute;a que los exploradores estuvieron fuera. Los diez mueren de peste ese mismo d&iacute;a. El pueblo hace duelo, y a la ma&ntilde;ana siguiente hace lo &uacute;nico que quedaba por hacer mal: sube a pelear sin el arca, con un verbo que aparece en un solo vers&iacute;culo m&aacute;s de la Biblia hebrea &mdash;aquel en que Habacuc opone el alma hinchada al justo que vivir&aacute; por su fe.",
    "num13": "Doce jefes, uno por tribu, son enviados desde el desierto de Par&aacute;n a mirar la tierra &mdash;y el cap&iacute;tulo abre con una palabra hebrea de dos letras que ha cargado con siglos de discusi&oacute;n. Dios le dice a Mois&eacute;s que env&iacute;e hombres «para ti», un pronombre dativo sin trabajo ordinario en la frase, y que signifique «esto lo mando yo» o «hazlo bajo tu propia responsabilidad» importa enormemente, porque Deuteronomio cuenta la misma historia al rev&eacute;s y dice que los esp&iacute;as fueron idea del pueblo. Mois&eacute;s le cambia el nombre a uno de los doce y lo llama Josu&eacute; antes de que partan, cuatro cap&iacute;tulos despu&eacute;s de que la Biblia empezara a llamarlo Josu&eacute;. Recorren el largo entero del pa&iacute;s en cuarenta d&iacute;as y vuelven cargando un solo racimo de uvas en un palo entre dos hombres. Y su informe es verdad &mdash;cada palabra, hasta que llega una palabra. Fluye leche y miel, y este es su fruto, SOLO que el pueblo es recio y las ciudades est&aacute;n fortificadas y los gigantes est&aacute;n all&iacute;. Caleb hace callar los gritos y dice que suban, sin discutir ni un dato del informe, solo su conclusi&oacute;n. Los otros diez dicen que los habitantes son m&aacute;s fuertes que nosotros, en una frase hebrea que tambi&eacute;n puede leerse «m&aacute;s fuertes que &Eacute;L», y luego sacan un mal informe de una tierra que devora a sus habitantes, donde vieron a los nefilim y se sintieron saltamontes &mdash;y afirman entonces saber c&oacute;mo se les ve&iacute;a desde los ojos de los gigantes.",
    "num12": "El hermano y la hermana de Mois&eacute;s se vuelven contra &eacute;l, y el cap&iacute;tulo abre con un detalle gramatical que toda Biblia espa&ntilde;ola oculta: se nombra a dos personas hablando, pero el verbo hebreo est&aacute; en femenino SINGULAR &mdash;ella habl&oacute;, Miriam y Aar&oacute;n. La queja llega en dos piezas que el texto nunca conecta. Una es por la mujer cusita con la que Mois&eacute;s se cas&oacute;. La otra es justo lo que Mois&eacute;s hab&iacute;a deseado en voz alta un cap&iacute;tulo antes: &iquest;de verdad ha hablado Dios solo por &eacute;l? Dios convoca fuera a los tres, llama adelante a dos, y pronuncia lo m&aacute;s parecido a una descripci&oacute;n del oficio prof&eacute;tico que hay en la Biblia &mdash;visiones y sue&ntilde;os para todos los dem&aacute;s, y para Mois&eacute;s boca a boca, a la vista, sin enigmas, contemplando exactamente aquello que el segundo mandamiento proh&iacute;be fabricar. Y luego se va sin dictar sentencia. El castigo no se anuncia; se descubre cuando la nube se levanta. Solo uno de los dos acusadores queda herido, con palabras id&eacute;nticas a las que se usaron de la propia mano de Mois&eacute;s en la zarza, y el hermano que tambi&eacute;n habl&oacute; sale intacto y se pone a suplicar. Mois&eacute;s responde con cinco palabras hebreas, la oraci&oacute;n m&aacute;s breve de la Tor&aacute;, y no pide nada para s&iacute;. El vers&iacute;culo con que Aar&oacute;n suplica carga con dos de los dieciocho lugares en que la tradici&oacute;n jud&iacute;a dice que los escribas suavizaron el texto. Y una naci&oacute;n con una columna de nube encima y la orden de marcha lista espera una semana entera por una sola mujer antes de moverse.",
    "num11": "El &aacute;nimo se quiebra a tres d&iacute;as del Sina&iacute;, y el libro cambia de car&aacute;cter para siempre. Todo hasta aqu&iacute; ha salido bien &mdash;el recuento, el campamento, la dedicaci&oacute;n, la partida. De este cap&iacute;tulo en adelante, N&uacute;meros es sobre todo un registro de cosas que salen mal, y abre con gente murmurando por algo que el texto ni siquiera especifica, y fuego quemando el extremo del campamento. Luego llega la queja que le da forma al cap&iacute;tulo, y es asombrosamente humana: quieren carne, y lo que de verdad echan de menos es una lista de verduras &mdash;el pescado, los pepinos, los melones, los puerros, las cebollas, los ajos&mdash; recordados como gratis, por gente que hab&iacute;a sido esclava. Nadie en el cap&iacute;tulo corrige ese recuerdo. Mois&eacute;s, entretanto, se derrumba por completo, y las palabras a las que recurre son de madre: &iquest;concebí yo a este pueblo, lo di a luz yo, para tener que llevarlo al pecho como una nodriza? Y luego, sin rodeos: m&aacute;tame. La respuesta de Dios no es una reprensi&oacute;n sino una reorganizaci&oacute;n &mdash;setenta ancianos reciben parte del mismo esp&iacute;ritu para que el peso deje de recaer sobre un solo hombre. Dos de ellos se ponen a profetizar en el lugar equivocado, fuera de la lista oficial, y cuando Josu&eacute; insta a Mois&eacute;s a callarlos, Mois&eacute;s suelta la mejor l&iacute;nea del libro: ojal&aacute; pudieran hacerlo todos. Y entonces llega la carne, en una cantidad pensada como castigo y no como regalo, y el lugar donde la comen se convierte en un cementerio cuyo nombre est&aacute; hecho con la misma palabra que el cap&iacute;tulo us&oacute; para el deseo.",
    "num10": "Por fin se van. Israel lleva estacionado en la misma monta&ntilde;a desde el tercer mes del a&ntilde;o anterior &mdash;a lo largo del pacto, el becerro de oro, la construcci&oacute;n entera del tabern&aacute;culo, todo el Lev&iacute;tico y nueve cap&iacute;tulos de este libro&mdash; y aqu&iacute;, en una fecha que el texto da hasta el d&iacute;a, la nube se alza y la columna parte. Primero Dios hace que Mois&eacute;s fabrique dos trompetas, labradas a martillo en plata, y les asocia un c&oacute;digo de se&ntilde;ales lo bastante preciso para dirigir a una naci&oacute;n: toca ambas y se re&uacute;ne todo el mundo, toca una y vienen solo los jefes, toca un golpe quebrado y fuerte y los campamentos del oriente empiezan a caminar. La distinci&oacute;n que m&aacute;s le importa al cap&iacute;tulo no es cu&aacute;ntos cuernos sino c&oacute;mo se tocan &mdash;el mismo instrumento, los mismos ejecutantes, y la diferencia entre «reunirse» y «marchar» viaja enteramente en la forma de la nota. Luego las tribus parten en la formaci&oacute;n exacta trazada ocho cap&iacute;tulos antes, y Mois&eacute;s se vuelve hacia su cu&ntilde;ado madianita y le pide que los acompa&ntilde;e como gu&iacute;a, porque una naci&oacute;n con una columna de nube encima sigue queriendo a alguien que conozca el terreno: «ser&aacute;s nuestros ojos». El hombre dice que no. Mois&eacute;s insiste. El texto nunca dice si vino. Y termina con dos vers&iacute;culos breves que los escribas han encorchetado, durante siglos, con una letra escrita al rev&eacute;s &mdash;una marca que no se encuentra en ning&uacute;n otro lugar de la Tor&aacute;, sobre un pasaje que una tradici&oacute;n antigua insiste en que no es un pasaje en absoluto, sino un libro aparte de la Biblia escondido a plena vista, con sus ochenta y cinco letras.",
    "num9": "Israel celebra la Pascua en el desierto &mdash;apenas la segunda que jam&aacute;s se ha hecho, un a&ntilde;o justo despu&eacute;s de aquella noche que los sac&oacute; de Egipto. Y entonces un problema para el que nadie hab&iacute;a escrito una regla: unos hombres hab&iacute;an tocado hac&iacute;a poco un cad&aacute;ver, lo cual, seg&uacute;n las propias leyes de pureza del campamento, los deja inhabilitados para participar, y no est&aacute;n dispuestos a dejarlo pasar. Van a Mois&eacute;s y preguntan, sin rodeos, por qu&eacute; han de quedar fuera de lo &uacute;nico que est&aacute; haciendo la naci&oacute;n entera. Mois&eacute;s no tiene respuesta. Les dice que esperen mientras &eacute;l pregunta &mdash;un legislador admitiendo, para que conste, que la ley no cubre esto. Lo que vuelve no es una dispensa, es toda una segunda Pascua: cualquiera que est&eacute; impuro, o simplemente demasiado lejos de casa, puede celebrarla un mes despu&eacute;s, el mismo d&iacute;a, con las mismas reglas, la misma comida, sin dejar sobras, sin quebrar un hueso. El mismo dictamen ensancha la puerta otra vez en una direcci&oacute;n que nadie hab&iacute;a planteado &mdash;un extranjero que viva entre ellos puede celebrarla tambi&eacute;n, en t&eacute;rminos id&eacute;nticos, una misma ley para ambos. Y cierra exactamente una puerta: quien pudiendo perfectamente presentarse simplemente no se molesta queda cortado de su pueblo. Luego el cap&iacute;tulo se aleja hacia la nube posada sobre la tienda &mdash;con fuego dentro de noche&mdash; y la disposici&oacute;n que gobierna todo de aqu&iacute; en adelante: cuando se alza, marchan; cuando se posa, se detienen; y a nadie se le avisa de antemano si eso significar&aacute; dos d&iacute;as, un mes o un a&ntilde;o.",
    "num8": "El candelabro de oro cambia de manos. Mois&eacute;s lo encendi&oacute; una vez &eacute;l mismo cuando se mont&oacute; la tienda por primera vez; aqu&iacute; el trabajo pasa a Aar&oacute;n para siempre, y el sacerdocio se hace cargo de atender la luz. Luego el cap&iacute;tulo se vuelve hacia algo m&aacute;s extra&ntilde;o: los levitas quedan purificados para el servicio, y el ritual se lee como una lista de tareas para deshacer por un momento la humanidad ordinaria de una persona &mdash;agua roc&iacute;ada sobre ellos, una navaja pasada por cada cent&iacute;metro de su piel, sus ropas lavadas, y luego toda la naci&oacute;n de Israel les pone las manos encima a la vez, y Aar&oacute;n los mece &mdash;a los hombres mismos, vivos&mdash; hacia adelante y atr&aacute;s como un sacerdote mece un pedazo de carne sobre un altar, porque es literalmente el mismo gesto usado en cualquier otro lugar de la Tor&aacute; para la grasa y el pecho de un sacrificio, solo que aqu&iacute; se realiza sobre una tribu entera de personas en vez de un animal. Dos novillos mueren para hacerlo oficial, uno como holocausto, otro para expiar por los hombres que est&aacute;n siendo consagrados. Luego Dios explica, esta vez con su propia voz, por qu&eacute; est&aacute; pasando todo esto: todo hijo primog&eacute;nito de Israel ya le pertenece, marcado la noche en que mat&oacute; a todo primog&eacute;nito de Egipto y dej&oacute; salir sin tocar a los propios primog&eacute;nitos de Israel &mdash;y los levitas son el trato de una sola tribu que salda esa cuenta para siempre, para que el resto de Israel no tenga que entregar un hijo primog&eacute;nito real para servir a Dios por ello. Y el cap&iacute;tulo termina con un n&uacute;mero que contradice llanamente un n&uacute;mero de cuatro cap&iacute;tulos atr&aacute;s &mdash;los levitas empiezan su servicio a los veinticinco a&ntilde;os aqu&iacute;, no a los treinta como la &uacute;ltima vez&mdash; y el texto nunca reconoce la diferencia.",
    "num7": "El tabern&aacute;culo queda terminado, y lo primero que recibe es una fiesta de doce d&iacute;as. Cada d&iacute;a, durante doce d&iacute;as seguidos, un jefe tribal se presenta con una ofrenda &mdash;y es exactamente la misma ofrenda, cada vez, elemento por elemento, hasta el siclo: un plato de plata, un taz&oacute;n de plata, una cuchara de oro con incienso, un toro, un carnero, un cordero, un macho cabr&iacute;o, y suficientes bueyes y carneros y machos cabr&iacute;os y corderos para una ofrenda de paz que podr&iacute;a alimentar a medio campamento. El texto lo escribe completo las doce veces de todos modos, en vez de simplemente decir «repite once veces m&aacute;s» &mdash;se dice cada nombre, se cuenta cada n&uacute;mero, porque, al parecer, ning&uacute;n regalo aqu&iacute; puede parecer m&aacute;s peque&ntilde;o solo porque once id&eacute;nticos ya lo precedieron. Y el orden en que aparecen los jefes no es al azar: es el mismo orden de marcha que el campamento ya usaba para levantar el campo cada ma&ntilde;ana, tribu por tribu &mdash;un calendario construido sobre el plano del cap&iacute;tulo anterior. Antes de todo eso, hay un detalle m&aacute;s extra&ntilde;o escondido al principio &mdash;los jefes donan seis carros y doce bueyes para ayudar a mover el tabern&aacute;culo, y dos de los tres clanes levitas los reciben con gusto. El tercer clan, a quien se le conf&iacute;a el arca misma, no recibe nada &mdash;porque esa carga no viaja en carreta, viaja sobre el hombro de un hombre, sin que ninguna rueda se le acerque jam&aacute;s. Luego el cap&iacute;tulo hace su propia cuenta en voz alta, dos veces, sumando cada plato y cada animal hasta un n&uacute;mero que cuadra exacto. Y justo al final &mdash;despu&eacute;s de quince cap&iacute;tulos construyendo una tienda seg&uacute;n unas especificaciones, un libro entero de ley sacrificial, y seis cap&iacute;tulos m&aacute;s&mdash;, por fin sucede una frase: Mois&eacute;s entra, y por primera vez, oye una voz que le responde desde entre las alas de dos estatuas de oro, exactamente como se le hab&iacute;a prometido, cap&iacute;tulos y cap&iacute;tulos atr&aacute;s, antes de que se cortara una sola tabla.",
    "num6": "Un voto que cualquiera pod&iacute;a hacer, por el tiempo que quisiera hacerlo. Nada de vino, nada de lo que salga de una vid &mdash;el jugo, las pasas, las c&aacute;scaras, todo. No te cortes el cabello. No te acerques a un cad&aacute;ver, ni siquiera al de tu propia madre o padre, mientras dure el voto. Eso es todo &mdash;sin deber en el templo, sin vestiduras especiales, solo tres restricciones que cualquiera en Israel pod&iacute;a asumir por una temporada y luego abandonar una vez cumplido el plazo. Salvo que tres personas de este libro nunca lo abandonan &mdash;Sans&oacute;n, marcado para ello antes de nacer; Samuel, prometido a ello por una madre que ni siquiera lo hab&iacute;a concebido todav&iacute;a; y, siglos despu&eacute;s, un beb&eacute; que crecer&aacute; para bautizar gente en un r&iacute;o, marcado de la misma manera desde el vientre. El voto estaba pensado para ser temporal. Nadie se lo dijo a las madres. Hay una extra&ntilde;a cl&aacute;usula de contingencia metida en medio: &iquest;qu&eacute; pasa si alguien simplemente cae muerto a tu lado, sin aviso, y arruina el voto sin ninguna culpa tuya? No te castigan por ello &mdash;pero tampoco te dan cr&eacute;dito por el tiempo ya cumplido. Af&eacute;itate la cabeza, espera una semana, trae dos aves al octavo d&iacute;a, y empieza de nuevo desde cero, con lo que ya hab&iacute;as avanzado simplemente borrado. Y terminar el voto correctamente, cuando nada lo interrumpe, cuesta mucho m&aacute;s que cumplirlo &mdash;tres animales distintos, pan, grano, vino, toda la producci&oacute;n, para un compromiso cuyos requisitos diarios eran solo tres cosas que no hac&iacute;as. Luego, sin ninguna transici&oacute;n, el cap&iacute;tulo le entrega a Aar&oacute;n y a sus hijos las palabras exactas para bendecir a toda la naci&oacute;n &mdash;tres l&iacute;neas, cada una un poco m&aacute;s larga que la anterior, terminando en una afirmaci&oacute;n que socava toda la ceremonia de la mejor manera: los sacerdotes en realidad no hacen la bendici&oacute;n. Solo la pronuncian en voz alta. Dios hace la parte de bendecir &eacute;l mismo, una vez que su propio nombre ha sido puesto sobre el pueblo que est&aacute; ah&iacute; escuchando.",
    "num5": "Tres leyes que no tienen nada que ver entre s&iacute; excepto una cosa: lo que hace falta para mantener un campamento apto para que Dios viva realmente en medio de &eacute;l. Primero, una orden de saneamiento: cualquiera con una enfermedad de la piel, un flujo corporal o contacto con un cad&aacute;ver es enviado fuera del campamento, no exactamente como castigo, solo porque esas cosas no pueden compartir espacio con el lugar donde Dios ha dicho que estar&aacute;. Luego una ley de deudas: si agravias a alguien, no puedes arreglar las cosas con Dios hasta haberlas arreglado primero con la persona &mdash;devuelve lo que tomaste, a&ntilde;ade un veinte por ciento encima, y solo entonces se habla de un sacrificio. &iquest;Y si la persona a quien agraviaste ha muerto sin dejar a nadie que cobre en su nombre? La deuda no simplemente desaparece. Pasa al sacerdote en su lugar, porque al parecer un agravio no deja de deberse solo porque ya no quede nadie a quien entreg&aacute;rselo. Luego el cap&iacute;tulo se vuelve hacia algo m&aacute;s extra&ntilde;o y m&aacute;s dif&iacute;cil de asimilar: un marido sospecha de su esposa, sin prueba en ning&uacute;n sentido, sin testigo, nada que nadie pudiera llevar a un tribunal. Entonces, en vez de un juicio sin evidencia sobre la cual apoyarse, hay un ritual &mdash;polvo del suelo del tabern&aacute;culo mezclado en agua, el cabello suelto, un juramento que ella tiene que pronunciar en voz alta aceptando de antemano una maldici&oacute;n que solo caer&aacute; si de verdad es culpable. Ella la bebe. Si miente, algo le sucede al cuerpo. Si dice la verdad, no sucede absolutamente nada, y vuelve a casa absuelta. Es el &uacute;nico lugar en todo el c&oacute;digo legal construido espec&iacute;ficamente para un caso donde genuinamente no hay forma de conocer la verdad por medios ordinarios &mdash;y sea cual sea el resultado, el marido mismo nunca responde por haber planteado la sospecha en primer lugar.",
    "num4": "Un segundo censo de los mismos levitas, y esta vez el rango de edad es más estrecho por ambos lados: de treinta a cincuenta años, no desde un mes de edad —los años de la fuerza real de un hombre, porque este capítulo no trata de a quién pertenece a Dios desde el nacimiento, sino de quién tiene la fuerza para cargar los muebles de Dios a través de un desierto. Y antes de que se permita a un solo coatita acercarse a esos muebles, Aarón y sus hijos tienen que hacer algo primero: envolverlos. El arca desaparece bajo un velo, luego una cubierta del mismo material de cuero misterioso que este proyecto ya señaló en Éxodo, luego una tela toda de azul encima. La mesa recibe el mismo tratamiento, y el candelabro, y el altar del incienso, y el altar de bronce afuera —cada uno envuelto en su color asignado antes de que nadie pueda tocarlo, y la advertencia que acompaña el envoltorio no es sutil: mirar las cosas santas descubiertas, aunque sea un instante, es morir. Solo después de que todo queda invisible bajo tela se les permite finalmente a los coatitas venir a cargarlo —con varas ya pasadas por las argollas, para que ninguna mano llegue jamás a tocar la cosa misma. A Eleazar, hijo de Aarón, se le encarga además otra responsabilidad aparte de supervisar todo esto: el aceite de la lámpara, el incienso, la ofrenda de grano diaria y el aceite de unción —los suministros ordinarios que mantienen el lugar funcionando día a día, aparte de los muebles. Los otros dos clanes levitas no reciben tal advertencia, porque nada de lo que cargan puede matar a nadie —Gersón tiene las cortinas y las cubiertas, Merari tiene los marcos y las barras, y ambos responden ante el otro hijo de Aarón, Itamar, no Eleazar. Luego el recuento real: 2.750 hombres de Coat, 2.630 de Gersón, 3.200 de Merari. Súmalos y da exactamente 8.580 —sin faltante esta vez, sin ningún sobrante de 300 que nadie pueda explicar, a diferencia del problema aritmético que dejó pendiente el capítulo anterior. Solo un número que cuadra, para una descripción de trabajo que trata sobre todo de sobrevivir lo suficiente para hacerlo.",
    "num3": "Un árbol genealógico que se corta en la segunda frase. Aarón tiene cuatro hijos, pero dos ya están muertos —ofrecieron el fuego equivocado sobre el altar y lo pagaron en el acto, sin dejar hijos— así que toda la línea sacerdotal tiene que pasar por los dos que sobrevivieron. Luego el capítulo se vuelve hacia un trato que se debía desde la propia noche del Éxodo: todo hijo primogénito de Israel quedó marcado como perteneciente a Dios la noche en que la plaga pasó de largo, y nadie había cobrado esa deuda —hasta ahora. Una tribu entera, los levitas, se entrega como pago, un sustituto que ocupa el lugar de cada hijo primogénito en cada otra familia de la nación. Para formalizar el trato se les cuenta de la misma manera en que se contó a los hombres de guerra el capítulo anterior, salvo que empezando desde un mes de edad en vez de veinte años, porque esto no trata de quién puede sostener un arma —trata de a quién se pertenece desde el nacimiento. Tres hijos de Leví, tres trabajos: un clan carga con la tela y las cortinas de la tienda y acampa detrás de ella, al occidente; un clan carga con la carga más peligrosa de todo el campamento —el arca, la mesa, el candelabro, los altares— acampado al sur bajo la vigilancia directa del propio hijo sobreviviente de Aarón; y un clan carga con lo pesado en lo que nadie piensa, los marcos y las barras y los postes que sostienen toda la estructura, acampado al norte. Moisés y la familia de Aarón se plantan justo frente a la entrada, al oriente, para que nada se acerque a esa puerta sin pasar primero por ellos. Y entonces el capítulo termina con una operación aritmética que hace que el lector la presencie dos veces: cuenta a cada hijo primogénito de la nación, cuenta a cada levita, y los números no coinciden del todo —273 primogénitos de más, sin ningún levita que ocupe su lugar. Así que se les rescata con dinero en su lugar, cinco monedas de plata cada uno, pagadas en efectivo directamente a los sacerdotes, hasta la última moneda.",
    "num2": "Los mismos 603.550 hombres del censo del capítulo anterior, ahora con un plano real. Doce tribus, repartidas en cuatro grupos de tres, cada grupo mirando hacia un punto de la brújula, cada uno bajo su propio estandarte plantado antes de levantar una sola tienda. El oriente recibe a Judá, Isacar y Zabulón, y son ellos quienes se mueven primero cada vez que el campamento levanta el vuelo. El sur recibe a Rubén, Simeón y Gad, moviéndose segundos —Rubén conserva el honor de encabezar un grupo pese a haber perdido su condición de primogénito dos libros atrás, porque una lista de censo, al parecer, no olvida un accidente de orden de nacimiento solo porque la bendición de un padre en su lecho de muerte sí lo hizo. El occidente recibe a Efraín y Manasés —los dos hijos de José, acampados uno junto al otro exactamente como fueron bendecidos uno junto al otro, con el nombre de Efraín todavía listado primero aunque era el menor de los dos. El norte recibe a Dan, Aser y Neftalí, moviéndose últimos, y el grupo de Dan resulta ser el más numeroso de los cuatro pese a que Dan era un hijo bastante secundario en la historia familiar. Y justo en medio de todo este cuadro, ni al frente ni a un lado, sino en el centro exacto: la propia tienda, con los levitas acampados en un anillo a su alrededor, de modo que sin importar hacia qué dirección mire la columna ni cuánto tenga que marchar, la misma arquitectura se mantiene —las tribus por fuera, el sacerdocio en el medio, y la presencia de Dios en el punto exacto alrededor del cual se construye todo lo demás. El capítulo termina como suelen terminar estas cosas aquí: hicieron exactamente lo que se les mandó, tanto al acampar como al marchar, hasta la última familia.",
    ...
    "jhn7": "«No subo a esta fiesta» — y luego sube de todos modos, en secreto, nueve versículos después. ⚠ Una sola palabra griega decide si esto es una contradicción real o no: los manuscritos más antiguos leen «no», el texto mayoritario lee «todavía no», y un filósofo pagano del siglo III ya usó este mismo versículo para llamar mentiroso a Jesús. La multitud en la Fiesta de los Tabernáculos no logra ponerse de acuerdo sobre qué es él — hombre bueno, engañador, el Profeta, el Cristo, o descalificado de plano porque todos ya saben que es de Galilea, no de Belén, de donde se supone que viene el Cristo. En el último y mayor día de la fiesta, durante el propio rito del agua del templo, se pone de pie y redirige toda la ceremonia hacia sí mismo: «si alguien tiene sed, que venga a mí y beba». Los alguaciles enviados a arrestarlo vuelven con las manos vacías y la mejor línea del capítulo — «jamás nadie ha hablado como este hombre» — y el último versículo del capítulo abre directamente hacia una de las disputas textuales más famosas del Nuevo Testamento, ausente por completo de los manuscritos más antiguos.",
    "jhn8": "Este capítulo abre con una historia ausente de los dos Nuevos Testamentos griegos completos más antiguos: la mujer sorprendida en adulterio, y los acusadores que se van uno por uno, empezando por los más viejos, tras «que el que esté sin pecado arroje la primera piedra». ⚠ Esta traducción declara la situación textual con claridad en vez de pasarla por alto. Lo que sigue escala rápido — «yo soy la luz del mundo», puesto en escena frente a los propios candelabros encendidos de la Fiesta de los Tabernáculos; una afirmación sin ningún predicado gramatical («si no creen que yo soy») que este capítulo se niega a completar hasta su último versículo; y un argumento con sus propios nuevos creyentes que se convierte, versículo a versículo, en la línea históricamente más peligrosa de este Evangelio — abordada con claridad, incluyendo por qué quince siglos de su peor uso malinterpretan el texto. Termina en la frase hacia la que la propia gramática griega venía construyendo: «antes que Abrahán fuese, yo soy» — y hombres tomando piedras antes de que termine de hablar.",
    ...
    "zechariah2": "Los cuatro cuernos y los cuatro artesanos, luego un hombre sale con un cordel a medir Jerusalén —y descubre que la ciudad ya ha superado todo el proyecto—. Dos visiones nocturnas más de Zacarías, fundidas en un solo capítulo hebreo (lo que el inglés separa como 1:18-21 y todo el capítulo 2). La visión se responde a sí misma: en vez de un muro, Jehová promete SER uno —«yo mismo seré para ella un muro de fuego en derredor, y seré la gloria en medio de ella»—, una ciudad medida en su extensión y luego dejada deliberadamente sin murallas, porque ningún muro podría contener lo que viene y ninguno hace falta. ⚠ El versículo 12 guarda uno de los verdaderos enigmas del libro —un «mí» sin nombre, enviado por «Jehová de los ejércitos», que reporta palabras que luego se deslizan, sin aviso, a la propia voz de Jehová en primera persona («toca la niña de SU ojo»)—. Y una promesa se ensancha más allá de Israel por primera vez: «se unirán muchas naciones a Jehová… y serán MI pueblo». ⚠ Un grabado alemán de 1695 ilustra la visión de los cuatro cuernos bajo su PROPIA numeración al estilo inglés, «Zach. I, 18» —la misma imagen, contada al revés—.",
    "zechariah5": "La SEXTA y la SÉPTIMA visión nocturna, una tras otra. Primero un rollo vuela por el aire, nueve metros por cuatro y medio —la huella exacta del pórtico del templo de Salomón—, escrito por ambos lados con una maldición contra los ladrones en una cara y contra quienes juran en falso por el nombre de Jehová en la otra, cubriendo entre las dos las dos tablas de los Diez Mandamientos. Luego sale una canasta, y dentro de ella, descubierta en vez de colocada allí, se sienta una mujer a quien el ángel nombra sin rodeos: «Esta es la Maldad». La empuja hacia abajo y sella la boca de la canasta con un disco de plomo —y dos mujeres con alas «como alas de CIGÜEÑA» levantan todo el conjunto por el aire para construirle una casa en la tierra de SINAR, Babilonia, la misma llanura donde una generación anterior levantó una torre «con su cima en el cielo». ⚠ El propio nombre hebreo de la cigüeña, chasidah, está construido sobre chesed, bondad de pacto —«la piadosa»—, y sin embargo la Torá la incluye entre las aves impuras de todos modos: la Maldad abandona la tierra santa sobre las alas de un ave cuyo nombre y estatus se contradicen. Y una cuestión genuina y sin resolver se sienta en el centro de la visión: ¿significa «este es su OJO en toda la tierra» (v6) su aspecto, o —como lee la Septuaginta, una sola letra hebrea de diferencia— su INIQUIDAD?",
    "zechariah4": "La QUINTA visión nocturna, y la frase más famosa del libro. Un ángel despierta al profeta somnoliento para mostrarle un candelabro de oro macizo, autoalimentado desde un tazón de depósito a través de tubos sin que ninguna mano humana aparezca rellenándolo, flanqueado por dos olivos que nadie sabe explicar. La respuesta, cuando llega, se dirige directamente al gobernador Zorobabel: «No con EJÉRCITO, ni con FUERZA, sino con mi espíritu», dice Jehová de los ejércitos —chayil y koach, fuerza y capacidad, negadas ambas de una vez a un hombre que reconstruye un templo sin ejército propio. Un «gran monte» se convierte en llanura ante él; saca la piedra principal entre gritos de «¡Gracia, gracia!»; y «el día de las pequeñeces» se nombra directamente —una casa modesta no necesita igualar la de Salomón para tener éxito—. Los siete ojos de Jehová regresan, un capítulo después de ser grabados por primera vez sobre una sola piedra. Cierra con las dos ramas de olivo —literalmente «espigas» de olivo, la misma raíz que la contraseña shibbolet de Jueces 12— identificadas solo como «los dos hijos de aceite», no «los dos ungidos» como imprimen la mayoría de las versiones: una palabra de cosecha para aceite fresco, deliberadamente no la palabra para la unción.",
    "zechariah3": "La cuarta visión nocturna, y la primera con un ser humano en juicio. El sumo sacerdote Josué está de pie ante el ángel de Jehová con vestiduras SUCIAS —una de las palabras más crudas del idioma, nada de tierra corriente—, mientras «el Acusador» (hebreo ha-satan, CON el artículo determinado: un cargo, todavía no un nombre —la misma figura y la misma escena de tribunal que la propia nota de Job 1 nombró siete capítulos por adelantado) está de pie a su derecha para acusarlo. Jehová reprende al Acusador de plano, sobre la base de que Jerusalén es SUYA para elegir; las vestiduras sucias se quitan, ropas de gala se ponen, y a Josué se le ofrece «libre acceso» entre los ángeles del propio consejo divino. Entonces la visión se ensancha más allá de un solo hombre: «voy a traer a mi siervo, BROTE» —tsemach, el término mesiánico que este proyecto ya encontró en Jeremías 23:5, aquí presentado por primera vez como nombre desnudo, no un título (el hebreo no lleva artículo determinado)— y una piedra con SIETE OJOS, que esta traducción lee literalmente en vez de suavizar a «facetas», la misma imagen y la misma cuenta que regresa un capítulo más adelante sobre un candelabro y, siglos después, sobre un Cordero inmolado en Apocalipsis 5:6. Cierra con la imagen más ordinaria de todo el libro: vecinos que se invitan unos a otros a sentarse bajo su propia vid y su higuera.",
    ...
    "josh2": "Dos espías salen de Sitim hacia Jericó y se alojan en casa de Rahab, una prostituta cuya casa está en la muralla. Ella los esconde bajo el lino de la azotea, manda con una mentira a los hombres del rey hacia los vados, y luego, en la azotea, le recita a Israel sus propias palabras: los habitantes que desfallecen del Cantar del Mar, el «Dios en los cielos arriba y en la tierra abajo» de Deuteronomio. La señal que pide es un cordón cuyo nombre hebreo, <em>tiqváh</em>, en todo el resto de la Biblia significa esperanza; escarlata, como el hilo atado una vez al hijo de Tamar; colgado en una casa marcada de la que nadie debe salir, la noche de Pascua al revés.",
    "josh3": "El cruce. Israel espera tres días a la orilla del río y luego sigue al arca del pacto a dos mil codos de distancia —llevada ahora por sacerdotes, no por los coatitas de Números 4— hasta un Jordán «lleno por encima de todas sus orillas todos los días de la siega». En cuanto los pies de los sacerdotes se mojan, el agua de arriba se pone de pie «en un solo montón», <em>ned</em>, la palabra propia del Cantar del Mar, muy lejos, en una ciudad llamada Adán cuya ribera se ha desplomado al menos dos veces desde entonces; el agua de abajo se agota hacia el mar Salado, y la nación entera cruza sobre tierra seca frente a Jericó mientras los sacerdotes se quedan quietos en el cauce. Dios habla una sola vez, para decir de quién es el día: «Este día comenzaré a hacerte grande», la frase de Deuteronomio 2:25 con Josué por objeto.",
    "josh4": "Doce hombres vuelven al cauce por doce piedras, una sobre el hombro de cada uno, y las dejan donde la nación duerme su primera noche en la tierra: «un memorial para los hijos de Israel para siempre», con una pregunta incorporada: «cuando vuestros hijos pregunten mañana, ¿qué son estas piedras para vosotros?». La misma catequesis que la Torá escribió para la noche de Pascua, y el cruce está fechado el diez del mes primero, el día en que se escoge el cordero pascual. Otras doce piedras quedan en medio del Jordán «hasta el día de hoy» —o las mismas doce: el hebreo no dice ni <em>otras</em> ni <em>las</em>, el griego y el latín dicen «otras», la NIV dice unas solas. Rubén, Gad y la media tribu de Manasés cruzan en orden de batalla, cuarenta mil de unos ciento diez mil, cumpliendo el juramento de Números 32 con sus propias palabras; Jehová hace grande a Josué «a los ojos de todo Israel», las tres últimas palabras de la Torá; y cuando las plantas de los sacerdotes se sueltan hacia la orilla el río vuelve por encima de todas sus orillas. El capítulo abre con un salto masorético en mitad de un versículo, cuenta dos veces la salida del arca, y termina con los padres enseñados a decir «nosotros» de un mar que nunca vieron.",
    "josh5": "Los reyes al oeste del río lo oyen, y se les derrite el corazón: la frase de Rahab, en boca del narrador, sobre un <em>nosotros</em> escrito que los masoretas leen como <em>ellos</em>. Luego un cuchillo: hazte cuchillos de pedernal y circuncida otra vez a los hijos de Israel, por segunda vez, porque todo el que salió de Egipto ha muerto y nadie de los nacidos por el camino fue cortado nunca. Una nación se queda quieta en país enemigo hasta que revive, y el campamento recibe su nombre —<em>hoy he hecho rodar de sobre vosotros el oprobio de Egipto</em>— de un verbo que rueda una piedra de un pozo. La primera Pascua en la tierra, en las llanuras de Jericó; a la mañana siguiente comen la tierra, grano tostado y panes sin levadura, al día siguiente de la Pascua —el día que Números 33 da para la salida de Egipto—, y a la mañana siguiente cesa el maná, con el verbo propio del sábado. Luego un hombre con la espada desenvainada a las afueras de Jericó, que responde a <em>¿eres de los nuestros, o de nuestros adversarios?</em> con un solo <em>no</em>, y da a Josué la frase que Moisés oyó en la zarza: con una sandalia en vez de dos, y sin tierra.",
    "josh7": "Un solo hombre toma de las cosas consagradas a la destrucción de Jericó, y el capítulo abre culpando de ello a una nación. Los espías dicen que Hai es pequeña; suben unos tres mil y huyen, 36 mueren en la bajada, y <em>el corazón del pueblo se derritió y se volvió agua</em>: la frase de Rahab sobre su propio pueblo, dicha ahora de Israel, el tercer corazón derretido del libro. Josué rasga sus vestiduras con la palabra de Jacob, cae sobre su rostro con la de Goliat, y reza palabra por palabra la queja de la generación del desierto —<em>para entregarnos en mano de los amorreos, para destruirnos</em>—, la frase que una vez rasgó sus vestidos para responder. La respuesta de Dios es una palabra escrita con una letra de menos, <em>¡Levántate!</em>, y cinco <em>y también</em>, más que ningún versículo de la Biblia: Israel ha quedado <em>consagrado a la destrucción</em>, como avisaba Deuteronomio 7:26. La nación es cribada por tribu, clan, casa y hombre, con el verbo que tomó Jericó y sin nombrar suerte alguna; Judá es tomada primero; y Acán —un zeraíta, descendiente del gemelo del hilo escarlata— confiesa con la gramática de Génesis 3:6 y el vocabulario de Deuteronomio 7:25: <em>vi &hellip; los codicié &hellip; los tomé</em>. Un manto de Sinar, una lengua de oro, un montón de piedras, y un valle llamado Turbación que Oseas llamará puerta de esperanza.",
    "josh8": "Hai cae una segunda vez, y ahora por un plan y no por un milagro: treinta mil hombres de noche, una emboscada detrás de la ciudad, un señuelo que deja que Israel &laquo;se deje herir&raquo; a propósito y huya &laquo;como la primera vez&raquo; &mdash;escenificando el mismo colapso que le acababa de costar una batalla y un hombre. Jehová abre el capítulo con los mismos dos verbos que Moisés usó en el borde de la tierra la primera vez, antes de que se enviaran los espías, y esta vez la concesión es real: solo el jérem de Jericó queda levantado, y el botín es de Israel para quedárselo. Josué madruga una cuarta y última vez, con los ancianos devueltos a su lado; una jabalina extendida y no bajada decide una batalla del mismo modo que una mano alzada decidió una vez contra Amalec; y al rey de Hai lo entierran bajo la frase idéntica que enterró a Acán un capítulo antes &mdash;un gran montón de piedras, todavía ahí, dice, hasta el día de hoy. Entonces la campaña se detiene, y Josué construye el altar que Deuteronomio prometió en el monte Ebal, con media nación frente a Guerizim y media frente a Ebal, y copia la ley sobre piedra &mdash;una &laquo;copia&raquo; cuya propia mala traducción, siglos después, le dará nombre a un libro que todavía no se ha escrito.",
    ...
    "deut2": "El camino largo. A Edom, Moab y Amón se les deja en paz —la misma palabra, «posesión», dada a cuatro naciones antes que a Israel— y el camino se topa con Sehón, que se niega a dejarlos pasar porque Jehová le endureció el corazón.",
    "deut3": "Og de Basán sale a la batalla, y el recuento cita a Números casi palabra por palabra. Su cama de hierro, de nueve codos, sigue expuesta en Rabá —el último de los refaítas, un nombre de clanes de gigantes más antiguo que Israel mismo. Transjordania se reparte entre Rubén, Gad y la media tribu de Manasés, y Moisés suplica cruzar el Jordán y se lo niegan: «Basta ya. Nunca me vuelvas a hablar de este asunto.» Se le manda subir al Pisgá a mirar, no a cruzar, y se le ordena fortalecer al hombre que sí lo hará.",
    "deut4": "Los ojos que vieron Baal-peor se vuelven la primera prueba del sermón: obedece, y vive, como puede atestiguar todo el que sigue de pie en este valle. Moisés establece la regla de autopreservación más antigua de la Biblia —no añadas a esta palabra, no le quites— y luego argumenta que Israel no vio ninguna forma en Horeb, solo oyó una voz, y por eso no debe tallar ninguna imagen de nada en el cielo, la tierra o el mar. Sigue una profecía de exilio, y dentro de ella una promesa: busca a Dios incluso desde el exilio y se le halla, porque es misericordioso. Luego la afirmación más fuerte del capítulo —Jehová, él solo, es Dios, en los cielos arriba y en la tierra abajo, no hay otro— y Moisés, antes de que exista una sola ley de refugio, aparta en silencio tres ciudades donde un homicida accidental puede huir y vivir.",
    "deut5": "Moisés repite las Diez Palabras a la generación que no estuvo de pie en Horeb —y la repetición no es palabra por palabra. «Acuérdate» del sábado se vuelve «Guarda», fundado ahora en la esclavitud en Egipto y no en la creación; honrar al padre y a la madre gana una segunda promesa que Pablo citará después; la décima Palabra invierte a la mujer y la casa del prójimo y recurre a un segundo verbo distinto; y el propio Jehová, una vez pronunciadas las Diez Palabras, «no añadió nada más» —la misma contención que el capítulo anterior le exigió a Israel. El pueblo, demasiado asustado para volver a oír la voz, pide un intermediario, y se le dice que pidió bien: así es como Moisés consigue su puesto.",
    "deut6": "El propio Shem&aacute; &mdash;cuatro palabras hebreas sin ning&uacute;n verbo, y toda traducci&oacute;n del mundo tiene que insertar un &laquo;es&raquo; y decidir d&oacute;nde va. Mois&eacute;s manda a Israel amar a Dios con el coraz&oacute;n, el alma y una tercera palabra que no es una parte del cuerpo sino un adverbio puesto a trabajar de sustantivo, y afilar estas palabras en sus hijos &mdash;un verbo que en todo el resto de la Biblia afila flechas y lenguas. Atarlas a la mano, escribirlas en el poste de la puerta donde una vez fue la sangre de la Pascua. Luego el peligro: ciudades que no edificaste, y la advertencia no cae sobre el hambre sino sobre la hartura. No prueben a Dios como lo probaron en Prueba. Y cuando ma&ntilde;ana tu hijo pregunte qu&eacute; significa todo esto, la respuesta que recibe no es una definici&oacute;n sino un relato.",
    "deut7": "Siete naciones nombradas una sola vez en toda la Biblia hebrea, y el mandato de consagrarlas al exterminio &mdash;una palabra que significa consagrar y no solo matar, y que Deuteronomio a\u00f1ade a los dos pasajes de \u00c9xodo que por lo dem\u00e1s reescribe casi cl\u00e1usula por cl\u00e1usula. La raz\u00f3n de que Israel sea escogido es que no hab\u00eda raz\u00f3n: no por el n\u00famero, porque era el m\u00e1s peque\u00f1o de todos los pueblos, sino solo porque los am\u00f3. A Dios se le llama aqu\u00ed \u00abel Dios fiel\u00bb y en ning\u00fan otro lugar de la Biblia; el castigo que llegaba a la tercera y la cuarta generaci\u00f3n se recorta a un solo hombre en su propia vida; la bendici\u00f3n sobre los corderos lleva escrito dentro el nombre de una diosa cananea; y el cap\u00edtulo que abri\u00f3 consagrando siete naciones cierra advirtiendo que una pieza de plata metida en casa te consagra A TI.",
    "deut11": "Regada con el pie &mdash;el riego de Egipto, y la tierra que en cambio bebe lluvia&mdash;. Mois&eacute;s argumenta desde lo que una generaci&oacute;n vio y la siguiente no: un mar desbordado sobre los caballos de Egipto con un verbo que aparece una sola vez en toda la Biblia, y un suelo que se ABRE DE PAR EN PAR bajo Dat&aacute;n y Abiram &mdash;contado de nuevo sin Cor&eacute; dentro, y con la palabra que Mois&eacute;s hab&iacute;a anunciado en vez de la que us&oacute; el narrador, mientras que lo que baja por el agujero es el sustantivo que G&eacute;nesis reserva para lo que destruy&oacute; el Diluvio&mdash;. Luego la lluvia temprana y la tard&iacute;a, nombradas aqu&iacute; por primera vez en la Biblia, y el segundo p&aacute;rrafo del Shem&aacute;, que por fin explica por qu&eacute; el &laquo;ustedes&raquo; de este libro no deja de cambiar entre singular y plural a mitad de frase: doce bloques alternos en treinta y dos vers&iacute;culos, y la costura es una comilla. Lo que Deuteronomio reescribi&oacute; del cap&iacute;tulo 6 lo pluraliz&oacute;; lo que copi&oacute; palabra por palabra lo dej&oacute; en singular, y 11:20 es 6:9 letra por letra. Y luego las fronteras que Josu&eacute; citar&aacute; en otro tiempo verbal, y una bendici&oacute;n y una maldici&oacute;n puestas sobre dos montes con nombre antes de que se haya explicado ninguna de las dos.",
    "deut12": "La ley misma empieza, y empieza demoliéndolo todo: derriben sus altares, quiebren sus piedras alzadas, quemen sus Aser\u00e1s, y destruyan su NOMBRE de aquel lugar &mdash; y luego vayan al lugar que Jehov\u00e1 escoja para poner SU nombre. Seis veces env\u00eda este cap\u00edtulo a Israel a ese lugar y ni una sola vez, en todo el libro, se le pone nombre; Jerusal\u00e9n y Si\u00f3n no aparecen en Deuteronomio. Como un solo altar a una semana de camino acabar\u00eda con la carne, el cap\u00edtulo concede entonces lo que Lev\u00edtico 17 prohib\u00eda &mdash; degollar y comer en casa, el inmundo y el limpio por igual, como una gacela &mdash; y da su propia raz\u00f3n: la distancia. Solo se retiene la sangre, y abstenerse de ella exige una palabra de guerra: S\u00c9 FUERTE, cuyas otras dos apariciones son el encargo a Josu\u00e9. Y la frase «cada hombre lo que sea recto a sus propios ojos», con la que el libro de los Jueces terminar\u00e1 dos veces, recibe respuesta catorce vers\u00edculos despu\u00e9s moviendo los ojos: lo recto a los ojos de Jehov\u00e1 &mdash; la f\u00f3rmula con que Reyes calificar\u00e1 a cada rey de Israel.",
    "deut14": "El capítulo pasa del pueblo que hay que quemar a lo que se puede comer, y hace algo que este proyecto no veía desde Levítico: repite un capítulo entero de otro libro. Puesto al lado de <a href=\"leviticus-11.es.html\">Levítico 11</a>, la reescritura se lee línea por línea —veintiún nombres de aves frente a veinte, y el que sobra es casi con seguridad un milano copiado dos veces en dos grafías, porque ד y ר se distinguen por el largo de una esquina y cada uno de los tres nombres está en exactamente un versículo de la Biblia—. Se mueve UNA sola ave, el cormorán, del segundo puesto de su serie al último. Deuteronomio añade diez animales permitidos que Levítico no enumera —tres de los siete nombres de caza no aparecen en ningún otro sitio, y por eso el estante produce un unicornio y una jirafa—, suprime el permiso de comer langostas, y cambia la palabra operativa del <em>sheqets</em> de Levítico 11 (ocho veces allí, ninguna aquí) por <em>to'evah</em>, la que el capítulo 13 usó de la apostasía de un pueblo entero. Empieza prohibiendo dos ritos de duelo en el único palmo de piel donde el Shemá manda atar las palabras de Dios, y termina en un diezmo que conviertes en plata y te gastas en cerveza.",
    "deut15": "Cada siete a&ntilde;os se cancelan todas las deudas &mdash;y la ley nombra por anticipado el c&aacute;lculo que har&aacute; un prestamista cuando se acerque el a&ntilde;o s&eacute;ptimo&mdash;. A ese pensamiento lo llama una palabra de <em>beliyya&rsquo;al</em>, el sustantivo m&aacute;s duro que tiene este libro y que solo hab&iacute;a usado una vez, dos cap&iacute;tulos atr&aacute;s, de los hombres que arrastran a un pueblo entero a la apostas&iacute;a: en la Tor&aacute; la palabra est&aacute; dos veces, y esta es la &uacute;nica de las dos que describe un pensamiento y no a personas. Con siete vers&iacute;culos de diferencia el cap&iacute;tulo dice que no habr&aacute; menesteroso en ti y que nunca faltar&aacute;n menesterosos en la tierra &mdash;y el estante lee de seis maneras distintas la part&iacute;cula min&uacute;scula de la que depende el vers&iacute;culo 4, desde la cl&aacute;usula de excepci&oacute;n de la KJV hasta el &laquo;para que&raquo; de la Reina-Valera&mdash;. Luego se rehace la ley del esclavo de <a href=\"exodus-21.es.html\">&Eacute;xodo 21</a> y los cambios se leen l&iacute;nea por l&iacute;nea: a tu HERMANO te lo venden en vez de comprarlo t&uacute;, no puedes despedirlo VAC&Iacute;O &mdash;la palabra que Jacob le ech&oacute; en cara a Lab&aacute;n&mdash; y tienes que cargarlo de bienes, con un verbo hecho sobre la palabra \u00abcollar\u00bb que est&aacute; en ese vers&iacute;culo y en ning&uacute;n otro de la Biblia. La lezna en la oreja se queda; el POSTE de la puerta desaparece sin ruido, y el poste es la superficie que el Shem&aacute; hab&iacute;a reservado. Y contado en todo el libro, este es el primer cap&iacute;tulo de Deuteronomio sin un solo \u00abustedes\u00bb en plural.",
    "deut16": "Las tres fiestas de peregrinaci&oacute;n, y cada una de ellas queda atra&iacute;da al &uacute;nico lugar escogido. La Pascua es el caso m&aacute;s agudo: <a href=\"exodus-12.es.html\">&Eacute;xodo 12</a> la come en casa, con sangre en los postes, y este cap&iacute;tulo proh&iacute;be sacrificarla <em>en cualquiera de tus puertas</em>. Y manda, con una sola palabra, lo que &Eacute;xodo proh&iacute;be con la forma m&aacute;s fuerte que tiene el hebreo: &Eacute;xodo 12:9 proh&iacute;be cocer la Pascua <em>en agua</em> y la manda asada al fuego, y 16:7 dice <em>y la COCER&Aacute;S</em>, con ese mismo verbo. Doce de los trece testigos del estante evitan imprimirlo; uno no; y 2 Cr&oacute;nicas resuelve el problema cociendo la Pascua AL FUEGO y llamando a eso la ordenanza. La fiesta de las Semanas es la &uacute;nica sin fecha &mdash;se empieza a contar cuando la hoz entra en la mies, palabra que est&aacute; en dos vers&iacute;culos de la Biblia y los dos aqu&iacute;&mdash;. La de las Caba&ntilde;as ha cambiado de nombre desde &Eacute;xodo, donde era la de la Cosecha. Luego jueces y oficiales en todas tus puertas, el soborno que ciega los ojos de los sabios &mdash;las dos mismas cosas que el cap&iacute;tulo 10 dijo que Dios no hace&mdash; y <em>la justicia, la justicia seguir&aacute;s</em>, una palabra duplicada que est&aacute; en exactamente un vers&iacute;culo de la Biblia hebrea y que el estante construye de seis maneras distintas. Y cierra con una Asera y una piedra alzada: el objeto que Jacob levant&oacute; en Betel y del que Mois&eacute;s puso doce al pie del Sina&iacute;, ahora la cosa que Jehov&aacute; <em>aborrece</em>.",
    "deut17": "El capítulo que le dio su nombre al libro. Termina el tribunal que abrió el <a href=\"deuteronomy-16.es.html\">capítulo 16</a>: un caso capital necesita dos o tres testigos y jamás puede descansar en uno solo, y la mano del propio testigo ha de ser la primera sobre el condenado &mdash;el procedimiento que está detrás de «el que esté sin pecado, que tire la primera piedra»&mdash;. Un caso demasiado <em>maravilloso</em> para un tribunal de pueblo &mdash;el mismo verbo que «¿hay algo demasiado maravilloso para Jehová?» sobre la risa de Sara&mdash; sube al único lugar escogido, y rechazar ese fallo es delito capital. Después, tras nombrar a trece reyes extranjeros, Deuteronomio le permite uno a Israel, con condiciones que le quitan al cargo casi todo aquello para lo que sirve normalmente un rey: no muchos caballos, y nada de hacer volver al pueblo a Egipto a comprarlos; no muchas mujeres; no mucha plata ni oro. Su único deber positivo es escribir <em>mishné ha-torá</em> &mdash;dos palabras que están en un solo versículo de la Biblia hebrea, que el griego leyó como «esta segunda ley», y que son la razón de que el libro se llame Deuteronomio.",
    "deut18": "Siguen los cargos, y este fija de qué vive el levita y quién habla por Dios. Ni <a href=\"deuteronomy-10.es.html#v10-9\">porción ni heredad</a> para toda la tribu de Leví &mdash;el sexto y último versículo que lleva esa fórmula, cuyo primero son Raquel y Lea preguntando si les queda alguna en la casa de su padre&mdash;. La ración del sacerdote es la espaldilla, las dos quijadas y el cuajar: tres piezas que <a href=\"leviticus-7.es.html#v7-31\">Levítico</a> y <a href=\"numbers-18.es.html#v18-18\">Números</a> no le dan nunca, y el cuajar paga una deuda que dejó abierta <a href=\"numbers-25.es.html#n25-6\">Números 25</a>. Luego el catálogo de adivinación más largo de la Biblia &mdash;ocho oficios en dos versículos, encabezados por un hombre que quema a su propio hijo&mdash; respondido en cuatro palabras hebreas con el vocabulario del altar: <em>íntegro serás</em>, la norma del animal sin defecto vuelta sobre una persona un capítulo después de que 17:1 prohibiera el animal con defecto. Y después un profeta <em>como yo</em>, expresión que en la Torá usan exactamente otros dos hablantes: José atribuyéndose la adivinación y Dios diciendo que no hay como él en toda la tierra. El capítulo es singular de principio a fin salvo en dos palabras, <em>a él escucharéis</em>, que son justo las que Hechos cita y pluraliza. Cierra con la prueba del falso profeta que el <a href=\"deuteronomy-13.es.html#v13-3\">capítulo 13</a> ya había contradicho, y que dos relatos posteriores aplican en direcciones opuestas: <a href=\"jeremiah-28.es.html#v28-9\">Jeremías 28</a> apuntándola contra un rival, y Micaías en 1 Reyes 22:28 apuntándosela a sí mismo.",
    "deut22": "Veintinueve versículos que no nombran ni a una persona ni un lugar, y un capítulo que una y otra vez resulta ser una reescritura. Abre rehaciendo <a href=\"exodus-23.es.html#v23-4\">Éxodo 23:4-5</a> con una palabra cambiada: allí el buey extraviado y el asno caído son de <em>tu enemigo</em>, y aquí, cuatro veces en cuatro versículos, de <em>tu hermano</em> &mdash;y el verbo de lo que no debes hacer pasa a ser <em>hit'alem</em>, ESCONDERTE, que está en seis versículos de la Biblia y tres de ellos son estos. Después la ley del vestir del otro sexo, cuyas dos mitades no están construidas igual: el <em>manto</em> de una mujer frente al <em>kelí</em> de un hombre, la palabra hebrea de los pertrechos, las herramientas y las armas &mdash;una asimetría que conservan la KJV, la ASV, la NWT 1984 y la RV 1909, y que todas sus propias revisiones aplanan a «ropa» en los dos lados. Un nido de pájaro lleva la misma recompensa exacta que honrar a tu padre y a tu madre, los dos únicos mandamientos del libro que la comparten. Un pretil se nombra con una palabra que está en un solo versículo de la Biblia, contra una frase en la que <em>el que cae cae</em>. <em>Sha'atnez</em> es la palabra que <a href=\"leviticus-19.es.html#v19-19\">Levítico 19</a> dio sin su significado, y este capítulo pone la glosa; la cláusula penal de la viña dice que la cosecha QUEDARÁ SANTIFICADA, que cuatro versiones imprimen como su contrario, <em>corrompida</em>. El versículo de las borlas usa la palabra propia del templo para las cadenillas de las columnas de Salomón, en las cuatro puntas que la Biblia por lo demás le da a la tierra. Y después diecisiete versículos de casuística sexual: la acusación falsa de un marido respondida con un manto extendido en la puerta, una infamia que la Biblia en todo otro lugar le carga a un hombre, una violación razonada como un homicidio, una joven en el campo sin <em>quien la salve</em> &mdash;y, al final, la decisión de traducción más difícil del capítulo, donde el hebreo tiene un verbo más débil que el que usó tres versículos antes y la NIV pone «rapes her» en los dos.",
    "deut23": "Veintiséis versículos en hebreo y veinticinco en toda Biblia inglesa, porque el primero de ellos &mdash;<em>ningún hombre tomará a la mujer de su padre</em>&mdash; es el versículo que el estante acaba de imprimir como 22:30. Después una cerca alrededor de la <em>asamblea de Jehová</em>, una expresión que está en ocho versículos de la Biblia y cuatro de ellos son estos: el hombre hecho eunuco, el <em>mamzer</em> (una palabra tan incierta que la Douay la deja en hebreo), el amonita y el moabita hasta la décima generación, para siempre &mdash;porque nadie salió con pan y agua, y porque Balac alquiló a Balaam para <em>maldecir</em>, con un verbo que Números nunca usó de él&mdash;, pero el edomita admitido, <em>porque es tu hermano</em>, y el egipcio, <em>porque forastero fuiste en su tierra</em>. Un campamento mantenido limpio con una estaca de tienda por paleta, porque <em>Jehová tu Dios anda en medio de tu campamento</em> con el mismo participio que Génesis usó para el Edén. Un esclavo fugitivo al que no se puede devolver y que se asienta <em>en el lugar que él escoja</em> &mdash;la fórmula que este libro reserva por lo demás para Dios. Ninguna <em>qedeshá</em> y ningún <em>qadesh</em>, y el precio de un perro vedado en el templo; un interés que en hebreo es una mordedura de serpiente, prohibido al hermano y permitido al extranjero; un voto que nunca estuviste obligado a hacer pero que has de pagar una vez dicho. Y al cierre, el caminante hambriento en el campo del prójimo: arrancar espigas con la mano, pero nada de hoz &mdash;la ley que los discípulos cumplían cuando los fariseos protestaron por el sábado y no por el grano.",
    "deut25": "Diecinueve versículos, el segundo capítulo seguido en que el hebreo y el inglés cuentan igual, y cada ley traza una raya en un cuerpo o en un nombre. Unos golpes contados en presencia del juez y detenidos en cuarenta, <em>para que tu hermano no quede rebajado a tus ojos</em> &mdash;el techo que la Misná lee como treinta y nueve, y por eso Pablo pudo decir que cinco veces había recibido <em>cuarenta menos uno</em>. Cuatro palabras hebreas sobre un buey al que no se puede poner bozal mientras trilla, citadas dos veces en el Nuevo Testamento para el salario de un predicador. El levirato: la viuda de un hermano muerto, un hermano que <em>no desea</em> tomarla, una sandalia quitada ante los ojos de los ancianos y un escupitajo en la cara que es el de Miriam en <a href=\"numbers-12.es.html#v12-14\">Números 12:14</a> &mdash;y una casa nombrada por la sandalia para siempre. Una mujer que agarra a un hombre por sus partes en una pelea, y la única ley de mutilación de la Torá, cerrada por el quinto y último <em>tu ojo no se compadecerá</em>. <em>Piedra y piedra</em> en la bolsa, efa y efa en la casa, y la <em>piedra cabal</em> que es también la piedra con que se edifica el templo de Salomón. Y Amalec: el gemelo de <a href=\"deuteronomy-24.es.html#v24-9\">24:9</a>, la propia palabra de Esaú para los rezagados, y la sentencia que <a href=\"exodus-17.es.html#v17-14\">Éxodo 17:14</a> le dio a Dios entregada a Israel &mdash;<em>borrarás la memoria de Amalec</em>&mdash; en un capítulo que abrió levantando un hijo para que un nombre <em>no</em> fuera borrado.",
    "deut26": "Diecinueve versículos, el tercer capítulo seguido en que el hebreo y el inglés cuentan igual, y la última ley del código que empezó en el capítulo 12 &mdash;dos liturgias, un credo y un juramento, puestos en la boca de un israelita corriente para decirlos ante el altar. Una canasta de primicias &mdash;<em>tene</em>, una palabra en cuatro versículos de la Biblia, todos en este libro&mdash; que lleva <em>de lo primero de todo el fruto del suelo</em>, que es la frase de Caín en Génesis 4:3 con la palabra que faltaba puesta de vuelta. Luego el credo: <em>un arameo errante era mi padre</em>, tres palabras en un versículo de la Biblia hebrea, cuya segunda palabra significa perdido, y a punto de perecer, y, en la Douay, perseguido; un padre llamado por el nombre que el Génesis da solo a la familia de Labán; y una historia de Egipto armada tesela a tesela con <a href=\"numbers-20.es.html#v20-15\">Números 20</a> y Éxodo, con el mensajero de Números dejado fuera. El diezmo del tercer año jurado fuera de la casa con el verbo que este libro reserva para <em>quemar el mal</em>, tres negaciones que tocan todas la muerte, y <em>mira desde lo alto</em> &mdash;el verbo de asomarse a una ventana&mdash; pedido al cielo. Y un verbo en dos versículos de la Biblia que el estante vierte de siete maneras: <em>has declarado a Jehová</em>, <em>Jehová te ha declarado</em>, la oferta de <a href=\"exodus-19.es.html#v19-5\">Éxodo 19:5</a> aceptada cuarenta años después, y una nación vestida con la propia <em>gloria</em> de Aarón.",
    "deut27": "Veintiséis versículos, el cuarto capítulo seguido en que el hebreo y el inglés cuentan igual, y el código que se cerró en el capítulo 26 se pone ahora en escena como ceremonia &mdash;Éxodo 24 hecho de nuevo a la otra orilla del Jordán. Piedras grandes encaladas con <em>cal</em> (una palabra que los profetas guardan por lo demás para lo que un horno hace de un cuerpo), toda la ley escrita sobre ellas <em>con claridad y a fondo</em>, con el adverbio que este libro les da a sus jueces, y un altar de <em>piedras cabales</em> &mdash;el adjetivo de la pesa justa de <a href=\"deuteronomy-25.es.html#v25-15\">25:15</a>&mdash; sobre el que no puede blandirse hierro, con la única ofrenda de paz de Deuteronomio encima. <em>Calla y oye</em>, con un verbo en un versículo de la Biblia; seis tribus en el Gerizim para bendecir y seis en el Ebal <em>para la maldición</em>, los dos que Jacob maldijo a la cabeza del lado de la bendición y Rubén el primero del otro; y luego doce maldiciones, cada una respondida por todo el pueblo con <em>Amén</em> &mdash;una palabra que solo una esposa acusada, en <a href=\"numbers-5.es.html#v5-22\">Números 5:22</a>, había dicho antes que ellos. Entre las doce: la imagen tallada y fundida de la casa de Micaía, la octava y última <em>abominación a Jehová</em> del libro, una suegra nombrada con una palabra que la Biblia usa una vez, un prójimo herido <em>en secreto</em>, y una última maldición que Pablo cita con un <em>todas</em> que el hebreo no tiene.",
    "deut28": "Sesenta y nueve versículos en hebreo y sesenta y ocho en castellano, con lo que la racha de cuatro capítulos de cuentas iguales termina aquí &mdash;las bendiciones y las maldiciones del pacto, catorce versículos de las unas y cincuenta y cuatro de las otras, y la maldición es un solo párrafo masorético sin corte alguno&mdash;. <em>Si de veras escuchas</em>, con el verbo duplicado de Mara; bendiciones que te <em>alcanzan</em> con el verbo del perseguidor del Cántico del Mar; seis <em>bendito</em> en cuatro versículos respondidos por seis <em>maldito</em>, las palabras que Dios dijo a la serpiente y a Caín; la canasta de <a href=\"deuteronomy-26.es.html#v26-2\">26:2</a> junto a la artesa de la noche del éxodo; el fruto del vientre que Elisabet bendecirá en <a href=\"luke-1.es.html#v42\">Lucas 1:42</a>. Luego un cielo de bronce sobre una tierra de hierro &mdash;los dos metales de <a href=\"leviticus-26.es.html#v26-19\">Levítico 26</a> puestos del revés&mdash;, la úlcera de Egipto, una palabra que los masoretas no leían en voz alta, los tres verbos del capítulo 20 con el otro hombre ya llegado, un yugo de hierro que llevará <a href=\"jeremiah-28.es.html#v28-14\">Jeremías 28</a>, una nación-águila cuya lengua no entenderás, un asedio en que la mujer delicada come en secreto, el <em>no halló lugar de reposo para la planta de su pie</em> de la paloma de Génesis 8:9, <em>me has abandonado</em> &mdash;dos palabras que están en un solo versículo más de la Biblia, el del Salmo 22&mdash; y, al final de todo, un regreso a Egipto en barcos a un mercado donde nadie compra.",
    "deut30": "Los números de versículo hebreo e inglés vuelven a coincidir después del desfase del capítulo 29. La raíz <em>shuv</em>, &laquo;volver&raquo;, suena siete veces en los primeros diez versículos &mdash;el propio Jehová <em>hará volver tu cautiverio</em>, reunirá a los desterrados desde el mismo extremo de los cielos, y <em>circuncidará tu corazón, y el corazón de tu descendencia</em>&mdash;, una respuesta, no dicha, al corazón que 29:4 ya dijo que Jehová no había dado. Luego el mandamiento que <em>no te es demasiado difícil&hellip; ni está lejos</em> &mdash;no en los cielos, no al otro lado del mar, sino una palabra ya <em>en tu boca y en tu corazón</em>, los mismos tres versículos que Pablo reescribirá algún día, cambiando el mar por el abismo, en una pregunta sobre quién hace bajar a Cristo y quién lo resucita de entre los muertos. Y el propio cierre del capítulo: un verbo que simplemente declara la noticia, uno segundo, más antiguo, que llama al cielo y a la tierra a atestiguarla, y la última palabra de una ceremonia del pacto &mdash;<em>escoge la vida</em>.",
    "deut31": "Treinta versículos, y la porción semanal más corta de toda la Torá: <em>Vayelekh</em>, llamada así por un verbo de ir que nunca dice adónde. Moisés, a los ciento veinte años, dice que ya no puede <em>salir ni entrar</em> &mdash;las mismas dos palabras con que Caleb dirá a los ochenta y cinco que todavía puede&mdash; y entrega el mando: <em>sé fuerte y resuelto</em>, dicho tres veces en un solo capítulo y en dos números distintos, con una promesa debajo que no va de que Dios no falle sino de una mano que no se afloja. Luego la instrucción se pone por escrito y se vuelve un objeto con custodios: leída en voz alta a los hombres, las mujeres, los pequeños y el extranjero residente cada siete años, en la fiesta de las Cabañas, y escrita con el vocabulario del día en Horeb que está hecha para repetir. La tienda de reunión asoma en su único versículo de todo el libro; una columna de nube se detiene a la entrada; y Dios dicta un cántico para archivarlo por adelantado como prueba, junto a otros dos testigos &mdash;un libro dejado al lado del arca y no dentro, y el cielo&mdash;. Y en medio, la frase que le dio su juego de palabras a un libro posterior: <em>ciertamente esconderé mi rostro.</em>",
    "deut32": "Cincuenta y dos versículos de poesía, <em>Ha&rsquo;azinu</em> &mdash;el Cántico de Moisés, que abre con <em>escuchen, cielos, y hablaré</em>. La Roca nombrada por primera vez en la Biblia, lluvia y rocío por doctrina, un águila que agita su nido, e Israel bajo un nombre que la prosa nunca usa &mdash;<em>Jesurún</em>, que engordó y coceó&mdash;; dioses que los padres nunca temieron, y un Dios pintado, en una sola línea, como padre y de parto a la vez. Una bifurcación textual recorre la propia estructura del poema &mdash;&laquo;hijos de Israel&raquo; en el hebreo que traduce este proyecto, &laquo;hijos de Dios&raquo; en un fragmento del mar Muerto y en la Septuaginta griega&mdash;, la misma bifurcación que una carta del Nuevo Testamento lee, en el último versículo mismo del cántico, como ángeles a los que se les manda adorar al Hijo. Luego Moisés entrega sus últimas palabras a un hombre al que el texto de pronto llama por su nombre viejo, y sube, por mandato de Dios mismo, a la única montaña desde la que se ve la tierra entera y no se alcanza ninguna parte de ella.",
    "deut33": "Las últimas palabras de Moisés, una bendición sobre las tribus antes de subir el monte que el capítulo anterior nombró. Se le llama &laquo;el hombre de Dios&raquo; &mdash;un título que toda la Torá le da exactamente una vez, aquí y en ningún otro lugar&mdash;, y abre con una teofanía cuya &laquo;ley de fuego&raquo; es una sola palabra masorética que ninguna versión del estante lee igual. Rubén y Judá reciben las dos bendiciones más delgadas del capítulo; la maldición de Leví en Génesis se vuelve el sacerdocio de Leví aquí, el gozne una masacre que este proyecto ya mostró completa; Benjamín el lobo se vuelve Benjamín el amado. La bendición de José toma prestadas sus propias palabras de cierre de Génesis, letra por letra, y su toro salvaje cumple una promesa hecha dos capítulos atrás. Y once tribus son nombradas. La duodécima, maldecida junto a Leví en la misma página de Génesis, no aparece en absoluto.",
    "deut34": "El último capítulo de la Torá: Moisés sube el monte que este libro ha estado señalando, se le muestra toda la tierra, y muere a los ciento veinte años con el ojo sin nublar y el vigor sin gastar &mdash;la primera persona en cinco libros que cae exactamente en el número que Génesis fijó una vez como techo para todos los demás. Lo entierra una mano que la gramática nunca nombra, en una tumba de la que este capítulo dice dos veces que nadie ha encontrado nunca. El luto prometido de Aarón llega a tiempo, treinta días; las dos manos de Josué, mandadas como una, siguen siendo dos. Y el veredicto de cierre &mdash;una frase que no se pronuncia en ningún otro lugar de toda la Biblia hebrea&mdash; deja atrás un modismo más raro y extraño sobre cómo Dios lo conoció y se decide, una última vez, por &laquo;cara a cara&raquo;.",
    "deut29": "Veintiocho versículos en hebreo y veintinueve en castellano &mdash;la misma costura que 28:69 ya señaló, así que cada versículo de aquí queda un número por detrás de su propia cita común&mdash;. El pacto se jura en Moab: todos puestos en pie, <em>tus cabezas, tus tribus, tus ancianos y tus oficiales&hellip; tus pequeños, tus mujeres, y tu extranjero que está en medio de tu campamento, desde el que corta tu leña hasta el que saca tu agua</em>, y el juramento que ata <em>al que está aquí de pie con nosotros hoy&hellip; y también al que no está aquí con nosotros hoy</em>. Un corazón que Jehová &laquo;no ha dado&raquo; para conocer, junto a cuarenta años en que un vestido y una sandalia no se gastaron; <em>una raíz que produce hiel y ajenjo</em>, la cláusula exacta que la Biblia griega le entrega a Hebreos 12:15 cuatro siglos después; un hombre que se bendice a sí mismo, &laquo;tendré paz, aunque ande en la terquedad de mi corazón&raquo; &mdash;tres palabras que la Biblia no volverá a usar hasta que Jeremías las repita siete veces, una de ellas con la misma falsa paz en boca de un falso profeta&mdash;. Luego una tierra de azufre y sal que las naciones preguntarán, como preguntaron por <a href=\"genesis-19.es.html#v19-24\">Sodoma y Gomorra</a> &mdash;y, nombradas junto a ellas aquí, Admá y Zeboím, las dos ciudades menores que <a href=\"genesis-14.es.html#v14-2\">Génesis 14</a> ya había listado pero que el propio relato de la destrucción en Génesis 19 dejó fuera&mdash;. Una nación arrancada de raíz con el mismo verbo con que Jeremías 1:10 será comisionado; y la sentencia que los rabinos marcaron con puntos: <em>las cosas ocultas pertenecen a Jehová nuestro Dios, pero las reveladas nos pertenecen a nosotros y a nuestros hijos para siempre</em>.",
    "deut24": "Veintidós versículos, y el hebreo y el inglés vuelven a contarlos igual. La única ley de divorcio de la Torá lo abre, y es una frase de cuatro versículos que no manda nada hasta su última cláusula: a una mujer despedida con una <em>carta de ruptura</em> y casada con otro no se puede <em>volver a tomar</em> &mdash;las palabras que el capítulo usa una vez más, de una gavilla olvidada, y en ningún otro lugar de la Biblia. Un recién casado retenido en casa un año para hacer alegrarse a su mujer; un molino de mano que no puede tomarse en prenda, <em>porque es una vida</em>; un secuestrador que <em>trafica con</em> un hermano, con el verbo que <a href=\"deuteronomy-21.es.html#v21-14\">21:14</a> prometió, y muere como ladrón; una enfermedad de la piel entregada a los sacerdotes, con los siete días de Miriam fuera del campamento como lo que hay que recordar. Un acreedor que ha de quedarse en la calle mientras el pobre escoge qué dar en prenda, y devolver el manto cuando el sol se pone, para que <em>se acueste en su manto y te bendiga</em> &mdash;la justicia de <a href=\"deuteronomy-6.es.html#v6-25\">6:25</a>, ganada con un solo vestido; un jornalero pagado en su día, porque <em>hacia él alza su vida</em>; padres e hijos a los que no puede darse muerte los unos por los otros, un versículo que un rey de Judá obedeció citándolo; el forastero, el huérfano y la viuda, nombrados de un solo aliento cuatro veces; y la cosecha que no puede repasarse <em>tras de ti</em> &mdash;la gavilla, el olivo, la vid&mdash;, porque <em>fuiste esclavo en Egipto</em>, dicho dos veces.",
    "deut21": "Cinco leyes sin nada evidente en com\u00fan, y una sola ra\u00edz corriendo por debajo de tres de ellas. Se halla un cuerpo en un campo sin asesino conocido, y los ancianos del pueblo m\u00e1s cercano le rompen la cerviz a una becerra en un valle sin labrar y se lavan las manos sobre ella &mdash;un rito sin juicio, sin acusado y sin altar, en el que a los sacerdotes se los hace pasar al frente y luego no se les da nada que decir&mdash;. El valle es un <em>najal eitan</em>, dos palabras que est\u00e1n en un solo vers\u00edculo m\u00e1s de la Biblia, el juicio de Am\u00f3s corriendo como las aguas, lo que las fija como agua perenne y deja del lado perdedor a la KJV y a las dos Reina-Valeras, que leen terreno escabroso siguiendo al lat\u00edn. Despu\u00e9s una mujer cautiva a la que se le da un mes entero para llorar a sus padres antes de que se decida cualquier otra cosa, y a la que protege luego un verbo que la Biblia no usa m\u00e1s que de un secuestrador; despu\u00e9s la ley que le proh\u00edbe a un padre adelantar al hijo de la esposa amada por encima del primog\u00e9nito de la aborrecida, escrita con las dos expresiones que G\u00e9nesis 29 us\u00f3 de Raquel y de Lea, de modo que el estatuto describe la casa del propio Jacob y proh\u00edbe lo que Jacob hizo; despu\u00e9s el hijo contumaz y rebelde, cuyos dos adjetivos Jerem\u00edas vuelve sobre la naci\u00f3n entera y cuya acta de acusaci\u00f3n &mdash;gl\u00f3t\u00f3n y borracho&mdash; es el insulto exacto que se le lanza a Jes\u00fas en <a href=\"matthew-11.es.html#v11-19\">Mateo 11:19</a>. Cierra con un cad\u00e1ver que no puede pasar la noche en el \u00e1rbol, porque maldici\u00f3n de Dios es el colgado &mdash;tres palabras sobre cuya direcci\u00f3n el estante nunca se ha puesto de acuerdo, y la frase que cita Pablo en G\u00e1latas 3:13 despu\u00e9s de a\u00f1adirle <em>todo</em> y quitarle <em>Dios</em>.",
    "deut20": "La ley de la guerra, abierta por un sacerdote &mdash;no Moisés&mdash; que discute a cuatro hombres para sacarlos del miedo, y cerrada por un ejército al que se le prohíbe blandir un hacha contra un árbol frutal. Entre las dos, cuatro hombres enviados a casa antes de que empiece la lucha &mdash;una casa sin dedicar, una viña todavía no <em>jalal</em> (liberada para uso común, la misma raíz que hace dos capítulos significaba COMENZAR), un matrimonio no consumado, y por último el temeroso y tierno de corazón, una frase exacta que este libro no usa en ningún otro lugar. A una ciudad lejana se le ofrece la paz y, si la rechaza, una guerra de términos limitados; a una ciudad dentro de la tierra no se le ofrece ninguna de las dos &mdash;no debe quedar con vida nada que respire, contra seis naciones y no las siete que nombró el <a href=\"deuteronomy-7.es.html#v7-1\">capítulo 7</a>, el gergeseo omitido en silencio. Y la última frase del capítulo es una de las más genuinamente disputadas de la Torá &mdash;¿acaso el árbol del campo es hombre, para retirarse ante ti al asedio? &mdash;, leída en este estante como pregunta, como afirmación de que el árbol da vida, y como afirmación de que simplemente no es un combatiente: tres tradiciones, y esta traducción no vota por ninguna.",
    "deut19": "El repaso de los cargos se vuelve al homicidio, y el capítulo al que todos llaman la ley de las ciudades de refugio no usa la palabra ni una vez: <em>miqlat</em> está en veinte versículos de la Biblia hebrea, once de ellos en <a href=\"numbers-35.es.html\">Números 35</a>, y ninguno en Deuteronomio. Tres ciudades, y otras tres si alguna vez se ensancha el territorio &mdash;una condición que ningún texto posterior registra cumplida, porque Josué 20 se detiene en seis&mdash;. Caminos despejados, para que el hombre a quien se le salió la cabeza del hacha y mató a su prójimo pueda ganarle al <a href=\"numbers-35.es.html#n35-16\">redentor de la sangre</a>, la misma palabra que hace redentor a Booz en <a href=\"ruth-1.es.html\">Rut</a>. Después el mojón <em>que lindaron los primeros</em>, la única ley de su clase en la Torá; y la regla de los dos o tres testigos, que <a href=\"deuteronomy-17.es.html#v17-6\">17:6</a> limitó a los casos capitales y 19:15 levanta a toda acusación &mdash;la redacción que cita <a href=\"matthew-18.es.html#v18-16\">Mateo 18:16</a>, y no la otra&mdash;. Cierra con el testigo malicioso, sentenciado a lo que <em>tramó</em> y no a lo que hizo, y con la frase que ha sobrevivido a su propio contexto en todas las lenguas europeas. ⭐ Deuteronomio escribe esa frase con una preposición que las otras dos listas de talión no usan: <em>néfesh BE-néfesh</em>, vida por vida, está en un solo versículo de la Biblia hebrea, mientras que <a href=\"exodus-21.es.html#v21-23\">Éxodo</a> y <a href=\"leviticus-24.es.html#v24-18\">Levítico</a> escriben los dos <em>tájat</em>, en lugar de.",
    "deut13": "En hebreo este capítulo empieza con el versículo que toda Biblia inglesa imprime como el final del capítulo 12 —no le añadas, no le quites—, y los masoretas ponen justo después su marca de párrafo más fuerte, sin unirlo a ninguno de los dos lados. <a href=\"deuteronomy-4.es.html\">Deuteronomio 4:2</a> dio la misma orden en plural; aquí está en singular, y eso convierte un duplicado en prueba. Luego la pregunta más dura que dejó el capítulo anterior: si el culto ocurre en un solo lugar y en ningún otro, ¿quién decide? Tres casos, cada uno marcado por su propia división escribal —un profeta cuya señal SÍ SE CUMPLE y que entonces dice «vayamos tras otros dioses»; un hermano, un hijo, una hija, la mujer de tu seno, el amigo que es como tu propia alma; y un pueblo entero—. Un solo verbo mueve los tres. Al pueblo se le aplica el anatema reservado a los cananeos y se le sentencia a ser un <em>tel</em> para siempre —dos palabras que están en un solo versículo más de toda la Biblia hebrea, sobre Hai—. Y el capítulo cierra con la fórmula que acuñó el capítulo 12, sorprendiendo a la KJV y a la Ginebra recuperando los ojos que acababan de perder.",
    "deut10": "El segundo par de tablas, labradas esta vez por Moisés mismo y subidas en su propia mano a un Dios que escribe otra vez las mismas palabras &mdash;y un arca de madera pelada, hecha antes de subir, que Éxodo construye cuatro capítulos después en oro y por manos de otro&mdash;. Luego Aarón muere en Moserá, donde Números lo entierra dos veces en un monte a cuatro paradas de allí, y la Biblia de Ginebra de 1599 responde a la contradicción en una línea al margen. La tribu de Leví queda apartada para tres verbos &mdash;llevar, estar de pie, bendecir&mdash; y pagada con una persona en lugar de tierra. Y entonces el sermón gira de la cerviz al corazón: circuncidad su prepucio, y no endurezcáis más la cerviz. La razón que da no es el poder sino la parcialidad invertida: el Dios de los dioses no levanta el rostro de nadie ni toma soborno, y ama al extranjero, dándole pan y un manto.",
    "deut9": "Mois\u00e9s deja de advertir y empieza a corregir: la tierra no se da por la justicia de Israel &mdash;dicho tres veces en tres vers\u00edculos&mdash; sino por la maldad de las naciones y un juramento hecho a tres muertos. El informe aterrador de los exploradores que quebr\u00f3 a la primera generaci\u00f3n se cita palabra por palabra y se CONCEDE en vez de refutarse; el &laquo;fuego devorador&raquo; que hace cuatro cap\u00edtulos era una advertencia a Israel sale ahora delante de \u00e9l. Luego el becerro de oro, contado por el hombre que estuvo all\u00ed &mdash;cuarenta d\u00edas en un monte sin pan ni agua, las tablas hechas pedazos ante sus ojos y no al pie de un monte, la ira del propio Mois\u00e9s desaparecida del relato, y dos cosas sobre Aar\u00f3n que \u00c9xodo nunca dice. El cap\u00edtulo se enmarca a s\u00ed mismo con tres palabras hebreas que no aparecen en ning\u00fan otro sitio de la Biblia, y cambia de n\u00famero gramatical en la misma juntura.",
    "deut8": "Man\u00e1, y la raz\u00f3n de \u00e9l: cuarenta a\u00f1os de hambre construidos para ense\u00f1ar una sola lecci\u00f3n, citada palabra por palabra por Jes\u00fas en el desierto. La ropa no envejeci\u00f3; la buena tierra que espera tiene trigo y cebada, vides e higueras y granados, hierro en sus montes y cobre para extraer. Luego la advertencia, construida como una trampa: come, sac\u00edate, edifica buenas casas, mira multiplicarse la plata &mdash;y solo entonces se eleva el coraz\u00f3n y se olvida al Dios que lo dio todo, casi con las mismas palabras que el propio cap\u00edtulo us\u00f3 catorce vers\u00edculos antes para el desierto que ense\u00f1\u00f3 la lecci\u00f3n.",
    ...
    "exod24": "Los Mishpatim se cierran con una ceremonia: el pueblo jura dos veces \u2014una antes de que se escriba una sola palabra, otra despu\u00e9s\u2014 y el segundo juramento a\u00f1ade un verbo: \u00ablo haremos, Y LO OIREMOS\u00bb, la frase sobre la que se construye toda una ense\u00f1anza rab\u00ednica. Mois\u00e9s divide la sangre del sacrificio en dos, la mitad sobre el altar, la mitad arrojada sobre el propio pueblo con cinco palabras que esta traducci\u00f3n conserva exactamente como las tiene el hebreo: \u00abhe aqu\u00ed la sangre del pacto\u00bb \u2014retomadas casi palabra por palabra trece siglos despu\u00e9s, sobre una copa de vino, en la \u00daltima Cena\u2014. \u26a0 Luego setenta y cuatro personas suben a medio camino del monte y ven a Dios, y comen, y el texto no trata ambas cosas como grados distintos de asombroso \u2014con un pavimento de zafiro bajo sus pies que la tradici\u00f3n rab\u00ednica posterior lee como un memorial deliberado: la misma palabra para \u00abpavimento\u00bb comparte ra\u00edz con \u00abladrillo\u00bb, lo que Israel se vio forzado a fabricar como esclavo en Egipto\u2014. Mois\u00e9s sigue subiendo solo, hasta una nube que cubre la cumbre durante seis d\u00edas antes de que Dios lo llame al s\u00e9ptimo, y desaparece durante cuarenta d\u00edas y cuarenta noches \u2014el primero de lo que se convertir\u00e1, a lo largo del resto de \u00c9xodo, en un n\u00famero muy consecuente.",
    "exod25": "Las instrucciones del tabern\u00e1culo se abren con una contribuci\u00f3n voluntaria, no un impuesto \u2014\u00abde todo hombre cuyo CORAZ\u00d3N lo mueva\u00bb\u2014, financiando un edificio cuyo prop\u00f3sito entero declarado es una preposici\u00f3n: \u00abque me hagan un santuario, para que yo habite ENTRE ELLOS\u00bb, no en \u00e9l. Luego comienzan las especificaciones: un arca cuyas varas nunca pueden quitarse de sus anillos, de modo que el objeto m\u00e1s sagrado del campamento viaja perpetuamente lista para moverse; una cubierta de oro que dos querubines guardan desde cada extremo \u2014no el \u00abpropiciatorio\u00bb que el espa\u00f1ol hereda de la tradici\u00f3n latina, sino literalmente solo \u00abla cubierta\u00bb\u2014, con una promesa adjunta que esos mismos querubines volv\u00edan estructuralmente imposible en la puerta del Ed\u00e9n: \u00aball\u00ed me ENCONTRAR\u00c9 contigo\u00bb. \u26a0 Una mesa para un pan que nunca come aquel ante quien se pone, y un candelabro de oro macizo labrado de una sola pieza de metal, siete l\u00e1mparas, que reaparece \u2014casi, pero no del todo, sin cambios\u2014 en la visi\u00f3n de un profeta nueve siglos despu\u00e9s. Y un elemento de la lista de materiales, las misteriosas pieles de \u00abtachash\u00bb, ha vencido a todo traductor desde que la Versi\u00f3n del Rey Jacobo adivin\u00f3 \u00abtejones\u00bb.",
    "exod26": "El tabern\u00e1culo propiamente dicho resulta ser el FORRO INTERIOR que ning\u00fan visitante de afuera ver\u00eda jam\u00e1s \u2014diez cortinas tejidas con querubines, envueltas en una \u00abtienda\u00bb m\u00e1s sencilla de once cortinas de pelo de cabra, envuelta a su vez en pieles protectoras contra la intemperie, tres capas con lo m\u00e1s sagrado m\u00e1s cerca del centro. Luego los muros: si eran planchas s\u00f3lidas de acacia o un marco abierto tipo enrejado es un debate erudito real y sin resolver \u2014la Reina-Valera dice \u00abtablas\u00bb, la Traducci\u00f3n del Nuevo Mundo dice \u00abarmazones\u00bb, y el argumento pr\u00e1ctico (el peso descomunal de la alternativa; si los sacerdotes de adentro pod\u00edan ver las cortinas con querubines a trav\u00e9s del muro) corta en ambas direcciones. Las dos espigas de cada tabla son, en hebreo, literalmente sus dos \u00abMANOS\u00bb. \u26a0 Y dos cortinas distintas cierran el cap\u00edtulo, distinguidas por dos t\u00e9rminos de oficio diferentes \u2014un tejido de doble cara para el velo que resguarda el arca, un bordado de una sola cara para la cortina m\u00e1s sencilla de la puerta p\u00fablica\u2014, una distinci\u00f3n que termina explicando algo extra\u00f1o trece siglos despu\u00e9s: por qu\u00e9 el relato evang\u00e9lico de la cortina del templo rasgada en la crucifixi\u00f3n no puede precisar a cu\u00e1l cortina se refiere.",
    "exod27": "El mobiliario y la estructura del tabernáculo reciben ahora una frontera: un altar de bronce con cuernos «de una sola pieza» —forjados del mismo metal que hombres fugitivos algún día se aferrarán buscando asilo, y que el juicio de un profeta venidero algún día mandará cortar—, construido deliberadamente HUECO, para que un altar portátil pueda seguir cumpliendo una ley más antigua que exigía que el altar de Dios fuera tierra desnuda o piedra sin labrar, nunca cortada ni subida por escalones. Alrededor de él, un atrio de cien por cincuenta codos cuyo muro entero es tela, no mampostería, cuya única puerta toma prestado el mismo bordado sencillo de la propia puerta exterior de la tienda —los querubines reservados solo para lo que está más adentro. ⚠ Y por primera vez desde que empezaron las especificaciones, una instrucción se dirige al PUEBLO en vez de a Moisés: traigan aceite de oliva puro, batido, para que una lámpara arda cada noche delante de Jehová —estatuto perpetuo, la misma fórmula que selló primero la Pascua, ahora sellando el primer deber estable del sacerdocio, un capítulo antes de que a Aarón o a sus hijos se les den siquiera las vestiduras que los harán sacerdotes.",
    "exod28": "Las instrucciones se apartan por fin de la ESTRUCTURA para volverse hacia las PERSONAS que servirán dentro de ella: Aarón y sus cuatro hijos nombrados individualmente, y «para que me sirva como sacerdote» repetido tres veces antes de que se describa una sola prenda. Un pectoral de JUICIO —la palabra propia de los Mishpatim, Éxodo 21-23, llevada ahora literalmente sobre el corazón— porta doce piedras preciosas famosamente disputadas, una por tribu, y el Urim y el Tumim: nombrados, colocados, y nunca descritos, el único objeto de toda esta página que cada versión del estante se niega a traducir en vez de adivinar. ⚠ Un manto reforzado «como la abertura de una cota de malla»; campanillas de oro y granadas tejidas para que la propia presencia del sumo sacerdote sea audible, «para que no muera»; una lámina de oro que dice SANTO A JEHOVÁ, llevada en la frente para que Aarón pueda «llevar la iniquidad de las cosas sagradas» que Israel trae; y un modismo —«llenar la mano»— que toda traducción importante convierte en silencio en «consagrar», conservado aquí tan literal como «costado» sobre «costilla» en Génesis 2.",
    "exod29": "Llega la ceremonia de ordenación, y cumple la promesa de Éxodo 28: el modismo «llenar la mano» —mantenido literal allí contra el «consagrar» de todo el estante— se dispara nueve veces más aquí, cuatro como verbo y cinco como su propio sustantivo, «el carnero DE LLENADO», el nombre propio del capítulo para el sacrificio que instala a Aarón y a sus hijos. La sangre va sobre los cuernos del altar por primera vez desde que Éxodo 27 los construyó «de una sola pieza»; la sangre de un segundo carnero marca oreja, pulgar, y dedo gordo del pie —oír, hacer, caminar, las tres extremidades del cuerpo, sin explicación alguna. ⚠ Pero el verdadero destino es el versículo de cierre: «HABITARÉ entre los hijos de Israel» —la raíz hebrea exacta detrás de mishkan, «tabernáculo», la palabra que ha dado nombre a todo este proyecto de construcción de cinco capítulos desde Éxodo 25:9. Quince capítulos de oro y cortinas nunca fueron realmente sobre el mobiliario.",
    "exod30": "La lista de mobiliario del tabernáculo, que parecía cerrada dos capítulos atrás, recibe una pieza más: un altar de incienso nombrado solo por lo que hace —«una quema de incienso», una sola raíz haciendo ambos trabajos— hasta que finalmente se pone en uso y gana un nombre propio, «el altar DEL incienso». Sigue un censo, tasado en un medio siclo fijo que el rico no puede inflar ni el pobre rebajar —la misma moneda que sobrevive trece siglos hasta convertirse en el impuesto del templo que Pedro y Jesús pagan en Mateo 17. Luego una fuente para lavarse, bajo pena de muerte, y dos recetas gemelas —el aceite de la unción y el incienso— cada una descrita con la misma frase hebrea de cuatro palabras, «el trabajo de un perfumista». ⚠ Ambas recetas terminan igual: quien componga una para sí mismo, o simplemente disfrute su fragancia sin nunca venderla, es cortado de su pueblo —el disfrute privado, por sí solo, ya es culpa suficiente.",
    "exod31": "Toda la instrucción del tabernáculo se cierra nombrando a quien lo construirá: Bezalel, lleno del «espíritu de Dios» —la misma frase para el Espíritu que se cernía sobre las aguas en la creación— y nombrado hasta su abuelo Hur, quien una vez sostuvo las propias manos de Moisés en batalla. Once versículos recapitulan todo el proyecto anterior en miniatura, cada objeto desde el arca hasta el incienso nombrado una vez más en un solo aliento, antes de que un mandamiento del sábado repita el Cuarto Mandamiento casi palabra por palabra y cierre con el verbo más extraño del capítulo: Dios descansó «y fue REFRESCADO» —la misma palabra rara que este libro usa en todo lo demás solo para un buey, un asno, o un esclavo agotados. ⚠ La verdadera bisagra del capítulo es su última línea: las dos tablas, escritas «con el dedo de Dios», finalmente entregadas —una promesa hecha siete capítulos antes, en el mismo monte donde Moisés ha estado de pie todo este tiempo.",
    "exod32": "El pueblo se impacienta esperando a Moisés, y le exige a Aarón que les haga «dioses que vayan delante de nosotros» —una frase hebrea genuinamente ambigua entre nuevas deidades y una imagen ilegítima del Dios que ya tienen. Aarón funde su oro en un becerro y proclama «una fiesta para Jehová», no un dios distinto. Moisés intercede con un argumento en dos partes —la reputación de Egipto, luego una promesa ya jurada a Abraham— y Dios se arrepiente, por primera vez en el hilo propio de este libro sobre el pesar divino. Moisés desciende con las mismas tablas prometidas siete capítulos antes, ve la danza, y las QUIEBRA al pie del monte antes de moler el becerro hasta hacerlo polvo y hacer que Israel lo beba. ⚠ La propia excusa de Aarón —«lo eché al fuego, y salió este becerro»— es respondida por el verbo final y llano del capítulo: «el becerro, QUE AARÓN HIZO».",
    "exod33": "Jehová repite cada promesa anterior —la tierra, el juramento, un ángel que guíe— y retiene lo único que habría hecho soportable todo lo demás: «no subiré en medio de ti, pues eres un pueblo de dura cerviz». Moisés planta una tienda sencilla muy fuera del campamento y la llama «tienda de reunión», donde habla con Jehová «cara a cara, como habla un hombre a su amigo». Luego presiona más allá, argumentando de vuelta la propia presencia de Dios —no solo un ángel— mediante una volea de cinco veces de la misma palabra, «favor», que cruza entre ambos en seis versículos seguidos. Habiendo ganado eso, pide todavía más: «Muéstrame, te ruego, tu gloria». La respuesta redirige la petición en vez de negarla —bondad que pasa, un nombre proclamado, una mano que cubre a Moisés en la hendidura de una peña— porque «no podrás ver mi rostro, porque el hombre no puede verme y vivir». ⚠ La misma palabra hebrea para «rostro» abre el capítulo como conversación íntima, se vuelve «presencia» en su mitad, y cierra como lo único llanamente imposible de ver.",
    "exod34": "Moisés talla tablas nuevas y sube el monte por segunda vez, y Jehová cumple la promesa del capítulo anterior casi de inmediato, descendiendo en la nube para proclamar su propio nombre en voz alta: «Jehová, Jehová, Dios misericordioso y clemente, tardo para la ira, y abundante en amor leal y verdad» —la autodescripción de Dios más citada de toda la Biblia hebrea. Moisés responde con su propio ruego del capítulo anterior, palabra por palabra, y el pacto se rehace en los mismos términos que el becerro de oro había roto: nada de dioses de fundición, las mismas fiestas repetidas casi palabra por palabra, la misma prohibición de seis palabras de cocer un cabrito en la leche de su madre. Luego Moisés baja del monte, y no sabe que la piel de su rostro RESPLANDECE por haber estado con Dios —lo bastante brillante como para que Israel tema acercarse a él, hasta que aprende a velarlo. ⚠ Ese verbo, qaran, comparte su raíz con la palabra hebrea para «cuerno» —el accidente etimológico que le dio a la famosa estatua de Miguel Ángel sus dos pequeños cuernos, y a Moisés catorce siglos de ser representado como algo que nunca se describió que fuera.",
    "exod35": "Cuando la construcción por fin comienza, Moisés invierte el orden habitual y pone el sábado primero esta vez, añadiendo un detalle genuinamente nuevo —no se encenderá fuego en ninguna morada ese día, la primera vez que la ley nombra un acto específico prohibido. Luego recita toda la lista de materiales y el inventario del mobiliario de vuelta al pueblo casi palabra por palabra desde siete capítulos antes, y responden con las manos abiertas: «todo aquel a quien su corazón impulsó», hombres y mujeres por igual, traen oro, hilo teñido, madera de acacia, e hilado hasta que la ofrenda se llama lo que llanamente es, un regalo voluntario. ⚠ La joyería que traen —narigueras, zarcillos, anillos de sello, brazaletes, «todo artículo de oro»— se describe con la misma palabra, nezem, que nombró exactamente lo que Aarón exigió que se arrancara para el becerro de oro tres capítulos antes: el mismo metal, una vez tomado bajo presión, ahora entregado sin que se lo pidan dos veces. El capítulo cierra nombrando a Bezalel y Aholiab con las palabras exactas que los comisionaron por primera vez antes de que ocurriera toda la crisis de este libro, como si cuatro capítulos de ruptura y reparación no hubieran dejado marca en lo que Dios pretendía construir.",
    "exod36": "Bezalel, Aholiab, y todo artesano hábil por fin se ponen a trabajar, y la ofrenda sigue llegando cada mañana hasta que los propios trabajadores tienen que detenerse y reportar un problema que ninguna otra historia de recaudación en la Biblia tiene: el pueblo trae mucho más de lo suficiente. Moisés hace proclamar una orden por todo el campamento —no traigan más— y «el pueblo fue refrenado de traer», un verbo que en todo el resto de la Biblia describe algo retenido contra su propia naturaleza: lluvia detenida, rocío y cosecha retenidos en una hambruna, un profeta encerrado bajo guardia. Aquí, por una vez, describe frenar un exceso de generosidad. De ahí en adelante el capítulo reporta, versículo por versículo, las mismas instrucciones del tabernáculo dadas siete capítulos antes en Éxodo 26 —cortinas, tablas, basas, barras, velo, cortina— pero cada verbo se ha movido del mandato a la historia cumplida: «harás» se vuelve simplemente «hizo». ⚠ El único problema de ingeniería genuinamente nuevo de todo el relato aparece discretamente en el v29 —las tablas de las esquinas tienen que duplicarse de adelante hacia atrás, un detalle sin equivalente en ninguna otra parte, porque un diseño que funciona en papel todavía tiene que sostener de verdad un ángulo recto.",
    "exod37": "El capítulo se estrecha de todo un equipo a un solo hombre, nombrado una vez: «Bezalel hizo el arca» (v1), y cada versículo después simplemente dice «hizo», sin nombre pero entendido, a través del arca y sus querubines, la mesa, el candelabro de oro, y el altar del incienso. El candelabro repite, casi palabra por palabra, la misma afirmación hecha tres veces siete capítulos antes —forjado de una sola masa de oro puro, sin uniones, sin soldadura— como si el texto desafiara al lector a imaginar cómo. ⚠ El altar del incienso llega fuera de su orden esperado, construido aquí junto al mobiliario de oro del cuarto interior en vez de junto al altar de bronce al que más se parece su nombre y construcción —el capítulo agrupa sus objetos por dónde están, no por la secuencia en que se dieron originalmente las instrucciones. Sus cuernos son «de una sola pieza con él», la frase idéntica ya usada del altar de bronce exterior: dos altares, uno de oro y uno de bronce, construidos bajo la misma regla en lados opuestos de la misma cortina.",
    "exod38": "El altar de bronce y la cerca del atrio se levantan exactamente como se mandó siete capítulos antes, y luego el capítulo se detiene en un detalle sorprendente que ninguna instrucción dio jamás: la fuente de bronce se hizo «de los espejos de las mujeres que servían a la puerta de la tienda de reunión» —el único objeto de todo el tabernáculo cuyo material en bruto el texto se molesta en rastrear hasta quien lo dio. Luego todo el proyecto cierra con algo nuevo, una auditoría formal: cada talento y siclo de oro, plata, y bronce detallado y contabilizado «por mano de Itamar, hijo de Aarón el sacerdote». ⚠ La aritmética realmente cuadra —301,775 siclos de plata, recaudados a razón fija de medio siclo por cabeza, se dividen exactamente en 603,550 hombres, el mismo total que declara el texto abiertamente. Leído frente al becerro de oro tres capítulos atrás, todo el relato se lee como una corrección silenciosa: oro tomado del pueblo y convertido, en secreto, en un ídolo que nadie podía contabilizar, respondido aquí por oro tomado del pueblo y convertido, en público, en un edificio cuya cada onza está anotada y firmada.",
    "exod39": "Las vestiduras sacerdotales se cosen por fin, exactamente como se mandó nueve capítulos antes —cada gema, cada hilo de oro, cada medida coincidiendo con Éxodo 28 palabra por palabra— y el cumplimiento lo dice, en voz alta, diez veces separadas: 'como Jehová mandó a Moisés' cierra versículo tras versículo, la mayor concentración de ese estribillo en toda la Torá, una respuesta deliberada a la total improvisación del becerro de oro tres capítulos atrás. Luego todo el tabernáculo terminado —cada tabla, cortina, utensilio, y prenda— se lleva a Moisés y se enumera una última vez, pieza por pieza nombrada, antes de que él bendiga al pueblo que lo construyó. ⚠ 'Así se ACABÓ' (v32) usa la misma raíz hebrea rara que Génesis usa dos veces para el fin de la creación misma —un eco textual que los eruditos han notado desde hace tiempo recorre todo el relato del tabernáculo, siete discursos respondiendo a siete días.",
    "exod40": "El capítulo final del libro, y avanza en dos grandes pasos: primero un mandato de nueve capítulos y nueve versículos —levantar el tabernáculo, colocar cada objeto, ungirlo todo, vestir y consagrar a Aarón y a sus hijos— respondido en una sola línea, «Así lo hizo Moisés; conforme a todo lo que Jehová le mandó, así lo hizo». Luego ese mismo mandato se vuelve un informe, marcado objeto por objeto, siete de sus cláusulas cerrando con la fórmula idéntica que dominó el capítulo anterior: «como Jehová mandó a Moisés». Y entonces llega la gloria. La nube cubre la tienda, y «la gloria de Jehová llenó el tabernáculo» tan completamente que Moisés —que hablaba con Dios cara a cara y entraba y salía libremente de la tienda— no puede entrar en absoluto. El libro que abrió con un pueblo sin morada propia cierra con Dios habitando entre ellos tan plenamente que hasta Moisés queda afuera de la puerta. ⚠ La última palabra del capítulo lleva una marca escribística masorética que no se usa en ninguna otra parte de esta traducción todavía —{ש}, «una línea vacía al final de algunos libros»— la propia señal de los antiguos copistas de que aquí, exactamente aquí, termina de verdad un libro.",
    ...
    "lam3": "El propio centro del libro, y su poema más disciplinado: sesenta y seis versículos, el alfabeto hebreo recorrido no una sino tres veces, cada una de sus veintidós letras abriendo tres líneas consecutivas seguidas. Por primera vez en Lamentaciones el «ella» colectivo cede el paso a una sola voz —«yo soy el hombre que ha visto aflicción»— y durante dieciocho versículos seguidos esa voz cataloga lo que se le ha hecho: cercado, cazado como presa, blanco de un arquero, triturado, hasta decir llanamente: «pereció mi fuerza, y mi esperanza en Jehová». Entonces, sin ningún hecho nuevo que lo explique, solo un recuerdo elegido: «el amor entrañable de Jehová jamás cesa... nuevas son cada mañana; grande es tu fidelidad» — seis palabras que se convirtieron en un himno que un siglo de lectores sigue cantando. &#9888; La voz se ensancha a «nosotros», confiesa, recae en el lamento crudo, e intercambia dos letras de su propio alfabeto fuera de orden exactamente donde el capítulo 2 ya había prometido que sucedería. Termina, sesenta y seis versículos después de haber empezado, en un ruego por la destrucción del enemigo que se sitúa junto a la esperanza sin resolverla.",
    "lev2": "La ofrenda que no exige que nada muera: flor de harina, aceite, e incienso, horneada en horno o cocida en sartén o en cazuela, con un pequeño puñado quemado como «porción memorial» y el resto guardado como alimento para los sacerdotes. Ni levadura ni miel pueden subir jamás al altar —pero la sal nunca puede faltar, «la sal del pacto de tu Dios». Y la ofrenda más temprana de todas no necesita ninguna cocina: espigas verdes frescas, tostadas al fuego y trituradas a mano, todavía en pie en el campo un instante antes.",
    "lev3": "La ofrenda que nadie está obligado a terminar solo: la ofrenda de paz, de la cual solo la grasa se convierte en humo —riñones, el lóbulo del hígado, y, cuando el animal es una oveja, la cola entera de grasa cortada cerca del espinazo— mientras la carne misma se vuelve una comida compartida, una parte para los sacerdotes, el resto para la misma familia que la trajo. Y el capítulo que revela todo el sistema en una última línea: nunca comas grasa, nunca comas sangre, una regla que este libro defenderá dos capítulos más —de la cual, siglos después, solo una mitad sobrevive en un conjunto muy distinto de instrucciones, escritas para gente que nunca guardó el resto de esta ley.",
    "lev4": "Las leyes de ofrendas pasan del regalo a la culpa: una ofrenda por el pecado graduada, toda su forma ajustada a quién pecó. El sacerdote ungido y la congregación entera reciben la versión elevada —sangre llevada al interior mismo del tabernáculo, rociada siete veces delante del velo, el cuerpo del animal quemado fuera del campamento sin que nadie lo toque, ni siquiera los sacerdotes. Un gobernante y una persona común reciben la versión menor —sangre solo sobre el altar exterior, el cuerpo se convierte en alimento como cualquier otra ofrenda. Cuatro casos, cuatro animales distintos, una sola palabra que delimita cada uno de ellos: shegagah, por error —nada aquí es para un pecado llevado abiertamente— y una sola frase que cierra cada caso, sin importar el rango: y será perdonado.",
    "lev5": "La ley de expiación se amplía: tres casos en que la culpa llega antes que el conocimiento —un testimonio retenido, un roce inadvertido con algo impuro, un juramento precipitado y olvidado— seguidos de una ofrenda por el pecado graduada a lo que una persona realmente puede costear, hasta un puñado de harina para el más pobre, sin aceite ni incienso, la única ofrenda por el pecado incruenta de todo el sistema. Luego la ofrenda por la culpa: el único sacrificio que viene junto con restitución en efectivo, primero por transgredir contra las cosas santas, luego —con las mismas palabras— por engañar a un prójimo respecto a un depósito, una prenda, un objeto perdido hallado y negado. Paga en su totalidad, añade una quinta parte, y solo entonces trae el carnero. ⚠ Este capítulo sigue el conteo hebreo completo, versículos 1-26; la mayoría de las Biblias en español dividen su mitad final en «Levítico 6:1-7».",
    "lev6": "Las mismas leyes de ofrendas, repetidas por segunda vez —no para quienes las traen, sino para los sacerdotes que atienden el altar. El fuego que nunca debe apagarse, de día ni de noche. La propia porción de los sacerdotes de la ofrenda de grano, ahora limitada con restricciones que Levítico 2 nunca precisó. La ofrenda diaria del propio sacerdote ungido, mañana y tarde desde el día de su ordenación —quemada enteramente, sin ninguna porción comestible, porque un sacerdote no puede comer su propio regalo siendo a la vez quien lo da y quien lo recibe. Y la ley de la ofrenda por el pecado cierra con un hecho material duro: una vasija de barro en que se coció la carne se rompe, una de bronce solo se friega —la santidad propagándose por contacto, limpiada donde se puede, destruida donde no. ⚠ Continúa la propia división de versificación de Levítico 5: este es el capítulo hebreo 6 completo, correspondiente al 6:8-30 en español.",
    "lev7": "La economía sacerdotal que cierra toda la sección de siete capítulos de leyes de ofrendas: quién cobra de cuál sacrificio, detallado hasta la piel. La ofrenda de paz se divide en tres ocasiones con tres relojes distintos —una ofrenda de acción de gracias comida ese mismo día, junto con la única regla de pan de todo el sistema que permite panes leudados en el recinto del altar; un voto u ofrenda voluntaria con un día más; lo que quede hasta el tercer día se vuelve carne corrompida, sin valor retroactivamente, como si nunca se hubiera ofrecido. Sigue una prohibición tajante y absoluta de comer grasa o sangre, dirigida a todo Israel y no solo a los sacerdotes. Y toda ofrenda de paz grava permanentemente dos cortes para el sacerdocio —el pecho, mecido delante de Jehová, y el muslo derecho, una contribución— llevados por las propias manos del oferente, no las del sacerdote. Cierra con un colofón formal que nombra seis ofrendas y termina, por fin, lo que se abrió en Levítico 1.",
    "lev8": "Siete capítulos de ley, y ahora la historia que la lleva a cabo: las propias instrucciones de ordenación de Éxodo 29, dadas quince capítulos y años antes, finalmente se realizan casi palabra por palabra. Aarón es lavado, y luego completamente vestido —túnica, cinturón, manto, efod, pectoral, mitra— antes de que una sola gota de aceite lo toque; el tabernáculo mismo es ungido primero, el hombre después. Un novillo por el pecado y un carnero de holocausto ponen en práctica leyes ya legisladas pero nunca antes realizadas, con Aarón y sus hijos poniendo las manos solo sobre las cabezas de los animales, el propio gesto del oferente ordinario —todavía no pueden actuar como sacerdotes, porque todavía no son sacerdotes. Luego el carnero de la consagración: sangre tocada en la punta de la oreja derecha, el pulgar de la mano derecha, el dedo gordo del pie derecho, antes de que la grasa cruda y el pan se coloquen directamente sobre las propias palmas abiertas de Aarón y se mezan allí —la mano, literalmente, llenada. Siguen siete días de confinamiento a la puerta del tabernáculo, terminando en la fórmula idéntica de seis palabras que una vez selló la propia construcción del tabernáculo: hicieron todo lo que Jehová mandó.",
    "lev9": "Llega el octavo día —el confinamiento ha terminado, y el sacerdocio se pone a trabajar por primera vez. Moisés le entrega el altar a Aarón: acércate, ofrece tu propia ofrenda por el pecado y tu holocausto, y solo después la del pueblo. Por primera vez en todo el libro, Aarón degüella, moja su propio dedo en la sangre, toca los cuernos del altar él mismo —las manos llenadas hace ocho días ahora son las que llenan. Lo hace una vez por sí mismo, luego otra vez, casi verso por verso, por toda la nación. Bendice al pueblo; él y Moisés lo bendicen otra vez, juntos; y sale fuego de delante de Jehová y consume la ofrenda ante todos, mientras todo el campamento grita de júbilo y cae rostro en tierra. Ninguna división masorética de párrafo separa nada de esto —todo el capítulo es una sola escena ininterrumpida, que fluye directamente hacia lo que sigue.",
    "lev10": "El mismo fuego que cerró el capítulo anterior en triunfo abre este en catástrofe. Nadab y Abiú, los propios hijos mayores de Aarón, ofrecen fuego extraño delante de Jehová, y sale fuego y los consume donde están —la cláusula idéntica, palabra por palabra, que acababa de consumir la ofrenda. Moisés responde con una cita, no con un consuelo, y toda la respuesta registrada de Aarón es una sola palabra: calló. Son parientes, no sus hijos sobrevivientes, quienes sacan los cuerpos, porque los sacerdotes en funciones no pueden ni siquiera salir de la entrada del tabernáculo. Jehová le habla a Aarón directamente —una de las pocas veces en todo el libro— prohibiendo el vino antes de la tarea diaria del sacerdocio de distinguir lo santo de lo común. Y el capítulo cierra con un giro inesperado: el padre que no dijo nada cuando murieron sus hijos habla ahora, sin que se lo pidan, en defensa de los dos que le quedan, y gana el argumento.",
    "lev11": "La ley alimentaria \u2014y la primera vez que este libro dice por qu\u00e9. Dos pruebas deciden sobre un animal terrestre, la pezu\u00f1a partida y el rumiar, y cuatro casos famosos fallan una de ellas: el camello, el dam\u00e1n, la liebre y el cerdo, que recibe un solo vers\u00edculo y ning\u00fan comentario especial. Las aletas y escamas resuelven las aguas en tres vers\u00edculos sin nombrar una sola criatura. Veinte aves aparecen en una simple lista, cerca de la mitad con nombres que ninguna traducci\u00f3n puede identificar con seguridad \u2014una misma palabra hebrea aparece una vez entre las aves y otra entre los lagartos, y ninguna versi\u00f3n la traduce igual dos veces. Las langostas son el \u00fanico insecto que Israel puede comer, y dos de los cuatro nombres de insectos no aparecen en ning\u00fan otro lugar de la Biblia, por lo que esta traducci\u00f3n los imprime sin traducir en lugar de adivinar. Luego la ley sigue a un lagarto muerto hasta la cocina: un cuenco de madera se lava, una vasija de barro se rompe, un horno se derriba \u2014mientras que un manantial o una cisterna sigue puro caiga lo que caiga en \u00e9l, lo \u00fanico aqu\u00ed que no puede contaminarse, y la palabra que el juda\u00edsmo posterior tom\u00f3 para su propio ba\u00f1o ritual. La palabra para vientre del v42 lleva la marca escribal m\u00e1s famosa de la Tor\u00e1: una vav agrandada que el Talmud llama la letra central de todo el rollo \u2014una tradici\u00f3n que no sobrevive a una comprobaci\u00f3n, como el propio Talmud medio admite. Y cuarenta y tres vers\u00edculos de criterios desnudos reciben por fin una raz\u00f3n: sed santos, porque yo soy santo. El cap\u00edtulo termina en un solo infinitivo, distinguir \u2014el verbo propio de la creaci\u00f3n, y el que se le entreg\u00f3 a Aar\u00f3n un cap\u00edtulo antes.",
    "lev12": "Ocho vers\u00edculos sobre el parto, y tres de las cosas m\u00e1s dif\u00edciles del libro. Una mujer \u2014en un verbo lo bastante extra\u00f1o como para dar nombre a toda la porci\u00f3n de la Tor\u00e1\u2014 \u00abconcibe simiente\u00bb y da a luz un hijo: siete d\u00edas impura, y luego treinta y tres m\u00e1s en lo que el hebreo llama la sangre de su PUREZA, una segunda etapa que casi todas las traducciones borran al convertirla en un proceso de ser limpiada de la sangre. Una hija duplica ambas cifras, y el texto no da ninguna raz\u00f3n \u2014toda explicaci\u00f3n jam\u00e1s ofrecida, desde la embriolog\u00eda de Fil\u00f3n hasta las lecturas medievales que culpaban a Eva, fue a\u00f1adida despu\u00e9s por lectores que trabajaban hacia atr\u00e1s desde los n\u00fameros, y el propio cap\u00edtulo se niega a dejar que la asimetr\u00eda se vuelva un precio: la ofrenda es id\u00e9ntica por un hijo o por una hija. La circuncisi\u00f3n al octavo d\u00eda interrumpe durante exactamente un vers\u00edculo, para que la impureza de la madre nunca retrase el rito del ni\u00f1o. Luego ella trae un cordero y un ave \u2014y una ofrenda por el pecado, aunque no ha hecho nada malo, que es el argumento m\u00e1s fuerte de que la palabra significa purificaci\u00f3n y no culpa. El cap\u00edtulo termina en una prueba de medios: si no alcanza para un cordero, bastan dos aves. Esa es la ofrenda que Lucas registra que trajo Mar\u00eda.",
    "lev13": "Cincuenta y nueve versículos de puro diagnóstico, y la palabra por la que se conoce este libro lleva dos mil años mal traducida. «Lepra» es la palabra tradicional, heredada del griego perfectamente razonable de la Septuaginta —lepros solo significaba «escamoso»; la enfermedad que la medicina moderna llama lepra tenía un nombre griego totalmente distinto, elefantíasis, y las dos nunca se confundieron hasta que «lepra» se estrechó, siglos después, hasta nombrar una sola enfermedad. Lo que el sacerdote examina en realidad es profundidad, propagación y color del pelo —tres pruebas aplicadas con precisión obsesiva sobre una hinchazón, una costra, una mancha blanca, la cicatriz de un divieso sanado, la cicatriz de una quemadura, y una escama del cuero cabelludo o la barba que vuelve el pelo fino y amarillo en vez de blanco. Una regla detiene en seco a la mayoría de los lectores: si la enfermedad cubre TODO el cuerpo, de la cabeza a los pies, sin que se vea carne viva en ningún sitio, el hombre es declarado puro —solo la carne viva cuenta como enfermedad activa, no el color que dio la primera alarma. Una palabra hapax, bohaq, se imprime sin traducir en vez de adivinarse. Y la misma aflicción, en este mismo capítulo, brota en la lana, en el lino y en el cuero —prueba, dentro del propio texto, de que sea lo que sea esto, no puede ser la enfermedad de Hansen, porque ninguna infección bacteriana crece sobre un abrigo. El capítulo cierra con la propia voz del diagnosticado: ropas rasgadas, cabello suelto, el labio cubierto, y un grito de «impuro, impuro» desde fuera del campamento —el aislamiento exacto que dos Evangelios registran a Jesús cruzando, a propósito, con su propia mano.",
    "lev14": "Levítico 13 diagnosticó; este capítulo readmite. La persona liberada de la enfermedad escamosa se encuentra con el sacerdote FUERA del campamento —el límite nunca cruza a buscarlo— para un rito que mata un ave sobre agua viva y moja una segunda ave, todavía viva, en su sangre antes de soltarla sobre campo abierto. Siguen siete días, y luego un afeitado total y deliberado de cada pelo del cuerpo, de la cabeza a las cejas. Después el octavo día, y la verdadera recompensa del capítulo: sangre y aceite tocados en la punta de la oreja derecha, el pulgar de la mano derecha, el dedo gordo del pie derecho —los mismos tres puntos, en el mismo orden, que consagraron al propio Aarón al sacerdocio quince capítulos atrás, en el peor y mejor día de su vida. Sigue una versión más barata para el pobre, aves en lugar de corderos, el costo recortado sin recortar el rito. Luego la ley se repite una tercera vez, para una casa —una plaga que brota en el yeso de una pared, examinada, puesta en cuarentena, raspada, y, si regresa, derribada piedra por piedra— una ley dada para una tierra que el campamento del desierto todavía no ha alcanzado, porque nadie que vive en una tienda posee una pared. Cierra con un colofón de seis líneas que nombra cada categoría que dos capítulos han cubierto: la afección, la escama, la prenda, la casa, la hinchazón, la costra, la mancha blanca —todo ello existiendo, dice el texto sin rodeos, para enseñar la única distinción que el sacerdocio recibió en su propia ordenación: lo impuro de lo puro.",
    "lev15": "La ley que cierra todo el bloque de lo puro y lo impuro, y la que Levítico 12 ya daba por sabida —dos veces, ese capítulo comparó la impureza de una madre reciente con «los días de su niddah» sin explicar jamás la palabra, porque aquí es donde se explica. Un flujo masculino anormal recibe la ley de contaminación por contacto más elaborada de toda la Torá: una cama, un asiento, una silla de montar, ser escupido, una vasija de barro rota sin más frente a una de madera simplemente enjuagada. Luego, en tres versículos breves, el capítulo se vuelve hacia algo que nadie espera que legisle un código de leyes con tanta llaneza: una emisión de semen ordinaria, y las relaciones matrimoniales ordinarias —el mismo «impuro hasta el atardecer» que se le asigna a una pareja haciendo exactamente lo que Génesis les mandó hacer, sin ofrenda, sin vergüenza, sin sacerdote de por medio. La menstruación ordinaria recibe la misma calma procesal. Y luego el caso más duro: una mujer que sangra muchos días más allá de su semana esperada —la condición exacta que los Evangelios registran que una mujer padeció durante doce años seguidos, hasta que se acerca por detrás de una multitud y toca un borde de manto, y la impureza que este capítulo pasó treinta versículos rastreando corre, por una vez, en la otra dirección. Cierra con la única frase que dice por qué existe todo esto: para que un pueblo que vive junto a su propio Dios no muera en su impureza al contaminar la tienda plantada en medio de su propio campamento.",
    "lev16": "El centro mismo del libro, y —de forma única en Levítico— contado en un solo párrafo ininterrumpido, sin pausa alguna hasta que cierra. Aarón, vestido con lino sencillo en vez del oro de su ordenación, sacrifica un toro por sí mismo y su casa, y luego se vuelve hacia dos machos cabríos idénticos y echa suertes: una suerte para Jehová, una para un nombre que esta traducción se niega a resolver en una sola palabra española —Azazel, un nombre que reclaman tres lecturas académicas genuinas (un risco del desierto, una etimología popular detrás de la palabra «chivo expiatorio», el nombre propio de un demonio) y ninguna de ellas zanja. El primer chivo es degollado, su sangre llevada más allá del velo hasta el espacio que nadie más puede entrar, rociada sobre la cubierta misma del arca —la «cubierta» literal, no el «propiciatorio» que inventó la tradición siglos después. El segundo chivo, todavía vivo, recibe las dos manos de Aarón sobre su cabeza y cada pecado de Israel pronunciado en voz alta sobre él, antes de que un hombre «mantenido listo para ello» lo saque hacia una tierra que el hebreo llama, en dos palabras, tierra de separación. Todo el que toca cualquier parte del ritual de este día —soltar el chivo, quemar lo que queda de los sacrificios— queda impuro por el contacto y debe lavarse antes de volver al campamento, incluso en el único día dedicado por entero a quedar puro. Cierra haciéndose permanente: una vez al año, para siempre, el día diez del séptimo mes, el día que el mundo llegará a llamar Yom Kipur.",
    "lev17": "Dieciséis versículos, ajustados como un escrito legal, y —como el capítulo anterior— contados sin una sola pausa interna. La ley: ningún buey, cordero o cabra puede matarse en ningún otro lugar que la propia entrada del tabernáculo de reunión, traído como ofrenda de paz en vez de sacrificado en campo abierto. La razón, medio escondida en el centro del mandato, es el verdadero tema del capítulo —algunos en el campamento habían estado sacrificando a «los demonios-cabra», los se'irim, objetos reales del culto popular que esta ley suprime en el mismo aliento que centraliza todo altar en uno solo. Los holocaustos reciben la regla idéntica dos versículos después, sin excepción por especie ni por quien ofrece. Luego el capítulo se vuelve de dónde se derrama la sangre a qué le sucede después: nunca comida, bajo ninguna circunstancia, nativo o extranjero por igual, porque —en la frase más clara de toda la Torá sobre qué es realmente un nefesh— «la vida de la carne está en la sangre». La sangre de un animal cazado, nunca destinada a un altar desde el principio, se derrama y se cubre con tierra en su lugar. Y comer un cadáver o un animal muerto por un depredador —trefah, la antepasada directa de la palabra «treif»— trae la misma impureza que ya traía tocar uno, tres capítulos atrás.",
    "lev18": "Treinta versículos que abren nombrando su propia alternativa —«no haréis como hacen en Egipto, no haréis como hacen en Canaán»— antes de exponer, una prohibición por versículo, doce grados prohibidos de parentesco, cada uno señalado en el texto masorético con su propia pausa de párrafo, un énfasis estructural que no se encuentra en ningún otro lugar de este libro. Luego, sin ningún cambio de registro, la lista continúa: casarse con dos hermanas como rivales, relaciones durante la separación mensual de una mujer, adulterio, entregar un hijo a Molec, un hombre que se acuesta con un varón como con mujer, un animal. Todo en la lista, sin excepción, recibe la misma palabra: abominación. El capítulo cierra con una de las imágenes más físicas de toda la Torá —la tierra misma, personificada, vomitando a las naciones que hicieron estas cosas antes de que Israel llegara— y se niega, dos veces, a dejar que Israel se imagine exento: el mismo destino espera al nativo y al extranjero por igual si hacen lo que hicieron los habitantes anteriores de la tierra. Este capítulo completa la serie desde Levítico 1 hasta el 19, sin ninguna laguna restante.",
    "lev20": "El propio catálogo de Levítico 18, contado una segunda vez —pero esta vez con una sentencia atada a cada elemento. Entrega un hijo a Molec, y el pueblo te apedrea; y si el pueblo mira hacia otro lado, Jehová dice que lo hará él mismo, una cláusula de respaldo dirigida menos al culpable que a la comunidad que podría dejarlo pasar. Maldice a un padre —la misma cláusula, palabra por palabra, que Éxodo ya fijó en un código legal anterior— y es la muerte. Adulterio, la mujer del padre, una nuera, dos hombres, un hombre y una bestia: muerte, cada caso cerrado con la misma fórmula sombría, «su sangre será sobre ellos», una manera de decir que la sentencia no es obra del verdugo. Un solo caso se quema en vez de apedrearse, la única admisión en una lista por lo demás plana de que no todas las faltas pesaban igual. Luego la lista se vuelve extraña: un hermano y una hermana que se miran reciben, de entre todas las palabras, chesed —la propia palabra bíblica para el amor leal de pacto, vuelta salvajemente del revés, a un solo juego de palabras amargo de distancia de la primera vez que esa palabra se pronunció jamás, por Lot, a la puerta de Sodoma. Y dos casos más no terminan en un tribunal en absoluto, sino en una predicción simple y llana: sin hijos. Este capítulo cierra exactamente donde abrió —médiums, espiritistas— con su propia razón de ser pronunciada una vez en medio de todo: seréis santos, porque yo soy santo.",
    "lev21": "Ley de santidad para el propio sacerdocio, en dos niveles. Un sacerdote ordinario solo puede ir a un funeral por sus cinco parientes más cercanos —padre, madre, hijo, hija, hermano, una hermana soltera— y aun así guarda las mismas reglas de duelo que ya sigue toda la nación: sin calva rapada, sin barba recortada, sin cortes en la carne por un muerto. Su lista de matrimonio excluye a una prostituta, a una mujer que el texto llama «profanada», a una divorciada. Luego el capítulo endurece cada una de esas reglas para un solo hombre: el sumo sacerdote no puede ni soltarse el cabello ni rasgar su propia ropa, no puede salir del santuario, no puede contaminarse ni siquiera por su propia madre o padre, y solo puede casarse con una virgen de su propio pueblo —ni siquiera con la viuda que un sacerdote ordinario podría tomar. La propia hija de un sacerdote, si se convierte en prostituta, es quemada, el mismo fuego que dos capítulos atrás se reservaba para exactamente otra ofensa. Y cierra con la lista más larga de condiciones físicas en todo este libro —ciego, cojo, un miembro roto, jorobado, enano, testículos aplastados— que impiden a un hombre acercarse al altar mismo, mientras el texto se esfuerza por decir qué NO toca esa barrera: sigue comiendo el pan sagrado, sigue perteneciendo, sigue recibiendo su sustento como sacerdote. La línea que traza el capítulo trata de quién puede cruzar un umbral particular, no de quién cuenta.",
    "lev22": "Dos leyes de santidad que resultan ser la misma ley dos veces. Primero: quién puede comer la porción sacerdotal de las ofrendas de Israel —comida real, no una abstracción. Un sacerdote con una enfermedad de la piel, un flujo, o contacto con un cadáver queda excluido de su propia mesa hasta que un lavado y el atardecer lo purifiquen; un extraño o un jornalero nunca puede comerla, sin excepción, pero un esclavo que un sacerdote compró con su propio dinero sí puede —la condición de propiedad, curiosamente, contando más que un salario. La hija de un sacerdote pierde su derecho el día que se casa fuera, y lo recupera, con la misma automaticidad, si vuelve viuda y sin hijos. Comerla por accidente tiene una solución exacta: lo que vale, más una quinta parte, entregado al sacerdote —la misma fórmula que este libro ya usó tres capítulos atrás. Luego el capítulo se vuelve de los hombres a los animales, y da, por primera vez, la lista real detrás de una palabra que este libro usa desde su propia primera página: tamim, «sin tacha». Ciego. Roto. Una verruga. Sarna. Aplastado. Es, elemento por elemento, la misma lista que impidió a un hombre cojo o con la mano aplastada acercarse al altar un capítulo antes —el mismo estándar, primero para los que sirven, ahora para lo que llevan al fuego. Un animal recién nacido recibe una semana con su madre antes de que nadie pueda tocarlo. Una madre y su cría no pueden morir el mismo día. Y una ofrenda de acción de gracias no puede guardarse para después —sea lo que sea la gratitud aquí, no dura hasta el día siguiente.",
    "lev23": "Todo el año religioso, expuesto en cuarenta y cuatro versículos y siete tiempos señalados —el calendario más completo que da la Torá en un solo lugar. Abre, antes de nombrar una sola fiesta anual, con el sábado semanal ordinario, archivado bajo la misma palabra hebrea que todo lo que sigue: un tiempo señalado, no un ritmo menor corriendo bajo el calendario real. Luego la Pascua, una sola noche sin ningún descanso festivo propio, seguida de inmediato por siete días de panes sin levadura que sí lo llevan. Una gavilla de la primera cebada, mecida antes de tocar el grano de nadie más. Un conteo de cincuenta días desde esa gavilla hasta una nueva ofrenda de grano de dos panes leudados —y, insertada en medio del conteo sin contenido ritual propio, la ley del borde del campo para el pobre y el extranjero, porque esto es cosecha, y la ley pertenece exactamente aquí. Un memorial de toques de trompeta en el séptimo mes que recibe dos versículos y ninguna explicación. El Día de la Expiación, ya dado su ritual cuatro capítulos atrás, ahora recibe su fecha en el calendario y, por primera vez, una pena por saltárselo. Y al final, siete días viviendo en refugios hechos de ramas, la única fiesta de todo el capítulo que declara sin rodeos por qué existe: para que las generaciones futuras sepan que sus antepasados no tuvieron una vez nada más firme que esto. Seis días de trabajo ordinario prohibidos por completo; en los propios días festivos, un tipo más estrecho de trabajo prohibido en su lugar —una distinción que este capítulo traza sin explicarla jamás, y de ese mismo silencio creció toda una categoría posterior de ley religiosa.",
    "lev27": "La propia lista de precios del libro, añadida después de que el argumento principal ya había cerrado. Si le prometes una PERSONA a Dios —no en sacrificio, solo prometiendo su valor—, esto es exactamente lo que cuesta: una tarifa fija según edad y sexo, cincuenta siclos por un hombre en su plenitud hasta tres por una niña de pecho, sin negociación, aunque si eres demasiado pobre para pagarla el sacerdote está obligado a fijar una cifra que realmente puedas pagar. Prometes un animal que ya podría sacrificarse, y no se permite cambiarlo después por uno peor —inténtalo, y ahora debes ambos animales, no uno. Prometes una casa o un campo, y un sacerdote lo tasa con justicia, aunque siempre puedes recomprarlo después por el precio tasado más un recargo del 20%, porque retractarse de una promesa a Dios no sale gratis. La tierra queda atada al mismo reloj de cincuenta años introducido dos capítulos atrás: consagra tu propio campo heredado y su precio depende de cuántos años quedan hasta que todo se reinicie; consagra un campo que simplemente compraste, y nunca fue realmente tuyo para dar en primer lugar —vuelve de golpe a su familia original sin importar lo que hagas. No puedes prometer el primogénito de un animal, porque ya estaba reservado antes de que se te ocurriera la idea. Y entonces el capítulo se pone genuinamente duro: algo puesto bajo un anatema total —consagrado, sin marcha atrás, sin poder recomprarlo a ningún precio— incluyendo, en la frase más dura del libro, a una persona. Sin rescate. Termina con los diezmos: una décima parte de la cosecha, y una décima parte del rebaño, contada animal por animal sin permitir elegir el mejor —el décimo es el décimo, sea el más flaco o el más gordo de la camada. Y luego, tras treinta y cuatro versículos de apéndice, una última línea cierra el libro entero: estas son las reglas que Dios le dio a Moisés, en la montaña, para Israel. Números continúa después, un mes más tarde, en la misma montaña, listos para moverse.",
    "lev26": "El balance final del propio libro, planteado como un trato directo: obedece, y esto es lo que obtienes; no obedezcas, y esto es lo que pasa en su lugar. El lado de la bendición ocupa diez versículos —lluvia a tiempo, cosechas tan buenas que la trilla se solapa con la siguiente vendimia, paz lo bastante segura para dormir con las puertas abiertas, una victoria tan total que cinco espantan a cien y cien espantan a diez mil, y, debajo de todo eso, la propia presencia de Dios moviéndose por el campamento de la misma manera en que una vez se movió por un jardín. Luego el trato se invierte, y el lado de la maldición ocupa el triple de espacio, en cuatro etapas distintas, cada una peor que la anterior, cada una llegando solo porque la anterior fue ignorada. Primero enfermedad y perder ante los enemigos. Luego el cielo se vuelve hierro y el suelo bronce, así que nada cae y nada crece. Luego los animales salvajes empiezan a llevarse tanto el ganado como a los hijos, y los caminos quedan vacíos porque nadie se arriesga a usarlos. Luego el asedio —asedio real, diez mujeres horneando pan en un solo horno compartido porque ya no hay harina ni combustible para diez hornos separados, y aun así nadie queda satisfecho. Y luego la peor frase de todo el libro: padres comiendo a sus propios hijos, porque ahí es donde realmente termina el camino si se recorre hasta el final. Ciudades arrasadas, santuarios derribados, los sobrevivientes dispersos en territorio enemigo tan a fondo que una hoja que cruje basta para hacerlos correr —no porque algo los persiga realmente, sino porque la culpa ya ha hecho la persecución por su cuenta. Y ahí, en el punto más bajo, el capítulo no se detiene. Da un giro: si alguna vez admiten lo que hicieron, si la resistencia dentro de ellos finalmente se quiebra, Dios se acuerda de la promesa antigua de todos modos —Jacob, luego Isaac, luego Abraham, retrocediendo por la familia como quien hojea fotos antiguas— y la puerta de vuelta permanece abierta sin importar cuán lejos hayan llegado las cosas. El libro cierra aquí su argumento legal principal, con una despedida formal: estas son las reglas, este fue el trato, sellado en la montaña.",
    "lev25": "Dos relojes corriendo a la vez, uno dentro del otro. Cada séptimo año, la tierra misma tiene derecho a detenerse —nada de sembrar, nada de podar, y lo que los campos produzcan por sí solos no pertenece a nadie en particular: el dueño, el jornalero, el extranjero residente y los animales salvajes comen todos de él en los mismos términos exactos. Cuenta siete de esos ciclos —cuarenta y nueve años— y el año cincuenta recibe un toque de trompeta en el día más solemne del año, y una frase que terminaría fundida en una campana en Filadelfia tres mil años después: proclamad libertad en la tierra, para todos sus habitantes. Cada familia recupera su tierra. Todo israelita que se vendió a sí mismo a servidumbre queda libre. El capítulo hace entonces algo que casi ningún otro código legal del mundo antiguo se molesta en hacer: calcula la aritmética real. Vender tierra no es realmente venderla —es arrendar las cosechas que quedan hasta el reinicio, y el precio tiene que calcularse en consecuencia, sin trampas en ninguna dirección. La tierra de un pariente empobrecido puede recomprarla el familiar más cercano que pueda pagarla, o el propio hombre si se recupera económicamente, o, si ninguna de las dos ocurre, el año cincuenta que llega de todos modos. Las casas dentro de una ciudad amurallada tienen una excepción curiosa —si se pierde la ventana de un año, se pierde para siempre, sin importar en qué año del ciclo se esté— a menos que seas levita, en cuyo caso vuelve la regla ordinaria, porque los levitas no tienen tierras de cultivo que perder para empezar. Nada de cobrar interés a un compatriota que ha caído en la pobreza. Y en cuanto a la servidumbre real, la ley traza una línea que en ningún otro lugar traza con esta claridad: un israelita que se vende a sí mismo para sobrevivir nunca, bajo ningún planteamiento, es un esclavo —es un jornalero con fecha de vencimiento, libre como muy tarde en el jubileo— mientras que solo de las naciones vecinas se puede comprar gente como propiedad permanente. Todo el capítulo cierra con la razón que sostiene todo lo anterior, repetida dos veces como un paréntesis alrededor de todo lo demás: en realidad no posees nada de esto —ni la tierra, ni a los demás— porque ya pertenece a quien te sacó de Egipto.",
    "lev24": "Tres cosas que casi no tienen nada que ver entre sí, archivadas bajo un mismo capítulo. Primero, dos leyes domésticas repetidas casi palabra por palabra desde Éxodo: mantener una lámpara encendida cada noche sin falta, y mantener doce panes sobre una mesa delante de Dios, reemplazados cada semana, comidos solo por sacerdotes, en un lugar santo. Luego, sin transición alguna, una historia —un hombre con madre israelita y padre egipcio se mete en una pelea en el campamento, y en el calor del momento pronuncia el propio nombre de Dios en voz alta como maldición. Nadie sabe qué hacer con él, así que lo encierran y esperan una respuesta directa de Jehová. La respuesta, cuando llega, no es solo su sentencia —es una ley: muerte por maldecir el nombre de Dios, sea que hayas nacido en el campamento o solo vivas en él. Y luego, todavía con el impulso de ese único caso, la ley sigue adelante, más allá de la blasfemia, hacia todo lo demás que una persona puede hacerle al cuerpo de otra: vida por vida, fractura por fractura, ojo por ojo, diente por diente —lo que le hiciste a otro, hecho de vuelta a ti, exactamente, ni más ni menos. Un solo estándar, dice el capítulo dos veces, para el extranjero y para el nativo por igual. Luego sacan al hombre fuera del campamento, y la sentencia que la ley acababa de describir se ejecuta sobre el mismo caso que la produjo.",
    ...
    "rev9": "La quinta trompeta abre un pozo hacia el abismo, y de él salen langostas armadas como caballos de guerra, con rostros de hombre, cabello de mujer, dientes de león y colas de escorpión -- con la orden de respetar toda planta y atacar solo a quienes no llevan el sello de Dios, atormentando sin matar, durante exactamente cinco meses. &#9888; Su rey lleva dos nombres, uno hebreo y otro griego -- Abadón, Apolión, ambos significan «Destructor» -- y el nombre griego suena lo bastante parecido al dios Apolo como para que algunos lectores oigan una pulla cifrada contra el emperador que lo reclamaba como su patrono. El primer ay pasa; quedan dos. La sexta trompeta libera a cuatro ángeles atados junto al Éufrates para matar a la tercera parte de los hombres, con una caballería de doscientos millones cuyos caballos respiran fuego, humo y azufre por la boca y golpean una segunda vez con una cabeza de serpiente en la cola. Y después de que muriera una cuarta parte de la tierra, luego una tercera parte de la tierra, y ahora una tercera parte de los hombres, la última palabra del capítulo es que nadie se arrepintió.",
    "rev10": "Un ángel poderoso desciende envuelto en una nube, con un arco iris sobre la cabeza, el rostro como el sol -- una figura que toma piezas reales de la propia descripción de Cristo en el capítulo 1, y a la que sin embargo se llama «OTRO ángel poderoso», la frase idéntica ya usada para una figura que inequívocamente no es Cristo. Pone un pie sobre el mar y otro sobre la tierra y jura -- lo mismo que Cristo prohibió -- que ya no habrá más demora: una vieja y famosa traducción errónea lee esto como «el tiempo dejará de existir». &#9888; Siete truenos hablan, y a Juan se le dice que selle sus palabras y nunca las escriba -- la única puerta que este Develar jamás abre. Luego se le entrega un rollito y se le dice que se lo coma: dulce como la miel en la boca, amargo en el vientre una vez tragado -- la misma orden que un profeta mucho más antiguo recibió en una orilla extranjera, siglos antes, con un rollo propio.",
    "rev11": "A Juan se le entrega una caña de medir y se le ordena medir el templo -- pero dejar sin medir el atrio exterior, entregado para ser pisoteado durante cuarenta y dos meses, el mismo lapso que dos testigos sin nombre pasarán profetizando vestidos de saco, con fuego saliendo de su boca, con poder para cerrar el cielo y convertir el agua en sangre: un retrato fusionado de Moisés y Elías que el texto nunca nombra abiertamente. &#9888; Cuando su testimonio termina, LA BESTIA -- el antagonista de este libro, nombrado aquí por primera vez, ya con artículo definido -- sube del abismo y los mata, y sus cuerpos quedan sin sepultura en una gran ciudad «llamada espiritualmente Sodoma y Egipto», mientras la tierra entera celebra sobre los cadáveres. Tres días y medio después, entra en ellos aliento de vida, se ponen de pie, y una voz dice solamente «suban acá». Suena por fin la séptima trompeta -- «el reino del mundo ha llegado a ser el reino de nuestro Señor» -- y se abre el propio templo del cielo sobre un objeto que nadie ha visto en seis siglos: el arca del pacto, que no estaba perdida después de todo, solo buscada siempre en el edificio equivocado.",
    "rev12": "Una gran señal en el cielo: una mujer vestida del sol, con la luna bajo sus pies, coronada por doce estrellas, que clama con los dolores de dar a luz -- mientras otra señal la espera enfrente, un gran dragón rojo de siete cabezas y diez cuernos, que arrastra del cielo la tercera parte de las estrellas y se coloca para devorar a su hijo en cuanto nazca. Ella da a luz a un hijo que «pastoreará a todas las naciones con vara de hierro», arrebatado hasta el trono de Dios antes de que el dragón pueda tocarlo, mientras ella huye al desierto por mil doscientos sesenta días. &#9888; Entonces estalla la guerra en el propio cielo: Miguel y sus ángeles contra el dragón, que pierde y es arrojado a la tierra -- nombrado por primera vez en toda la Biblia, en una sola frase, como la serpiente del Edén, el Diablo y Satanás a la vez. Una gran voz anuncia su caída y el fin de un tribunal abierto desde Job: el Acusador, expulsado para siempre. Furioso y corto de tiempo, se vuelve contra la mujer una segunda vez -- un río vertido de su boca, tragado entero por la tierra misma -- y luego contra «el resto de su descendencia», todos los que guardan los mandamientos de Dios y tienen el testimonio de Jesús. El capítulo termina con él de pie sobre la arena del mar, vigilando el agua: una sola variante textual de una letra decide si esa frase pertenece aquí, o abre el capítulo siguiente.",
    "rev13": "Una bestia sube del mar -- diez cuernos, siete cabezas, el mismo cuerpo del dragón del capítulo anterior, y ahora un compuesto de cada animal que la visión de las cuatro bestias de Daniel necesitó una escena aparte para describir: cuerpo de leopardo, pies de oso, boca de león. Una de sus cabezas lleva una herida que debería haberla matado y no lo hizo; toda la tierra la sigue maravillada, coreando una pregunta -- «¿quién es semejante a la bestia?» -- que toma prestada su propia gramática del nombre del ángel que acaba de derrotar al dragón hace un capítulo. &#9888; Se le da una boca que «habla grandes cosas», tomada palabra por palabra del propio cuerno jactancioso de Daniel, y autoridad por cuarenta y dos meses, los mismos tres años y medio que este libro ya ha contado de cuatro maneras distintas. Después sube de la tierra una segunda bestia -- con cuernos de cordero, voz de dragón --, que hace señales falsas, da aliento a una imagen de la primera bestia, y mata a quien se niegue a adorarla. A todos, «pequeños y grandes, ricos y pobres, libres y esclavos», se les obliga a llevar una marca en la mano o en la frente antes de poder comprar o vender nada. &#9888; El capítulo termina con el número más discutido de toda la Biblia: «el que tenga entendimiento, calcule el número de la bestia, porque es número de hombre; y su número es seiscientos sesenta y seis», un valor en el que casi todos los testigos antiguos concuerdan, frente a una lectura rival, 616, ya conocida y ya rechazada por un obispo que escribía apenas un siglo después del propio libro.",
...
def header(active="", lang="en"):
    ...
    if lang == "es":
        ...
        # "Preguntar" moved OUT of the header (2026-09-09), mirroring the English
        # side -- see _foot_actions, which puts it in the boxed pair above the footer.
...
ES_FOOTER = f"""<footer class="site-foot">
  ...
  <p><a href="es.html">Inicio</a> · <a href="{HOME_URL}">English edition</a> · <a href="{SITE_URL}/">mistertranslation.com</a> · <a href="privacy.html">Privacidad</a></p>{_FOOT_VIEWS_LINE}
</footer>"""
...
def _chapter_art_html(art, lang="en"):
    ...
    artist = art.get("artist_es") if es and art.get("artist_es") else art["artist"]
    line = (f'<span class="art-artist">{html.escape(artist)}</span>, '
