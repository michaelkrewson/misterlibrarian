...
CHAPTERS = [
    ...
    ("num30", "Numbers", 30, "A single law of vows, and the shelf cannot even agree where it begins &mdash; only Douay-Rheims and Geneva 1599 side with the Masoretic text in opening the chapter with the sentence <a href='numbers-29.html'>Numbers 29</a>'s own closing note promised; the other eleven witnesses on this project's shelf attach it to the chapter before. ⭐ The father's law (vv3-6) uses one verb of override, once; the husband's law (vv7-16) uses two, and the second &mdash; 'annul' &mdash; six times in ten verses, a lopsided weighting this translation has not found named anywhere else. ⭐⭐ Three times an on-time override closes with 'and Jehovah will forgive her' &mdash; but the one time a husband waits too long, the sentence is not forgiveness for her but 'he shall bear her guilt' (v16): the unresolved weight of an overridden vow does not vanish, it moves. ⚠ And the one woman no man can override is the one who answers to neither &mdash; a widow or a divorced woman, whose own vow carries the identical unconditional force this chapter gives a man's."),
